...
namespace VistA.Imaging.Telepathology.Worklist.Messages
{
    ...
    public static partial class AppMessages
    {
        ...
        /// TODO: Update summary.
        /// </summary>
        public static class ViewNotesMessage
        {
            ...
            {
                Messenger.Default.Send(data, MessageTypes.ViewNotes);
            }

            public static void Register(object recipient, Action<MessageData> action)
            {
                Messenger.Default.Register(recipient, MessageTypes.ViewNotes, action);
            }
        }
    }
}
