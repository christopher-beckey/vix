// -----------------------------------------------------------------------
// <copyright file="RestBooleanReturnType.cs" company="Department of Veterans Affairs">
...
namespace VistA.Imaging.Telepathology.Common.VixModels
{
    ...
    /// <summary>
    /// Boolean type object returns from VIX
    /// </summary>
    [XmlRoot("restBooleanReturnType")]
    public class RestBooleanReturnType : INotifyPropertyChanged
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RestBooleanReturnType"/> class
        /// </summary>
        public RestBooleanReturnType()
        {
            this.Result = bool.FalseString;
        }
...
#pragma warning restore 0067
        ...
        public bool BoolResult
        {
            ...
            {
                bool result;
                if (bool.TryParse(this.Result, out result))
                {
                    return result;
                }
