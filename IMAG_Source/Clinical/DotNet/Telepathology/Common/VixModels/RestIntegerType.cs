// -----------------------------------------------------------------------
// <copyright file="RestIntegerType.cs" company="Department of Veterans Affairs">
//  Package: MAG - VistA Imaging
//  WARNING: Per VHA Directive 2004-038, this routine should not be modified.
//  Date Created: Jul 2012
//  Site Name:  Washington OI Field Office, Silver Spring, MD
//  Developer: Duc Nguyen
//  Description: hold integer value return from vix
//        ;; +--------------------------------------------------------------------+
...
namespace VistA.Imaging.Telepathology.Common.VixModels
{
    ...
    [XmlRoot("restIntegerType")]
    public class RestIntegerType : INotifyPropertyChanged
    {
...
#pragma warning restore 0067
        ...
        public int IntValue
        {
            get
            {
                ...
                {
                    int numVal;
                    bool result = Int32.TryParse(this.StringValue, out numVal);
                    if (result)
                    {
                        return numVal;
                    }
