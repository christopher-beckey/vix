// -----------------------------------------------------------------------
// <copyright file="PathologyReadingSiteType.cs" company="Department of Veterans Affairs">
...
namespace VistA.Imaging.Telepathology.Common.VixModels
{
    ...
    [XmlRoot("pathologyReadingSiteType")]
    public class PathologyReadingSiteType : INotifyPropertyChanged
    {
