// -----------------------------------------------------------------------
// <copyright file="RestStringType.cs" company="Department of Veterans Affairs">
//  Package: MAG - VistA Imaging
//  WARNING: Per VHA Directive 2004-038, this routine should not be modified.
//  Date Created: Jul 2012
//  Site Name:  Washington OI Field Office, Silver Spring, MD
//  Developer: Duc Nguyen
//  Description: Store string input for the VIX
//        ;; +--------------------------------------------------------------------+
...
namespace VistA.Imaging.Telepathology.Common.VixModels
{
    ...
    /// <summary>
    /// Store string input for the vix
    /// </summary>
    [XmlRoot("restStringType")]
    public class RestStringType : INotifyPropertyChanged
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RestStringType"/> class
        /// </summary>
