// -----------------------------------------------------------------------
// <copyright file="PathologyTemplateInputType.cs" company="Department of Veterans Affairs">
...
namespace VistA.Imaging.Telepathology.Common.Model
{
    ...
    [XmlRoot("pathologyTemplateInputType")]
    public class PathologyTemplateInputType : INotifyPropertyChanged
    {
