...
namespace VistA.Imaging.Telepathology.Common.VixModels
{
    ...
    [XmlRoot("pathologyElectronicSignatureNeedType")]
    public class PathologyElectronicSignatureNeedType : INotifyPropertyChanged 
    {
        public PathologyElectronicSignatureNeedType()
        {
            this.Status = ESigNeedType.error;
...
#pragma warning restore 0067
        ...
        [XmlElement("status")]
        public ESigNeedType Status { get; set; }
