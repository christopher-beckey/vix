// -----------------------------------------------------------------------
// <copyright file="CaseList.cs" company="Department of Veterans Affairs">
...
namespace VistA.Imaging.Telepathology.Common.Model
{
    ...
    /// TODO: Update summary.
    /// </summary>
    [XmlRoot("pathologyCasesType")]
    public class CaseList : INotifyPropertyChanged
    {
        public CaseList()
        {
