...
namespace VistA.Imaging.Telepathology.Communication
{
    ...
    public class ViXClient
    {
        ...
        public CaseList GetUnreleasedCases(string siteID)
        {
            ...
            {
                URI = String.Format("pathology/cases/unreleased/{0}/{1}", siteID, "30");
            }
            else
            {
                URI = String.Format("pathology/cases/unreleased/{0}/{1}/{2}", siteID, "30", UserContext.LocalSite.SiteStationNumber);
            }
            IRestResponse response;
            CaseList result;
            try
        ...
        public CaseList GetReleasedCases(string siteID, int dayrange = 30)
        {
