//-----------------------------------------------------------------------
// <copyright file="ModulesView.xaml.cs" company="Department of Veterans Affairs">
...
// </copyright>
// -----------------------------------------------------------------------
namespace VistA.Imaging.Shell.Views
{
    using VistA.Imaging.Prism.Views;
    using VistA.Imaging.Shell.ViewModels;

    /// <summary>
    /// Interaction logic for ModulesView.xaml
    /// </summary>
    public partial class ModulesView : UserControlView<ModulesViewModel>
    {
        /// <summary>
