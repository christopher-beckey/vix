//-----------------------------------------------------------------------
// <copyright file="UserControlView.cs" company="Department of Veterans Affairs">
...
namespace VistA.Imaging.Prism.Views
{
    ...
    public class UserControlView<TViewModel> : UserControl, IActiveAware
        where TViewModel : ViewModel
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the UserControlView class
        /// </summary>
        ...
        public UserControlView(TViewModel viewModel)
            : base()
        {
