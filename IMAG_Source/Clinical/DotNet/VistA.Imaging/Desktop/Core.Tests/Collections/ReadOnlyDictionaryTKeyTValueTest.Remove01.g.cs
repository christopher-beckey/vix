...
public void Remove01ThrowsNotSupportedException714()
{
    ReadOnlyDictionary<int, int> readOnlyDictionary;
    bool b;
    readOnlyDictionary = new ReadOnlyDictionary<int, int>();
    b = this.Remove01<int, int>(readOnlyDictionary, default(KeyValuePair<int, int>));
}
[TestMethod]
[PexGeneratedBy(typeof(ReadOnlyDictionaryTKeyTValueTest))]
[ExpectedException(typeof(NotSupportedException))]
public void RemoveThrowsNotSupportedException275()
{
    ReadOnlyDictionary<int, int> readOnlyDictionary;
    bool b;
    readOnlyDictionary = new ReadOnlyDictionary<int, int>();
    b = this.Remove<int, int>(readOnlyDictionary, 0);
}
    }
}
