// <copyright file="SelectedItemsViewBase.cs" company="Department of Veterans Affairs">
...
namespace VistA.Imaging.Viewer.Views.Bases
{
    ...
    /// <summary>
    /// SelectedItemsView base class
    /// </summary>
    public class SelectedItemsViewBase : UserControlView<SelectedItemsViewModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SelectedItemsViewBase"/> class.
        /// </summary>
        ...
        public SelectedItemsViewBase(SelectedItemsViewModel viewModel)
            : base(viewModel)
        {
        }
    }
