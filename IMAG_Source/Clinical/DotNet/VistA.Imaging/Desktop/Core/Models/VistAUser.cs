// -----------------------------------------------------------------------
// <copyright file="VistAUser.cs" company="Department of Veterans Affairs">
...
namespace VistA.Imaging.Models
{
    ...
    public class VistAUser
    {
        ...
        /// </summary>
        public ObservableCollection<Institution> Divisions { get; set; }

        /// <summary>
        /// Gets or sets the security keys.
        /// </summary>
