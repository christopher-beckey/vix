...
Type
  ...
  Public
    ...
    procedure SetLogRPCCalls(value : boolean) ; Virtual; Abstract;  {140 Log RPC Calls}
    function  GetLogRPCCalls() : boolean; Virtual ; Abstract;        {140 Log RPC Calls}
...
{/p121 adds Division as extra parameter at end.}
    ...
    {/ P127T1 - NST 04/04/2012 - added LocalSiteStationNumber}
    {Retrieve the read/unread list}
    Function RPMagTeleReaderUnreadlistGet(Var t: TStrings; Var Xmsg: String; AcquisitionPrimaryDivision, Sitecode, SpecialtyCode, ProcedureStrings, LastUpdate, UserDUZ, LocalSiteCode, SiteTimeOut, StatusOptions, LocalSiteStationNumber: String): Boolean; Virtual; Abstract;
    {Lock items in the unread list}
    Function RPMagTeleReaderUnreadlistLock(Var Xmsg: String; AcquisitionPrimaryDivision, AcquisitionSiteCode, ItemID, LockUnlockValue, UserFullName, UserInitials, LocalDUZ, LocalSiteCode, LocalSiteStationNumber: String): Boolean; Virtual; Abstract;
...
//    procedure RPMagAnnotGetHistory(IEN: String; Var Fstat: Boolean; Var Rpcmsg: String; Var AnnotHistory: TStringList); Virtual; Abstract;
//
...
//                               var Rpcmsg: String); Virtual; Abstract;
//
...
//      Deleted: String; Var Fstat: Boolean; Var Rpcmsg: String; ServerName: String; ServerPort: Integer); Virtual; Abstract;
    ...
    procedure RPMagAnnotGetHistory(IEN: String; Var Fstat: Boolean; Var Rpcmsg: String; Var AnnotHistory: TStringList;
     ServerName: String; ServerPort: Integer); Virtual; Abstract;

    {/ P122 - JK 6/20/2011 - Get the annotation XML for an specific image IEN and annotation layer (history).
       Calls RPC: MAG ANNOT GET IMAGE DETAIL /}
    procedure RPMagAnnotGetXML(AnnotID: String; LayerNumber: String; var AnnotXML: TStringList; var Fstat: Boolean;
                               var Rpcmsg: String; ServerName: String; ServerPort: Integer); Virtual; Abstract;
    ...
    {/ P122 - JK 7/6/2011 - gets the kernel parameter result for annotation permission /}
    function RPKernelAnnotatePermission: Boolean; Virtual; Abstract;

    {/ P123 - JK 8/8/2011 - returns I = IHS or V = VA /}
    function RPMaggAgency: String; Virtual; Abstract;

    { P131 JMW 5/15/2013 - return a unique string to identify this broker connection}
    function GetBrokerIdentifier() : String; Virtual; Abstract;
