...
(*  procedure TMagImageListManager.MyLogMsg(msgType, msg: String; Priority: TMagMsgPriority = magmsgINFO);
begin
...
Begin
  magAppMsg('s', '**--**-- -- -- TMagImageListManager.Update_  state ' + SubjectState);
...
Begin
  ...
  Try
    Begin
      ...
      magAppMsg('', 'Image Group selected, accessing Group Images...'); {JK 10/5/2009 - MaggMsgu refactoring}
      If Temp.Count = 1 Then
        //LogMsg('s', magpiece(temp.strings[0], '^', 2));
        magAppMsg('s', MagPiece(Temp.Strings[0], '^', 2)); {JK 10/5/2009 - MaggMsgu refactoring}
    ...
    Begin
      ...
      magAppMsg('D', 'ERROR: Accessing Group Images.  See VistA Error Log.'); {JK 10/5/2009 - MaggMsgu refactoring}
      Exit;
    End;
    Temp.Delete(0);
