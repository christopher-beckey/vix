...
procedure TfrmWebHelpMapping.Execute;
begin
CheckForm;
frmWebHelpMapping.show;

end;
procedure TfrmWebHelpMapping.checkform();
begin
  if not doesformexist('frmWebHelpMapping') then application.CreateForm(TfrmWebHelpMapping,frmWebHelpMapping);
end;
