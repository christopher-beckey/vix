...
procedure TMagSyncCPRSf.checkform();
begin
  if not doesformexist('MagSyncCPRSf') then application.CreateForm(TMagSyncCPRSf,MagSyncCPRSf);
end;


Procedure TMagSyncCPRSf.GetCPRSLinkOptions(Var CprsSync: CprsSyncOptions);
Begin
checkform();
