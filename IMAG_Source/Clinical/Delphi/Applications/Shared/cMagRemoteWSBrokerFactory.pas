...
//  cMagRemoteWSBroker_V6,  {/ P117-NCAT JK 10/26/2010 /}
  cMagRemoteWSBroker_v7,  {/ P122 - JK 7/4/2011 /}
  Idhttp,
  SysUtils,
  Xmldoc,
  Xmlintf
...
(*  Procedure TMagRemoteWSBrokerFactory.MyLogMsg(msgType, msg: String; Priority: TMagMsgPriority = magmsgINFO);
begin
...
//                WorkstationID, localBrokerPort, SecurityTokenNeeded);
  ...
  if (Version = '7') then
    Result := TMagRemoteWSBrokerV7.Create(Site, LocalVixURL, ImgService,
                WorkstationID, localBrokerPort, SecurityTokenNeeded)
End;
...
//  FAllowedVersionsList.Add('6');  {/ P117-NCAT JK 10/26/2010 /}
  FAllowedVersionsList.Add('7');  {/ P122 - JK 7/4/2011 /}
End;
  ...
  Try
    ...
    Except
      ...
      Begin
        ...
        magAppMsg('s', 'Error getting versions from IDS service [' + e.Message + ']', MagmsgERROR); {JK 10/5/2009 - Maggmsgu refactoring}
      End;
    End;
  Finally
