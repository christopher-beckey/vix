...
Begin
  ...
  Try
    ...
    Begin
      { TODO -cDemo : Create Abstracts, and Resolve Image Format for the images in the directory. }
...
Begin
  ...
  { TODO -clowPriority :  need to change the 'O' and 'W' to enumerated type. maglocMag, maglocJB, }
  ...
  { 12-PACS Group   10-PACS Resident    13-ECG     14-cine }
    Case ImgObj.ImgType Of
      ...
      107: Result := VApppath + '\bmp\maghtml.bmp';
    End; {case}
...
Function TMagVUtils.ResolveTypeFromExt(Filename: String): Integer;      {called from DirImagesToObjList}{won't be called by CAPP APP}
Var
  Ext, StrType: String;
  i: Integer;
Begin
...
{DONE: need to make a DB Call for this, and should be moved to cMagUtilsDB.pas}
