object frmFullResSpecial: TfrmFullResSpecial
  Left = 541
  Top = 261
  HelpContext = 10086
  BorderIcons = [biSystemMenu]
  Caption = 'Image Special Options'
  ClientHeight = 610
  ClientWidth = 737
  Color = clBtnFace
  ...
  object MainMenu1: TMainMenu
    ...
    object File1: TMenuItem
      ...
      object mnuOpenacopy1: TMenuItem
        Caption = 'zz-Duplicate Selected Image'
        Visible = False
        OnClick = mnuOpenacopy1Click
      end
      object mnuCopy1: TMenuItem
        Caption = 'zz-Copy Image to Clipboard'
      ...
      object mnuImageSaveAs1: TMenuItem
        Caption = 'zz-Image Save As...'
        Visible = False
      end
      object mnuDelete1: TMenuItem
        Caption = 'zz-Image Delete...'
    ...
    object Help1: TMenuItem
      Caption = 'Help'
      object mnuHelpFullResSpecial: TMenuItem
        Caption = 'Print Options...'
        Enabled = False
        ImageIndex = 28
        OnClick = mnuHelpFullResSpecialClick
      end
    end
  end
