...
// WSDL     : imagingClinicalDisplaySOAP_v6.wsdl
//  >Import : imagingClinicalDisplaySOAP_v6.wsdl:0
// Encoding : UTF-8
// Version  : 1.0
// (1/17/2011 3:28:02 PM - - $Rev: 10138 $)
// ************************************************************************ //

unit imagingClinicalDisplaySOAP_v6;
...
type
  ...
  FilterType           = class;                 { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[GblCplx] }
  UserCredentialsType  = class;                 { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[GblCplx] }
  ImageAccessLogEventType = class;              { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[GblCplx] }
  FatImageType         = class;                 { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[GblCplx] }
  ShallowStudyType     = class;                 { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[GblCplx] }
  ShallowStudiesErrorMessageType = class;       { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[GblCplx] }
  ShallowStudiesType   = class;                 { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[GblCplx] }
  ShallowStudiesResponseType = class;           { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblCplx] }
  ImageAccessEventType = class;                 { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblCplx] }
  ImageInformationType = class;                 { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblCplx] }
  ImageSystemGlobalNodeType = class;            { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblCplx] }
  ImageDevFieldsType   = class;                 { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblCplx] }
  StudyReportType      = class;                 { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblCplx] }
  RemoteMethodParameterType = class;            { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[GblCplx] }
  RemoteMethodResponseType = class;             { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblCplx] }
  PingServerType       = class;                 { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblCplx] }
  PrefetchResponseType = class;                 { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblCplx] }
  PatientSensitiveCheckResponseType = class;    { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[GblCplx] }
  PatientSensitiveCheckWrapperResponseType = class;   { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblCplx] }
  getPatientSensitivityLevel = class;           { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  getPatientSensitivityLevelResponse = class;   { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  getPatientShallowStudyList = class;           { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  getPatientShallowStudyListResponse = class;   { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  getStudyImageList    = class;                 { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  postImageAccessEvent = class;                 { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  postImageAccessEventResponse = class;         { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  pingServer           = class;                 { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  postPingServerResponse = class;               { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  prefetchStudyList    = class;                 { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  PrefetchStudyListResponse = class;            { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  getImageInformation  = class;                 { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  getImageInformationResponse = class;          { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  getImageSystemGlobalNode = class;             { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  getImageSystemGlobalNodeResponse = class;     { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  getImageDevFields    = class;                 { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  getImageDevFieldsResponse = class;            { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  getStudyReport       = class;                 { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  getStudyReportResponse = class;               { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  remoteMethodPassthrough = class;              { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  remoteMethodPassthroughResponse = class;      { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  image                = class;                 { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Alias] }
  study                = class;                 { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Alias] }
  RemoteMethodParameterValueType = class;       { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[GblCplx] }
  remoteMethodParameter = class;                { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Alias] }

  { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Smpl] }
  ...
  { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[GblSmpl] }
  ...
  DateType        =  type WideString;      { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[GblSmpl] }


  // ************************************************************************ //
  // XML       : FilterType, global, <complexType>
  // Namespace : urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov
  // ************************************************************************ //
  ...
  FatImagesType = array of image;               { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblCplx] }
  ...
  ShallowStudiesStudiesType = array of study;   { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[GblCplx] }
  ...
  RemoteMethodInputParameterType = array of remoteMethodParameter;   { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[GblCplx] }
  ...
  TransactionIdentifierType =  type WideString;      { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[GblSmpl] }
  RemoteMethodNameType =  type WideString;      { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[GblSmpl] }
  ...
  getStudyImageListResponse =  type FatImagesType;      { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Lit][GblElm] }
  ...
  multipleValue   =  type WideString;      { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[Alias] }
  RemoteMethodParameterMultipleType = array of multipleValue;   { "urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov"[GblCplx] }
  ...
  // port      : ImageMetadataClinicalDisplay.V6
  ...
  ['{458CBC57-692F-3A1F-9647-96948FA6BE7B}']
...
const
  defWSDL = 'imagingClinicalDisplaySOAP_v6.wsdl';
  ...
  defPrt  = 'ImageMetadataClinicalDisplay.V6';
var
  RIO: THTTPRIO;
begin
  Result := nil;
...
initialization
  InvRegistry.RegisterInterface(TypeInfo(ImageClinicalDisplayMetadata), 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'UTF-8');
  ...
  RemClassRegistry.RegisterXSInfo(TypeInfo(DateType), 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'DateType');
  RemClassRegistry.RegisterXSInfo(TypeInfo(origin), 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'origin');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(origin), 'NON_VA', 'NON-VA');
  RemClassRegistry.RegisterXSClass(FilterType, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'FilterType');
  ...
  RemClassRegistry.RegisterXSClass(UserCredentialsType, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'UserCredentialsType');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(UserCredentialsType), 'client_version', 'client-version');
  RemClassRegistry.RegisterXSInfo(TypeInfo(eventType), 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'eventType');
  RemClassRegistry.RegisterXSClass(ImageAccessLogEventType, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'ImageAccessLogEventType');
  ...
  RemClassRegistry.RegisterXSClass(FatImageType, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'FatImageType');
  ...
  RemClassRegistry.RegisterXSInfo(TypeInfo(FatImagesType), 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'FatImagesType');
  RemClassRegistry.RegisterSerializeOptions(TypeInfo(FatImagesType), [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(ShallowStudyType, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'ShallowStudyType');
  ...
  RemClassRegistry.RegisterXSInfo(TypeInfo(ShallowStudiesErrorType), 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'ShallowStudiesErrorType');
  RemClassRegistry.RegisterXSClass(ShallowStudiesErrorMessageType, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'ShallowStudiesErrorMessageType');
  RemClassRegistry.RegisterXSInfo(TypeInfo(ShallowStudiesStudiesType), 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'ShallowStudiesStudiesType');
  RemClassRegistry.RegisterXSClass(ShallowStudiesType, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'ShallowStudiesType');
  ...
  RemClassRegistry.RegisterXSClass(ShallowStudiesResponseType, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'ShallowStudiesResponseType');
  RemClassRegistry.RegisterSerializeOptions(ShallowStudiesResponseType, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(ImageAccessEventType, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'ImageAccessEventType');
  RemClassRegistry.RegisterSerializeOptions(ImageAccessEventType, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(ImageInformationType, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'ImageInformationType');
  RemClassRegistry.RegisterSerializeOptions(ImageInformationType, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(ImageSystemGlobalNodeType, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'ImageSystemGlobalNodeType');
  RemClassRegistry.RegisterSerializeOptions(ImageSystemGlobalNodeType, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(ImageDevFieldsType, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'ImageDevFieldsType');
  RemClassRegistry.RegisterSerializeOptions(ImageDevFieldsType, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(StudyReportType, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'StudyReportType');
  RemClassRegistry.RegisterSerializeOptions(StudyReportType, [xoLiteralParam]);
  RemClassRegistry.RegisterXSInfo(TypeInfo(RemoteMethodParameterTypeType), 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'RemoteMethodParameterTypeType');
  RemClassRegistry.RegisterXSClass(RemoteMethodParameterType, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'RemoteMethodParameterType');
  RemClassRegistry.RegisterXSInfo(TypeInfo(RemoteMethodInputParameterType), 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'RemoteMethodInputParameterType');
  RemClassRegistry.RegisterXSClass(RemoteMethodResponseType, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'RemoteMethodResponseType');
  RemClassRegistry.RegisterSerializeOptions(RemoteMethodResponseType, [xoLiteralParam]);
  RemClassRegistry.RegisterXSInfo(TypeInfo(pingResponse), 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'pingResponse');
  RemClassRegistry.RegisterXSClass(PingServerType, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'PingServerType');
  RemClassRegistry.RegisterSerializeOptions(PingServerType, [xoLiteralParam]);
  RemClassRegistry.RegisterXSInfo(TypeInfo(prefetchResponse), 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'prefetchResponse');
  RemClassRegistry.RegisterXSClass(PrefetchResponseType, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'PrefetchResponseType');
  RemClassRegistry.RegisterSerializeOptions(PrefetchResponseType, [xoLiteralParam]);
  RemClassRegistry.RegisterXSInfo(TypeInfo(PatientSensitivityLevelType), 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'PatientSensitivityLevelType');
  RemClassRegistry.RegisterXSClass(PatientSensitiveCheckResponseType, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'PatientSensitiveCheckResponseType');
  RemClassRegistry.RegisterXSClass(PatientSensitiveCheckWrapperResponseType, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'PatientSensitiveCheckWrapperResponseType');
  RemClassRegistry.RegisterSerializeOptions(PatientSensitiveCheckWrapperResponseType, [xoLiteralParam]);
  RemClassRegistry.RegisterXSInfo(TypeInfo(TransactionIdentifierType), 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'TransactionIdentifierType');
  RemClassRegistry.RegisterXSInfo(TypeInfo(RemoteMethodNameType), 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'RemoteMethodNameType');
  RemClassRegistry.RegisterXSClass(getPatientSensitivityLevel, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'getPatientSensitivityLevel');
  ...
  RemClassRegistry.RegisterXSClass(getPatientSensitivityLevelResponse, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'getPatientSensitivityLevelResponse');
  RemClassRegistry.RegisterXSClass(getPatientShallowStudyList, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'getPatientShallowStudyList');
  ...
  RemClassRegistry.RegisterXSClass(getPatientShallowStudyListResponse, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'getPatientShallowStudyListResponse');
  RemClassRegistry.RegisterXSClass(getStudyImageList, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'getStudyImageList');
  ...
  RemClassRegistry.RegisterXSInfo(TypeInfo(getStudyImageListResponse), 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'getStudyImageListResponse');
  RemClassRegistry.RegisterXSClass(postImageAccessEvent, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'postImageAccessEvent');
  ...
  RemClassRegistry.RegisterXSClass(postImageAccessEventResponse, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'postImageAccessEventResponse');
  RemClassRegistry.RegisterXSClass(pingServer, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'pingServer');
  ...
  RemClassRegistry.RegisterXSClass(postPingServerResponse, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'postPingServerResponse');
  RemClassRegistry.RegisterXSClass(prefetchStudyList, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'prefetchStudyList');
  ...
  RemClassRegistry.RegisterXSClass(PrefetchStudyListResponse, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'PrefetchStudyListResponse');
  RemClassRegistry.RegisterXSClass(getImageInformation, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'getImageInformation');
  ...
  RemClassRegistry.RegisterXSClass(getImageInformationResponse, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'getImageInformationResponse');
  RemClassRegistry.RegisterXSClass(getImageSystemGlobalNode, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'getImageSystemGlobalNode');
  ...
  RemClassRegistry.RegisterXSClass(getImageSystemGlobalNodeResponse, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'getImageSystemGlobalNodeResponse');
  RemClassRegistry.RegisterXSClass(getImageDevFields, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'getImageDevFields');
  ...
  RemClassRegistry.RegisterXSClass(getImageDevFieldsResponse, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'getImageDevFieldsResponse');
  RemClassRegistry.RegisterXSClass(getStudyReport, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'getStudyReport');
  ...
  RemClassRegistry.RegisterXSClass(getStudyReportResponse, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'getStudyReportResponse');
  RemClassRegistry.RegisterXSClass(remoteMethodPassthrough, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'remoteMethodPassthrough');
  ...
  RemClassRegistry.RegisterXSClass(remoteMethodPassthroughResponse, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'remoteMethodPassthroughResponse');
  RemClassRegistry.RegisterXSClass(image, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'image');
  RemClassRegistry.RegisterXSClass(study, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'study');
  RemClassRegistry.RegisterXSInfo(TypeInfo(multipleValue), 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'multipleValue');
  RemClassRegistry.RegisterXSInfo(TypeInfo(RemoteMethodParameterMultipleType), 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'RemoteMethodParameterMultipleType');
  RemClassRegistry.RegisterXSClass(RemoteMethodParameterValueType, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'RemoteMethodParameterValueType');
  RemClassRegistry.RegisterXSClass(remoteMethodParameter, 'urn:v6.soap.webservices.clinicaldisplay.imaging.med.va.gov', 'remoteMethodParameter');
