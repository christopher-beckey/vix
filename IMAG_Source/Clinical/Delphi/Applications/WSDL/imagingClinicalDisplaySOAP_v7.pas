...
// Encoding : UTF-8
// Version  : 1.0
// (7/5/2011 10:00:38 AM - - $Rev: 10138 $)
// ************************************************************************ //
...
type
  ...
  source = (ClinicalDisplay, VistARad);
  ...
  published
    ...
    property annotations_included:  Boolean     read Fannotations_included write Fannotations_included;
  end;
...
initialization
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(FatImageType), 'annotations_included', 'annotations-included');
