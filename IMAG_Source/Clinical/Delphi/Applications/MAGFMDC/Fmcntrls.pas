...
procedure Register;
begin
  //RegisterComponents('MagFileMan', [TFMEdit, TFMMemo, TFMListbox]);
  //RegisterComponents('MagFileMan', [TFMComboBox, TFMComboBoxLookUp]);
  //RegisterComponents('MagFileMan', [TFMRadioButton, TFMRadioGroup, TFMCheckBox, TFMLabel]);
end;
