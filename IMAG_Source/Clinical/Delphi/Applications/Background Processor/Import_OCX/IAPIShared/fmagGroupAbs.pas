...
Begin
  ...
  begin
    MagLogger.LogMsg('DI', TMag4Vgear(PopupVImage.PopupComponent).PI_ptrData.GetViewStatusMsg, MagLogINFO);
  end
  else
  begin
...
Begin
  ...
  //  if (iobj.PlaceCode <> wrksplacecode) then    // JMW 3/2/2005 p45
    ...
    ImsgObj.LogMsg('s', 'Attempting deletion of ' + IObj.FFile + '  IEN ' + IObj.Mag0);
...
Begin
  caption := 'Group Abstracts: (' + Inttostr(Mag4Viewer1.GetImageCount) + ')' + Dmod.MagPat1.M_NameDisplay;
