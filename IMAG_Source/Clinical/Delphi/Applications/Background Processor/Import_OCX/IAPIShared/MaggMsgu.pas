...
Type
  ...
  Private
    ...
    Function MiniSaveMemoryToZipFile(Var sList: Tstringlist): Boolean; {/ JK 12/17/2009 - P94 /}
  Public
    ...
    {TODO:  get this out of here, move to unit with related functions }
...
//    procedure IENsToMsgWindow(t: Tlist);
    ...
    Property RetroStyle: Boolean Read FRetroStyle Write FRetroStyle;
...
Begin
  ...
  If frmMaggMsg <> Nil Then
    If frmMaggMsg.PrivLevel <> plUser Then
      reMemo.BringToFront;
...
Begin
  ...
  MagLoggerHelp := AppPath + '\MaggMsgu_Help.pdf';
...
Begin
  ...
  Begin
    ...
    Begin
      ...
      If WriteImmediate <> True Then
        WriteImmediate := False;

      frmMaggMsg.WriteImmediate := WriteImmediate;
