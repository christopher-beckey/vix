...
//Uses Vetted 20090929:fmxutils, uMagClasses, cMagImageUtility, sysutils
    ...
    Begin
      Try
        ...
        Begin
          ...
          MagLogger.LogMsg('', 'Error caching image to [' + ExtractFileName(DestinationName) + ']', MagLogERROR); {JK 10/5/2009 - Maggmsgu refactoring}
        End;
//        copyfile(imagename, destinationName);
      Except
        ...
        Begin
          ...
          MagLogger.LogMsg('s', 'Error caching image [' + ImageName + ']. Error=[' + e.Message + '].'); {JK 10/5/2009 - Maggmsgu refactoring}
  ...
  Begin
    ...
    MagLogger.LogMsg('s', 'Unable to cache image [' + ImageName + ']. File does not exist on remote server.'); {JK 10/5/2009 - Maggmsgu refactoring}
  End;
End;
