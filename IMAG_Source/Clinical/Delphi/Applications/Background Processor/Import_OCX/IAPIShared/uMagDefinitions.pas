...
{ TODO -ogarrett -c117 :  get this out of here.  don't want coupled to magguini..}
  gDebugUser: boolean; //P106 BB debug added to capture, value kept in .ini
Implementation
Uses
  Forms,
  SysUtils,
...
Begin
  ...
  Begin
    ...
    FScope := MagPiece(Value, '^', 11);
        { TODO -ogarrett -c93 :   Need to follow through,
