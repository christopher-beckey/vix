...
//Uses Vetted 20090929:FMagAnnotation
...
//procedure TmagViewerRadTB2.LogMsg(MsgType : String; Msg : String; Priority : TMagLogPriority = MagLogINFO);
//begin
...
Begin
  //LogMsg('s','TmagViewerRadTB2.addViewerToToolbar', MagLogDEBUG);
  MagLogger.LogMsg('s', 'TmagViewerRadTB2.addViewerToToolbar', MagLogDebug); {JK 10/6/2009 - Maggmsgu refactoring}
  NilIndex := -1;
...
Var
  Count, i: Integer;
Begin
  //LogMsg('s','TmagViewerRadTB2.removeViewerFromToolbar', MagLogDEBUG);
  MagLogger.LogMsg('s', 'TmagViewerRadTB2.removeViewerFromToolbar', MagLogDebug); {JK 10/6/2009 - Maggmsgu refactoring}
  Count := (High(FViewerArray));
  For i := 0 To Count Do
  Begin
    If (Viewer = FViewerArray[i]) Then
