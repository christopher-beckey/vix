...
//dmod.MagUtilsDB1.ImageCopy(magvgear,stat,xmsg);
  Dmod.MagUtilsDB1.ImageTextFileCopy(FIObj, MemTextFile, 'VistA Imaging Copy');
  Dmod.MagDBBroker1.RPLogCopyAccess(Reason + '^^' + FIObj.Mag0 + '^' +
...
//begin
//  inherited;
//dmod.MagUtilsDB1.ImageTextFilePrint(FIobj,memTextFile.Lines,'VistA Imaging Print');
Var
  Xmsg, Reason: String;
  Stat: Boolean;
Begin
