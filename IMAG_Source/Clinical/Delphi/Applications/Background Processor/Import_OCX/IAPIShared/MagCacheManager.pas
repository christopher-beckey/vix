...
//      maggmsgf.MagMsg('s','Caching of study started');
      ...
      MagLogger.LogMsg('s', 'Caching of study started'); {JK 10/6/2009 - Maggmsgu refactoring}
    End
    Else
      ...
      //LogMsg('s','Caching of study complete');
        MagLogger.LogMsg('s', 'Caching of study complete'); {JK 10/6/2009 - Maggmsgu refactoring}
      End
      Else
      Begin
        ...
        Begin
          ...
          //LogMsg('s','Auto-caching file: [' + NetworkFilename + ']');
            MagLogger.LogMsg('s', 'Auto-caching file: [' + NetworkFilename + ']'); {JK 10/6/2009 - Maggmsgu refactoring}
          ...
          //LogMsg('s','Cache complete [' + NetworkFilename + ']');
            MagLogger.LogMsg('s', 'Cache complete [' + NetworkFilename + ']'); {JK 10/6/2009 - Maggmsgu refactoring}
            aThread := Nil;
            CurrentCacheFile := '';
          End;
        End
        ...
        //LogMsg('s','File [' + extractfilename(destinationfilename) + '] already exists, no caching needed.');
          MagLogger.LogMsg('s', 'File [' + ExtractFileName(DestinationFilename) + '] already exists, no caching needed.'); {JK 10/6/2009 - Maggmsgu refactoring}
        End;
      End;
    ImageList.Delete(0);
  End;
