  ...
  Try
    ...
    Begin
      ...
      {/ P117 - JK 9/21/2010 - added 3rd param /} {/p117 gek used Upref instead of umagdisplay variable.}
       Dmod.MagDBBroker1.RPMag4GetImageInfo(IObj, t, upref.UseDelImagePlaceHolder);  {}
      ...
      Begin
        MagReplaceStrings(Dmod.MagPat1.M_PatName, Dmod.MagPat1.M_NameDisplay, Tstr);
        MagReplaceStrings(Dmod.MagPat1.M_SSN, '000000000', Tstr);
        MagReplaceStrings(Dmod.MagPat1.M_SSNdisplay, '000-00-0000', Tstr);
      End;
