...
//Uses Vetted 20090929:GearCORELib_TLB, Dialogs, Graphics, Classes, Variants, Messages, Windows, GearFORMATSLib_TLB, SysUtils
...
//        If (Not (DataSet.ElemCount > 0)) Then
  ...
  Except
    On e: Exception Do
    Begin
      //LogMsg('s','Exception loading DICOM header, ' + e.Message, magLogError);
      MagLogger.LogMsg('s', 'Exception loading DICOM header, ' + e.Message, MagLogERROR); {JK 10/5/2009 - Maggmsgu refactoring}
    End;
  End;
  Self.Showmodal();
