...
function MakeThumbForImage(Imagefile, Thumbfilename: String; VIGPageViewCtl: TIGPageViewCtl; var rmsg : string) : boolean;
...
Begin
  result := false;
  rmsg := 'Unknown Error creating Abstract';
  If Not FileExists(Imagefile) Then
    begin
     rmsg := ' Image file does not exist. ' + Imagefile;
     exit;
    end;
  if thumbfilename = '' then
    begin
      rmsg := 'Name of abstract file is <null>';
      exit;
    end;
try
