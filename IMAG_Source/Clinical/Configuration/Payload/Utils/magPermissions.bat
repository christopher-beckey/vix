...
echo y|cacls.exe "%INSTALLDIR%\Bmp" /G Everyone:F
echo y|cacls.exe "%INSTALLDIR%\Cache" /G Everyone:F
echo y|cacls.exe "%INSTALLDIR%\Image" /G Everyone:F
echo y|cacls.exe "%INSTALLDIR%\Import" /G Everyone:F
echo y|cacls.exe "%INSTALLDIR%\Lib" /G Everyone:F
echo y|cacls.exe "%INSTALLDIR%\Muse" /G Everyone:F
