...
{
    public class DSREnhancedSRConstraintChecker : DSRIODConstraintChecker
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public DSREnhancedSRConstraintChecker()
        {
        }
        ...
        {
            return E_DocumentType.DT_EnhancedSR;
        }
                                                                        ...
                                                                        bool byReference = false)
        {
            ...
            if (!byReference)
            {
                ...
                /* row 3 of the table */
                    ...
                    (sourceValueType == E_ValueType.VT_Waveform) || (sourceValueType == E_ValueType.VT_Composite) || (sourceValueType == E_ValueType.VT_Num /* see CP 571 */)))
                {
                    result = (targetValueType == E_ValueType.VT_Text) || (targetValueType == E_ValueType.VT_Code) || (targetValueType == E_ValueType.VT_Num) ||
                             (targetValueType == E_ValueType.VT_DateTime) || (targetValueType == E_ValueType.VT_Date) || (targetValueType == E_ValueType.VT_Time) ||
                    ...
                    ((sourceValueType == E_ValueType.VT_Text) || (sourceValueType == E_ValueType.VT_Code) || (sourceValueType == E_ValueType.VT_Num)))
                {
                    result = (targetValueType == E_ValueType.VT_Text) || (targetValueType == E_ValueType.VT_Code) || (targetValueType == E_ValueType.VT_Num) ||
                             ...
                             (targetValueType == E_ValueType.VT_TCoord);
                }
                /* row 7 of the table */
