...
namespace Hydra.Dicom
{
...

    {
        ...
        /// </summary>
        internal TargaExtensionArea ExtensionArea
        {
        ...
        /// </summary>
        internal TargaImage(string strFileName) : this()
        {
            // make sure we have a .tga file
            if (System.IO.Path.GetExtension(strFileName).ToLower() == ".org" || System.IO.Path.GetExtension(strFileName).ToLower() == ".tga")
            {
        ...
        private void _LoadImage(Stream filestream)
        {
            // create a BinaryReader used to read the Targa file
        ...
        private void LoadTGAHeaderInfo(BinaryReader binReader)
        {
            ...
            if (binReader != null && binReader.BaseStream != null && binReader.BaseStream.Length > 0 && binReader.BaseStream.CanSeek == true)
            {
                try
                {
                    ...
                    this.objTargaHeader.SetImageType((TargaImageType)binReader.ReadByte());
                ...
                {
                    if (this.objTargaHeader.ImageType == TargaImageType.UNCOMPRESSED_COLOR_MAPPED || 
                        this.objTargaHeader.ImageType == TargaImageType.RUN_LENGTH_ENCODED_COLOR_MAPPED)
                    {
        ...
        private byte[] LoadImageBytes(BinaryReader binReader)
        {
            ...
            if (binReader != null && binReader.BaseStream != null && binReader.BaseStream.Length > 0 && binReader.BaseStream.CanSeek == true)
            {
                if (this.objTargaHeader.ImageDataOffset > 0)
                {
                    ...
                    if (this.objTargaHeader.ImageType == TargaImageType.RUN_LENGTH_ENCODED_BLACK_AND_WHITE ||
                       this.objTargaHeader.ImageType == TargaImageType.RUN_LENGTH_ENCODED_COLOR_MAPPED ||
                       this.objTargaHeader.ImageType == TargaImageType.RUN_LENGTH_ENCODED_TRUE_COLOR)
                    {
        ...
        private void LoadTGAImage(BinaryReader binReader)
        {
            ...
            { // no color map
                ...
                if (this.objTargaHeader.PixelDepth == 8 && (this.objTargaHeader.ImageType == TargaImageType.UNCOMPRESSED_BLACK_AND_WHITE ||
                    this.objTargaHeader.ImageType == TargaImageType.RUN_LENGTH_ENCODED_BLACK_AND_WHITE))
                {
        ...
        internal static Bitmap LoadImage(Stream fileStream)
        {
            Bitmap b = null;
            using (TargaImage ti = new TargaImage())
            {
                ti._LoadImage(fileStream);
        ...
        internal static Bitmap LoadTargaImage(string sFileName)
        {
            Bitmap b = null;
        ...
        internal static void ConvertToJpeg(string imageFilePath, string destinationFilePath, int imageWidth, int imageHeight)
        {
            Bitmap bitmap = LoadTargaImage(imageFilePath);
            if (bitmap != null)
            {
                ...
                ImageResizer.ImageBuilder.Current.Build(bitmap, destinationFilePath, settings);
            }            
        }
    }
    ...
    internal class TargaHeader
    {
        ...
        private TargaImageType eImageType = TargaImageType.NO_IMAGE_DATA;
        ...
        /// </summary>
        internal ColorMapType ColorMapType
        {
        ...
        /// </summary>
        internal TargaImageType ImageType
        {
        ...
        internal protected void SetImageType(TargaImageType eImageType)
        {
        ...
        /// </summary>
        internal short ColorMapFirstEntryIndex
        {
        ...
        /// </summary>
        internal byte ColorMapEntrySize
        {
        ...
        /// </summary>
        internal VerticalTransferOrder VerticalTransferOrder
        {
        ...
        /// </summary>
        internal HorizontalTransferOrder HorizontalTransferOrder
        {
        ...
        /// </summary>
        internal System.Collections.Generic.List<System.Drawing.Color> ColorMap
        {
    ...
    internal class TargaFooter
    {
        ...
        /// </summary>
        internal int ExtensionAreaOffset
        {
        ...
        /// </summary>
        internal int DeveloperDirectoryOffset
        {
        ...
        /// </summary>
        internal string ReservedCharacter
        {
    ...
    internal class TargaExtensionArea
    {
        ...
        /// </summary>
        internal string AuthorComments
        {
        ...
        /// </summary>
        internal int PixelAspectRatioNumerator
        {
        ...
        /// </summary>
        internal int PixelAspectRatioDenominator
        {
        ...
        /// </summary>
        internal int ColorCorrectionOffset
        {
        ...
        /// </summary>
        internal int PostageStampOffset
        {
        ...
        /// </summary>
        internal System.Collections.Generic.List<int> ScanLineTable
        {
        ...
        /// </summary>
        internal System.Collections.Generic.List<System.Drawing.Color> ColorCorrectionTable
        {
