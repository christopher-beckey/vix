        ...
        easyResponsiveTabs: function (options) {
            ...
            this.each(function () {
                ...
                $respTabs.find('.resp-accordion').each(function () {
                    ...
                    if ($respTabs[0].id == "content_View") {
                        $accItem.addClass($tabItem[0].className.split(/\s+/)[0]);
                    }
                ...
                $respTabs.find("[role=tab]").each(function () {
                    ...
                    $currentTab.click(function () {
                        $prevActiveTab = $(this);
                        if ($prevActiveTab[0].parentElement.parentElement.id !== "lblTypeMenu") {
                            sanityCheck(callback);
                        } else {
                            callback();
                        }
                    });
