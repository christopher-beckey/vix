  ...
  JSONFormatter = (function() {
    ...
    JSONFormatter.prototype.stringToHTML = function(value) {
      ...
      if (/^(http|https|file):\/\/[^\s]+$/i.test(value)) {
        return "<a href=\"" + (this.htmlEncode(value)) + "\" target=\"_blank\"><span class=\"q\">\"</span>" + (this.jsString(value)) + "<span class=\"q\">\"</span></a>";
      } else {
        multilineClass = '';
    ...
    JSONFormatter.prototype.objectToHTML = function(object, level) {
      ...
      for (prop in object) {
        ...
        output += "<li><a class=\"prop\" href=\"javascript:;\" target=\"_blank\"><span class=\"q\">\"</span>" + key + "<span class=\"q\">\"</span></a>: " + (this.valueToHTML(value, level + 1));
        if (numProps > 1) {
          output += ',';
        }
        output += '</li>';
