...
namespace ECGViewer
{
	...
	public class ECGViewer : System.Windows.Forms.Form
	{
        ...
        private ECGDraw.GridType DisplayGrid = ECGDraw.GridType.OneMillimeters;
		...
		public ECGViewer(string[] args)
		{
			...
			this.menuGridNone.Checked = this.DisplayGrid == ECGDraw.GridType.None;
            this.menuGridOne.Checked = this.DisplayGrid == ECGDraw.GridType.OneMillimeters;
            this.menuGridFive.Checked = this.DisplayGrid == ECGDraw.GridType.FiveMillimeters;
		...
		private void InnerECGPanel_Paint(object sender, PaintEventArgs e)
		{
			lock (this)
			{
				...
				if (_DrawBuffer == null)
				{
					...
					int
						oldSPS = _CurrentSignal.RhythmSamplesPerSecond,
						ret = ECGDraw.DrawECG(Graphics.FromImage(_DrawBuffer), this.DisplayGrid, _CurrentSignal, _DrawType, ECGTimeScrollbar.Value, 25.0f, _Gain, true);
					...
					if (ret < 0)
					{
                        ...
                        ret = ECGDraw.DrawECG(g, this.DisplayGrid, _CurrentSignal, ECGDraw.ECGDrawType.Regular, ECGTimeScrollbar.Value, 25.0f, _Gain, false);
					}
		...
		private void menuGridOne_Click(object sender, System.EventArgs e)
		{
			...
			this.DisplayGrid = ECGDraw.GridType.OneMillimeters;
		...
		private void menuGridFive_Click(object sender, System.EventArgs e)
		{
			...
			this.DisplayGrid = ECGDraw.GridType.FiveMillimeters;
		...
		private void menuGridNone_Click(object sender, System.EventArgs e)
		{
			...
			this.DisplayGrid = ECGDraw.GridType.None;
