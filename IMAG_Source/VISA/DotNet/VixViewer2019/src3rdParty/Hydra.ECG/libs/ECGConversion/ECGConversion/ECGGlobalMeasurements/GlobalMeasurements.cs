...
namespace ECGConversion.ECGGlobalMeasurements
{
	...
	public class GlobalMeasurements
	{
        ...
        private ushort _PRint = GlobalMeasurement.NoValue;
        private ushort _QRSdur = GlobalMeasurement.NoValue;
        private ushort _QTdur = GlobalMeasurement.NoValue;
		...
		public ushort PRint
		{
			get
			{
                if (_PRint < GlobalMeasurement.NoValue)
                    return _PRint;
		...
		public ushort QRSdur
		{
			get
			{
                if (_QRSdur < GlobalMeasurement.NoValue)
                    return _QRSdur;
		...
		public ushort QTdur
		{
			get
			{
                if (_QTdur < GlobalMeasurement.NoValue)
                    return _QTdur;
