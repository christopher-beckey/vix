...
namespace ClearCanvas.Dicom
{
	...
	/// </summary>
	public static class DirectoryRecordDictionary
	{
		...
		static DirectoryRecordDictionary()
		{
            ...
            _sopClassLookup.Add(SopClass.Sop12LeadEcgWaveformStorageUid, DirectoryRecordType.Waveform);
		...
		public static bool TryGetDirectoryRecordType(string uid, out DirectoryRecordType type)
		{
		...
		/// <returns></returns>
        public static bool TryGetDirectoryRecordTagList(DirectoryRecordType type, out List<uint> tagList)
		{
