...
namespace ClearCanvas.Dicom
{
	...
	public partial class DicomAttributeCollection : IEnumerable<DicomAttribute>, IDicomAttributeProvider
	{
		...
		/// <param name="options"></param>
		/// <returns></returns>
        public uint CalculateWriteLength(TransferSyntax syntax, DicomWriteOptions options)
		{
		...
		/// <param name="options"></param>
		/// <returns></returns>
		public uint CalculateWriteLength(uint startTag, uint stopTag, TransferSyntax syntax, DicomWriteOptions options)
		{
			uint length = 0;
			ushort group = 0xffff;
