...
namespace DicomImporter.Views
{
    ...
    /// </summary>
    public partial class OrderingLocationLookupWindow
    {
        #region Constructors and Destructors

        /// <summary>
        /// Initializes a new instance of the <see cref="OrderingLocationLookupWindow"/> class.
        /// </summary>
        public OrderingLocationLookupWindow() : base()
        {
        ...
        /// The view model.
        /// </param>
        public OrderingLocationLookupWindow(OrderingLocationLookupViewModel viewModel) : base()
        {
            this.InitializeComponent();
        ...
        /// Gets ViewModel.
        /// </summary>
        public OrderingLocationLookupViewModel ViewModel
        {
            get
            {
                return (OrderingLocationLookupViewModel)this.DataContext;
            }
        }
        ...
        private void SearchTextBox_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            this.ViewModel.SelectedLocation = null;
