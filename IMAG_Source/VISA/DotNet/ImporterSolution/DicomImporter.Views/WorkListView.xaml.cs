...
namespace DicomImporter.Views
{
    ...
    public partial class WorkListView
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkListView"/> class.
        /// </summary>
        public WorkListView()
        {
        ...
        {
            if (this.dgWorkItems.SelectedItem != null)
            {
                this.dgWorkItems.ScrollIntoView(this.dgWorkItems.SelectedItem);
            }
        }
