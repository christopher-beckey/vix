...
namespace ImagingClient.Infrastructure.DialogService
{
    ...
    public interface IDialogService
    {
        ...
        /// </param>
        void ShowAlertBox(Window owner, Dispatcher uiDispatcher, string message, string caption, MessageTypes messageType);
        ...
        /// The type of the message
        /// </param>
        MessageBoxResult ShowAlertBox(Dispatcher uiDispatcher, string message, string caption, MessageTypes messageType);
        ...
        /// </param>
        void ShowExceptionWindow(Dispatcher uiDispatcher, Exception e);
