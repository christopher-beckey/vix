...
namespace VixHealthMonitor.ViewModel
{
    ...
    /// </para>
    /// </summary>
    public class VixCountsViewModel : VixCountsModel// ViewModelBase
    {
        

        public VixCountsViewModel()
        {
            Messenger.Default.Register<ReloadSourcesMessage>(this, action => LoadVixSites(action));
        }

        /*
        public override ObservableCollection<VixHealthMonitorCommon.VixHealthSource> GetVixSources()
        {
            return VixSources;
        }*/
        ...
        public VixCountsViewModel()
        {
            ...
            else
            {
                ...
                // this ensures we get update messages to know how many sites there are to count with
                Messenger.Default.Register<ReloadSourcesMessage>(this, action => LoadVixSites(action));
        ...
        private void UpdateValues()
        {
            ...
            {
                if (vixHealthSource.VixHealth.VisaHealth.LoadStatus == VixHealthLoadStatus.loaded)
                {
                    healthLoadedCount++;
        ...
        */
        ...
        {
            return VixSourceHolder.getSingleton().VisaSources;
        }
    }
}