...
extends AbstractImagePropertyTag
{
	...
	public void setImageQuality(String imageQualityExternalForm)
    {
		...
		catch(IllegalArgumentException iaX)
		{
            ...
            {
                logger.warn("Image Quality '{}' is neither a valid ImageQuality or number between 1 and 100, defaulting to DIAGNOSTIC.", imageQualityExternalForm);
	...
	public void setContentType(String contentTypeExternalForm)
    {
        ...
        {
            logger.warn("Content Type '{}' is not a valid ImageFormat, defaulting to DICOMJPEG2000.", contentTypeExternalForm);
