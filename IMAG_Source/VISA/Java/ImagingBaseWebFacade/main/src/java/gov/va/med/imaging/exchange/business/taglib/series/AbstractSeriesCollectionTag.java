...
extends BodyTagSupport
{
	...
	private static final Logger LOGGER = Logger.getLogger(AbstractSeriesCollectionTag.class);
    ...
    throws JspException
    {
    	...
    	if(getEmptyResultMessage() != null)
    		...
    		{
    			LOGGER.error("AbstractSeriesCollectionTag.doStartTag() --> Unable to write empty result set message.");
    		}
