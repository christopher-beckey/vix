...
extends AbstractBaseImageServlet
{
	...
	private static final Logger LOGGER = Logger.getLogger(DiagnosticServlet.class);
	...
	throws ServletException, IOException
    {
		...
		else
		{
            ...
            LOGGER.info("DiagnosticServlet.doGet() --> Getting diagnostic image path [{}]", pathInfo);
	        ...
	        {
				String msg = "DiagnosticServlet.doGet() --> [" + Encode.forHtmlContent(imageIdentifier) + "] is not a valid image identifier (ImageURN): " + e.getMessage();
				LOGGER.info(msg);
