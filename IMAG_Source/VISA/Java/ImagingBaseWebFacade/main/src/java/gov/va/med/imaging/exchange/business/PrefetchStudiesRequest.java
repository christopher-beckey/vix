...
extends AbstractBaseServlet
{
	...
	throws ServletException, IOException
    {
		...
		if(imageQuality != null)
		{
			...
			{
                getLogger().warn("PrefetchStudiesRequest.doPost() --> Invalid image quality parameter [{}] is being ignored, 'reference' quality images will be prefetched.", imageQuality);
			}
		}
	...
	throws IOException
	{
		...
		writer.write("<message>");
		// Fortify change: can't expose underlying errors
        getLogger().error("Encountered an error: {}", message);
		writer.write("Error");
		writer.write("</message>");
		writer.write("</prefetch-request-response>");
	}
	...
	throws ServletException
	{
		...
		{
            getLogger().warn("PrefetchStudiesRequest.getRouter() --> Return null. Exception getting the facade router implementation: {}", x.getMessage());
			return null;
		}
