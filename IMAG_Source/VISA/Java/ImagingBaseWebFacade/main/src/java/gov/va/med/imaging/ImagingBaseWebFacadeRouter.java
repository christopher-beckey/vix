...
extends gov.va.med.imaging.BaseWebFacadeRouter
{
	 ...
	 * @param routingToken
	 * @param PhotoIDInformationNotification
	 * @param remote
	 * @return
	 * @throws MethodException
	 * @throws ConnectionException
	 */
	@FacadeRouterMethod(asynchronous=false, commandClassName="GetPatientIdentificationImageCommand")
	public abstract InputStream getRemotePatientIdentificationImage(
		PatientIdentifier patientIdentifier,
		RoutingToken routingToken,
