 ...
 *
 */
public class VixServerHealthViewTransactionLogStatisticsTransactionsQueriedTag
extends AbstractVixServerHealthViewPropertyTag
{
	...
	public String getElementValue() throws JspException
	{
		...
		return vixServerHealthView.getTransactionLogStatisticsTransactionsQueried();
	}
