 ...
 *
 */
public class VixServerHealthViewTransactionLogStatisticsTransactionsPerMinuteTag
extends AbstractVixServerHealthViewPropertyTag
{
	...
	public String getElementValue() throws JspException
	{
		...
		return vixServerHealthView.getTransactionLogStatsTransactionsPerMinute();
	}
}
