 ...
 *
 */
public class VixServerHealthViewTransactionLogStatisticsTransactionReadErrorsTag
extends AbstractVixServerHealthViewPropertyTag
{
	...
	public String getElementValue() throws JspException
	{
		...
		return vixServerHealthView.getTransactionLogStatsTransactionReadErrors();
	}
}
