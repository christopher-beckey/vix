 ...
 *
 */
public class VixServerHealthViewTransactionLogStatisticsTransactionsWrittenTag
extends AbstractVixServerHealthViewPropertyTag
{
	...
	public String getElementValue() throws JspException
	{
		...
		return vixServerHealthView.getTransactionLogStatisticsTransactionsWritten();
	}
}
