 ...
 *
 */
public class VixServerHealthConfigurationTag 
extends AbstractVixServerHealthConfigurationTag 
{

	private static final long serialVersionUID = 1L;

	/* (non-Javadoc)
	 * @see gov.va.med.imaging.vixserverhealth.configuration.taglib.AbstractVixServerHealthConfigurationTag#getVixServerHealthWebAppConfiguration()
	 */
	@Override
