 ...
 *
 */
public class VixServerHealthViewVixCacheOperationsSuccessfulTag 
extends AbstractVixServerHealthViewPropertyTag 
{
	...
	throws JspException 
	{
		return this.getVixServerHealthView().getVixCacheOperationsSuccessful();
	}
}
