 ...
 *
 */
public class VixServerHealthViewTransactionLogStatisticsTransactionWriteErrorsTag
extends AbstractVixServerHealthViewPropertyTag
{
	...
	public String getElementValue() throws JspException
	{
		...
		return vixServerHealthView.getTransactionLogStatsTransactionWriteErrors();
	}
}
