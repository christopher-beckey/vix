 ...
 *
 */
public class DataDictionaryCommandCreatorProvider 
extends CommandCreatorProvider
{

	public DataDictionaryCommandCreatorProvider()
	{
	...
	protected String[] getCommandPackageNames() 
	{
		return new String []
           {
				"gov.va.med.imaging.router.commands.dd"
           };
	}
	...
	private synchronized static CommandContext getLocalCommandContext(CommandContext baseCommandContext)
	{
		...
		{
			localCommandContext = new DataDictionaryCommandContext(baseCommandContext);
		}
