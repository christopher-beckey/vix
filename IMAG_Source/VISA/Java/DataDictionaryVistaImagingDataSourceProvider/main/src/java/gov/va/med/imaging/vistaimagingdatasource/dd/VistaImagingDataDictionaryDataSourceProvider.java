 ...
 *
 */
public class VistaImagingDataDictionaryDataSourceProvider
extends Provider
{
	private static final String PROVIDER_NAME = "VistaImagingDataDictionaryDataSource";
	 ...
	 * to create instances.
	 */
	public VistaImagingDataDictionaryDataSourceProvider()
	{
	 ...
	 * @param info
	 */
	private VistaImagingDataDictionaryDataSourceProvider(String name, double version, String info)
	{
		...
		services.add(
				new ProviderService(
					...
					VistaImagingDataDictionaryDataSourceService.SUPPORTED_PROTOCOL,
					1.0F,
