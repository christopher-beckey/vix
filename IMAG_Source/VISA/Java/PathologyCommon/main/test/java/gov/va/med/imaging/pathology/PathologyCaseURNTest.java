...
public class PathologyCaseURNTest
{
	...
	public void testToString()
	{
		try
		{
			...
			// test with DFN -- PathologyCaseURN not working with DFN PatientIdentifier
			// PatientIdentifier expects dfn(site-dfn) while PathologyCaseURN expects dfn(dfn)
//			PathologyCaseURN dfnUrn = PathologyCaseURN.create("660", "CY", "12", "34", 
//					new PatientIdentifier("100797", PatientIdentifierType.dfn));
//			assertNotSame(urnString,  dfnUrn);
//			String dfnUrnString = dfnUrn.toString();
//			System.out.print("\ndfnurnString: " + dfnUrnString + "\n");
//			assertEquals("urn:vapathologycase:660-CY-12-34-dfn(100797)", dfnUrn.toString());
//
//			PathologyCaseURN newCaseDfnUrn = URNFactory.create(dfnUrnString, PathologyCaseURN.class);
//			System.out.print("\nnewdfnurnString: " + newCaseDfnUrn.toString() + "\n");
