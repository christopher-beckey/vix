...
extends AbstractCommandImpl<java.lang.Void>
{
	...
	throws MethodException
	{
        ...
        getLogger().info("RouterImpl.logImageAccessEventInternal({}) for image [{}] by [{}].", getEvent().getEventType().toString(), getEvent().getImageIen(), xactionContext.getTransactionId());
