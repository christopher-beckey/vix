...
extends AbstractStudyCommandImpl<java.lang.Void>
{
	...
	throws MethodException
	{
        ...
        getLogger().info("Asynchronous Command [{}] - study list obtained, getting images", this.getClass().getSimpleName());
			...
			if( study.getSeries() != null )
				for(Series series : study.getSeries())
					for(Image image : series )
					{
                        ...
                        getLogger().info("Image command {} has been submitted for asynchronous execution.", image.getImageUrn());
					}
        getLogger().info("Asynchronous Command [{}] - completed.", this.getClass().getSimpleName());
