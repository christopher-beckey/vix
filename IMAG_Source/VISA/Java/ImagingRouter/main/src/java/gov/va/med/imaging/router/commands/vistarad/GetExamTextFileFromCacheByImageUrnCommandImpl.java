...
extends AbstractExamImageCommandImpl<Integer>
{
		...
		throws MethodException, ConnectionException
	{
		...
		{
            getLogger().info("Exam image Text file'{}' caching enabled", imageUrn.toString());
			try
			{
				...
				if(response != null)
				{
					...
					if( bytesReturned > 0 )
					{
                        ...
                        getLogger().info("Exam image txt file '{}' found in the cache and streamed to the destination.", imageUrn.toString());
						return bytesReturned;
					}
				}

                getLogger().info("Did not get exam image txt file [{}] from cache", imageUrn.toString());
