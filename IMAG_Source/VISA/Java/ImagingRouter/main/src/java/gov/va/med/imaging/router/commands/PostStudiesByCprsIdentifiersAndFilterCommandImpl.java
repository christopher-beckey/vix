...
import java.util.List;
	 ...
	 *
	 */
	public class PostStudiesByCprsIdentifiersAndFilterCommandImpl 
	extends AbstractStudyCommandImpl<List<Study>>
	{
		private static final long serialVersionUID = -7605009044618808407L;
		private final RoutingToken routingToken;
		private final List<CprsIdentifier> cprsIdentifiers;
		private final PatientIdentifier patientIdentifier;
		private final StudyFilter filter;
		
		public PostStudiesByCprsIdentifiersAndFilterCommandImpl(
		...
		{
			logger.debug("...executing PostStudiesByCprsIdentifiersAndFilterCommand.");
		...
		throws MethodException
		{
			...
			{
				List<Study> studies;
				studies = ImagingContext.getRouter().postStudiesByCprsIdentifiersAndFilter(
						getRoutingToken(), 
		...
		public boolean equals(Object obj)
		{
			...
			final PostStudiesByCprsIdentifiersAndFilterCommandImpl other = (PostStudiesByCprsIdentifiersAndFilterCommandImpl) obj;
