...
extends AbstractExamCommandImpl<PatientEnterpriseExams> 
{
	...
	class ExamSiteWaiter implements AsynchronousCommandResultListener
    {
		...
		public void setTimedOut()
	    {
            ...
            getLogger().debug("{} Asynchronous Commands: {} Completed OK, {} Failed, {} Orphaned.", examSiteMap.size(), numCommandsSucceeded, numCommandsFailed, numCommandsOrphaned);
	    ...
	    public void commandComplete(AsynchronousCommandResult result) 
	    {
			...
			{
				numCommandsFailed++;
                getLogger().warn("Failed to get ExamSite for Patient ID {}, Site Number {}.{}Details: {}", patientIcn, cmd.getRoutingToken(), lnSep, result.getException());
