...
extends AbstractExamCommandImpl<String>
{
	...
	throws MethodException, ConnectionException 
	{
        ...
        getLogger().info("Getting exam requisition report '{}, transaction ({}).", getStudyUrn(), transactionContext.getTransactionId());
		...
		{
            getLogger().info("Got requisition report for exam '{}' from cache", getStudyUrn().toString());
        ...
        getLogger().info("DID NOT get requisition report for exam '{}' from cache, requesting from data source", getStudyUrn().toString());
