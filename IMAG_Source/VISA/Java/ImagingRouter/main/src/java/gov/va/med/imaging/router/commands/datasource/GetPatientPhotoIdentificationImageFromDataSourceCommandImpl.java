 ...
 *
 */
public class GetPatientPhotoIdentificationImageFromDataSourceCommandImpl 
extends AbstractDataSourceCommandImpl<PatientPhotoID, PatientDataSourceSpi>
{	
	private static final long serialVersionUID = -1795435834769987885L;

	private static final String SPI_METHOD_NAME = "getPatientPhotoIdentificationImage";
	
	private final RoutingToken routingToken;
	private final PatientIdentifier patientIdentifier;
	
	public GetPatientPhotoIdentificationImageFromDataSourceCommandImpl(RoutingToken routingToken, PatientIdentifier patientIdentifier)
	{
	 ...
	 */
	@Override
	protected PatientPhotoID getCommandResult(PatientDataSourceSpi spi)
	throws ConnectionException, MethodException 
	{
		return spi.getPatientPhotoIdentificationImage(getPatientIdentifier());
	}
	 ...
	 */
	@Override
	protected PatientPhotoID postProcessResult(PatientPhotoID result) 
	{
