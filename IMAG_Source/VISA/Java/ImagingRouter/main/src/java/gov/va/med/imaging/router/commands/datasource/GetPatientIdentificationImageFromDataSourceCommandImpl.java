...
{	
	...
	private final boolean remote; //not used. Added to satisfy the Interface for Federation
	...
	public GetPatientIdentificationImageFromDataSourceCommandImpl(RoutingToken routingToken, PatientIdentifier patientIdentifier, boolean remote)
	{
