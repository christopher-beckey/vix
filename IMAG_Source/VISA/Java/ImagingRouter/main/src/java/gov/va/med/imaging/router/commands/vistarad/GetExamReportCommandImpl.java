...
extends AbstractExamCommandImpl<String>
{
	...
	throws MethodException, ConnectionException 
	{
        ...
        getLogger().info("Getting exam report '{}, transaction ({}).", getStudyUrn(), transactionContext.getTransactionId());
		...
		{
            getLogger().info("Got report for exam '{}' from cache", getStudyUrn().toString());
        ...
        getLogger().info("DID NOT get report for exam '{}' from cache, requesting from data source", getStudyUrn().toString());
