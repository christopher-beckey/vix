...
extends AbstractCommandImpl<java.lang.Void>
{
	...
	throws MethodException
	{
        ...
        getLogger().info("Asynchronous Command [{}] is being processed.", this.getClass().getSimpleName());
        ...
        getLogger().info("Asynchronous Command [{}] - patient ID image stream obtained.", this.getClass().getSimpleName());
    ...
    throws MethodException
    {
        ...
        getLogger().info("getPatientIdentificationImage - Transaction ID [{}] from site [{}] for patient [{}].", transactionContext.getTransactionId(), siteNumber, patientIdentifier);
		try
		{
			InputStream patientIdImageStream = 
				ImagingContext.getRouter().getPatientIdentificationImage(
					getRoutingToken(), 
					patientIdentifier );
            getLogger().info("{} for patient '{}'.", (patientIdImageStream == null) ? "Did not find ID image" : "Found ID image", patientIdentifier);
