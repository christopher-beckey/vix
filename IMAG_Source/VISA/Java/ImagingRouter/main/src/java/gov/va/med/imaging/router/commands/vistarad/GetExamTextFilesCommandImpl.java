...
extends AbstractExamImageCommandImpl<Long> 
{
	...
	throws MethodException, ConnectionException 
	{
        ...
        getLogger().info("Completed processing exam '{}' text files, processed '{}' files successfully, failed to process '{}' text files. Wrote '{}' total bytes", studyUrn.toString(), successfulTxtFiles, failedTxtFiles, totalBytes);
		return totalBytes;
	}
