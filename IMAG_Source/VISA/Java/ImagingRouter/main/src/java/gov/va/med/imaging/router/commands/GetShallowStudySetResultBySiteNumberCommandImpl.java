...
extends AbstractStudyCommandImpl<StudySetResult>
{
	...
	// Quoc removed this to use directly in statement below and changed to "FULL"
	// to prevent unnecessary second call for a full study list.
	...
	throws MethodException, ConnectionException
	{
		...
		//StudySetResult result = this.getPatientStudySetResult(getRoutingToken(), getPatientIdentifier(), getFilter(), studyLoadLevel);
		StudySetResult result = this.getPatientStudySetResult(getRoutingToken(), getPatientIdentifier(), getFilter(), StudyLoadLevel.FULL);
		return result;
	}
