 ...
 *
 */
public class GetStudiesByCprsIdentifierAndFilterCommandImpl 
extends AbstractStudyCommandImpl<List<Study>>
{
	...
	public GetStudiesByCprsIdentifierAndFilterCommandImpl(
			String patientIcn, 
	...
	throws MethodException
	{
		...
		{
			List<Study> studies;
			studies = ImagingContext.getRouter().getStudyFromCprsIdentifierAndFilter(
					getRoutingToken(), 
					getPatientIcn(), 
					getFilter(),
					getCprsIdentifier());
            getLogger().info("Got {} patient '{}' studies.", studies == null ? "null" : "" + studies.size(), patientIcn);
	...
	public boolean equals(Object obj)
	{
		...
		if (getClass() != obj.getClass())
			return false;
		final GetStudiesByCprsIdentifierAndFilterCommandImpl other = (GetStudiesByCprsIdentifierAndFilterCommandImpl) obj;
