...
extends FacadeRouter
{
	...
	public abstract List<Study> getStudyFromCprsIdentifier(
			RoutingToken routingToken, 
			String patientIcn, 
			CprsIdentifier cprsIdentifier)
	throws MethodException, ConnectionException;

	@FacadeRouterMethod(asynchronous=false, isChildCommand=true, commandClassName="GetStudiesByCprsIdentifierAndFilterFromDataSourceCommand")
	public abstract List<Study> getStudyFromCprsIdentifierAndFilter(
			RoutingToken routingToken, 
			String patientIcn, 
			StudyFilter filter, 
			CprsIdentifier cprsIdentifier)
	...
	@FacadeRouterMethod(asynchronous=false, isChildCommand=true, commandClassName="PostStudiesByCprsIdentifiersFromDataSourceCommand")
	...
	@FacadeRouterMethod(asynchronous=false, isChildCommand=true, commandClassName="PostStudiesByCprsIdentifiersAndFilterFromDataSourceCommand")
	public abstract List<Study> postStudiesByCprsIdentifiersAndFilter(
			RoutingToken routingToken, 
			PatientIdentifier patientIdentifier, 
			StudyFilter filter, 
			List<CprsIdentifier> cprsIdentifiers)
	...
	//WFP-changed the command name. It was matching same as above.  Find who calls this and change accordingly in ViewerStudyWebApp.
	@FacadeRouterMethod(asynchronous=false, isChildCommand=true, commandClassName="GetPatientPhotoIdentificationImageFromDataSourceCommand")
	public abstract PatientPhotoID getPatientPhotoIdentificationImage(RoutingToken routingToken, PatientIdentifier patientIdentifier)
	throws MethodException, ConnectionException;	
	...
	@FacadeRouterMethod(asynchronous=false, commandClassName="GetStudyOnlyArtifactResultsBySiteNumberMuseDataSourceCommand", isChildCommand=true)
	public abstract ArtifactResults getStudyOnlyPatientArtifactResultsFromSiteMuse(RoutingToken routingToken, 
			PatientIdentifier patientIdentifier, 
			StudyFilter filter, 
			boolean includeRadiology,
			boolean includeDocuments)
	...
	@FacadeRouterMethod(asynchronous=false, isChildCommand=true, commandClassName="GetPatientIdentificationImageInformationFromDataSourceCommand")
	public abstract PatientPhotoIDInformation getPatientIdentificationImageInformation(RoutingToken routingToken, PatientIdentifier patientIdentifier)
	throws MethodException, ConnectionException;
	
	@FacadeRouterMethod(asynchronous=true, isChildCommand=true, commandClassName="GetPatientIdentificationImageInformationCommand")
	public abstract void getPatientIdentificationImageInformationAsync(RoutingToken routingToken, PatientIdentifier patientIdentifier,
		boolean allowCached);
	
	@FacadeRouterMethod(asynchronous=false, isChildCommand=true, commandClassName="GetPatientIdentificationImageInformationCommand")
	public abstract PatientPhotoIDInformation getPatientIdentificationImageInformation(RoutingToken routingToken, PatientIdentifier patientIdentifier,
		boolean allowCached)
	throws MethodException, ConnectionException;
	...
	@FacadeRouterMethod(asynchronous=false, isChildCommand=true, commandClassName="PostViewerStudiesForQaReviewFromDataSourceCommand")
	public abstract List<Study> postViewerStudiesForQaReview(
			RoutingToken routingToken, 
			StudyFilter filter)
	throws MethodException, ConnectionException;
	
	@FacadeRouterMethod(asynchronous=false, isChildCommand=true, commandClassName="GetRemoteWorkItemListCommand")
	...
	@FacadeRouterMethod(asynchronous=false, isChildCommand=true, commandClassName="DeleteRemoteWorkItemCommand")
	public abstract Boolean deleteRemoteWorkItem(
			RoutingToken globalRoutingToken,
			String id) 
	throws MethodException, ConnectionException;

	@FacadeRouterMethod(asynchronous=false, isChildCommand=true, commandClassName="GetRemoteWorkItemListFromDataSourceCommand")
	...
	@FacadeRouterMethod(asynchronous=false, isChildCommand=true, commandClassName="DeleteRemoteWorkItemFromDataSourceCommand")
