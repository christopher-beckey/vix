...
extends AbstractDocumentCommandImpl<Boolean>
{
	...
	throws MethodException, ConnectionException
	{
        ...
        getLogger().info("RouterImpl.prefetchDocument({}), transaction '{}'", getDocumentIdentifier().toString(), transactionContext.getTransactionId());
		...
		if(cache != null)
		{
			try
			{
				...
				if(instance != null)
				{
                    ...
                    getLogger().info("Document '{}' found in cache.", getDocumentIdentifier().toString());
			...
			{
                getLogger().error("CacheException reading '{}' from cache, {}", getDocumentIdentifier().toString(), cX.getMessage());
			}
			...
			try
			{
				...
				if(cacheOutStream != null)
				{
                    ...
                    getLogger().info("Wrote '{}' bytes to cache for document '{}'.", bytesReturned, getDocumentIdentifier().toString());
					return true;
