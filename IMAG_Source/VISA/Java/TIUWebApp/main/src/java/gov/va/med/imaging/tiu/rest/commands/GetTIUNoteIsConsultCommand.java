 ...
 *
 */
public class GetTIUNoteIsConsultCommand
extends AbstractTIUCommand<Boolean, RestBooleanReturnType>
{
	 ...
	 */
	public GetTIUNoteIsConsultCommand(String tiuNoteUrnString, String interfaceVersion)
	{
		super("isNoteAConsult");
	...
	{
		try {
			TIUItemURN noteUrn = URNFactory.create(getTiuNoteUrnString(), TIUItemURN.class);
			return getRouter().isTiuNoteAConsult(noteUrn);
		} catch (ConnectionException e) {
			throw e;
		} catch (Exception e) {
			throw new MethodException("General error checking if tiu note is consult via router", e);
		}
	}
	/* (non-Javadoc)
