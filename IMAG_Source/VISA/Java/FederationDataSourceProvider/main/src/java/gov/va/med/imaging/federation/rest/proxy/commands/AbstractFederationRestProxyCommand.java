...
extends AbstractFederationRestProxy
{
	...
	throws MethodException, ConnectionException
	{
        ...
        getLogger().info("{}, Transaction [{}] {}", getMethodName(), transactionContext.getTransactionId(), methodParameterDescription == null ? "." : "" + methodParameterDescription);
        ...
        getLogger().info("{}, Transaction [{}] returned [{}] result webservice object.", getMethodName(), transactionContext.getTransactionId(), webServiceResult == null ? "null" : "not null");
		T result = null;
        ...
        getLogger().info("{}, Transaction [{}] {}", getMethodName(), transactionContext.getTransactionId(), translatedResultDescription == null ? "." : "" + translatedResultDescription);
