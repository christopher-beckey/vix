...
extends AbstractFederationRestProxy
{
	...
	throws MethodException, ConnectionException
	{
        ...
        getLogger().info("logImageAccessEvent, Transaction [{}] initiated, event Type '{}'", transactionContext.getTransactionId(), logEvent.getEventType().toString());
        ...
        getLogger().info("logImageAccessEvent, Transaction [{}] logged image access event {}", transactionContext.getTransactionId(), result == null ? "null" : "" + (result.isResult() ? "ok" : "failed"));
