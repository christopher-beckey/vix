...
import gov.va.med.imaging.federation.proxy.v8.FederationVistaRadImageProxyV8;
 ...
 *
 */
public class FederationVistaRadImageDataSourceServiceV8
extends FederationVistaRadImageDataSourceServiceV5
{
	private final static String DATASOURCE_VERSION = "8";
	private FederationVistaRadImageProxyV8 proxy = null;
	 ...
	 */
	public FederationVistaRadImageDataSourceServiceV8(ResolvedArtifactSource resolvedArtifactSource, String protocol)
		throws UnsupportedOperationException
	{
	...
	@Override
	protected FederationVistaRadImageProxyV8 getProxy()
	throws ConnectionException
	{
		if(proxy == null)
		{
			...
			proxy = new FederationVistaRadImageProxyV8(proxyServices, 
