...
import gov.va.med.imaging.federation.proxy.v8.FederationRestDocumentProxyV8;
 ...
 *
 */
public class FederationDocumentDataSourceServiceV8
extends FederationDocumentDataSourceServiceV5
{
	private FederationRestDocumentProxyV8 proxy = null;
	 ...
	 */
	public FederationDocumentDataSourceServiceV8(ResolvedArtifactSource resolvedArtifactSource, String protocol)
	throws UnsupportedOperationException
	{
		super(resolvedArtifactSource, protocol);
	}
	
	private FederationRestDocumentProxyV8 getProxy()
	throws ConnectionException
	{
		if(proxy == null)
		{
			...
			proxy = new FederationRestDocumentProxyV8(proxyServices, getFederationConfiguration());
		}
		return proxy;
	}
		...
		if(federationProxyServices == null)
		{
			federationProxyServices = 
				FederationProxyUtilities.getCurrentFederationProxyServices(
						getSite(), getFederationProxyName(), getDataSourceVersion());
		}
