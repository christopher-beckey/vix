...
extends AbstractFederationExternalSystemOperationDataSourceService
{
	...
	throws MethodException, ConnectionException
	{
		...
		{
            getLogger().error("FederationExternalSystemOperationDataSourceServiceV4.initiateExamPrefetchOperation() --> IOException initating exam prefetch operation: {}", ioX.getMessage());
	...
	throws MethodException, ConnectionException
	{
		...
		{
            getLogger().error("FederationExternalSystemOperationDataSourceServiceV4.refreshSiteServiceCache() --> IOException initating operation: {}", ioX.getMessage());
			throw new FederationConnectionException(ioX);
		}
	...
	public void prefetchPatientStudies(RoutingToken globalRoutingToken,
			...
			throws MethodException, ConnectionException
	{
        getLogger().info("FederationExternalSystemOperationDataSourceServiceV4.prefetchPatientStudies() --> For patient ICN [{}], StudyLoadLevel [{}], transaction Id [{}]", patientIcn, studyLoadLevel, TransactionContextFactory.get().getDisplayIdentity());
		try 
		{
			federationConnection.connect();			
		}
		...
		{
            getLogger().error("FederationExternalSystemOperationDataSourceServiceV4.prefetchPatientStudies() --> Error prefetching patient studies: {}", ioX.getMessage());
			throw new FederationConnectionException(ioX);
		}					
		if(filter != null)
		{
	...
	throws MethodException, ConnectionException
	{
		...
		{
            getLogger().error("FederationExternalSystemOperationDataSourceServiceV4.prefetchExamImage() --> Error prefetching exam image: {}", ioX.getMessage());
			throw new FederationConnectionException(ioX);
		}
	...
	throws MethodException, ConnectionException
	{
        getLogger().info("FederationExternalSystemOperationDataSourceServiceV4.prefetchGai() --> For GAI [{}], transaction Id [{}]", gai.toString(), TransactionContextFactory.get().getDisplayIdentity());
		try 
		{
			federationConnection.connect();			
		}
		...
		{
            getLogger().error("FederationExternalSystemOperationDataSourceServiceV4.prefetchGai() --> Error prefetching GAI: {}", ioX.getMessage());
			throw new FederationConnectionException(ioX);
		}
	...
	throws MethodException, ConnectionException
	{
        getLogger().info("FederationExternalSystemOperationDataSourceServiceV4.prefetchImage() --> For image URN [{}], ImageFormatQualityList ({}], transaction Id [{}]", imageUrn.toString(), imageFormatQualityList.getAcceptString(true, true), TransactionContextFactory.get().getDisplayIdentity());
		try 
		{
			federationConnection.connect();			
		}
		...
		{
            getLogger().error("FederationExternalSystemOperationDataSourceServiceV4.prefetchImage() --> Error prefetching image: {}", ioX.getMessage());
			throw new FederationConnectionException(ioX);
		}
