...
implements Serializable, DetectConfigNonTransientValueChanges
{
	...
	private EncryptedConfigurationPropertyString aKeystorePassVal;
	private EncryptedConfigurationPropertyString aTruststorePassVal;
	...
	{
		super();
		aTruststorePassVal = new EncryptedConfigurationPropertyString("");
		truststoreUrl = "";
		aKeystorePassVal = new EncryptedConfigurationPropertyString("");
		keystoreUrl = "";
	...
	public FederationConfiguration(String truststoreUrl, String keystoreUrl,
		...
		this.aKeystorePassVal = new EncryptedConfigurationPropertyString(keystorePassword);
		this.aTruststorePassVal = new EncryptedConfigurationPropertyString(truststorePassword);
	...
	public String getKeystorePassword() {
		if(aKeystorePassVal == null) return null;
		return aKeystorePassVal.getValue();
	}
	...
	public void setKeystorePassword(EncryptedConfigurationPropertyString keystorePassword) {
		this.aKeystorePassVal = keystorePassword;
	}
	...
	public String getTruststorePassword() {
		if(aTruststorePassVal == null) return null;
		return aTruststorePassVal.getValue();
	}
	...
	public void setTruststorePassword(EncryptedConfigurationPropertyString truststorePassword) {
		this.aTruststorePassVal = truststorePassword;
	}
	...
	public boolean hasValueChangesToPersist(boolean autoStoreChanges) {
		if(this.aTruststorePassVal != null && this.aTruststorePassVal.isUnencryptedAtRest()) return true;
		if(this.aKeystorePassVal != null && aKeystorePassVal.isUnencryptedAtRest()) return true;
		return false;
	}
}
