...
extends AbstractFederationStudyGraphDataSourceService 
{
	...
	{
        getLogger().info("getPatientStudies for patient ({}), StudyLoadLevel ({}), TransactionContext ({}).", patientIdentifier.toString(), studyLoadLevel, TransactionContextFactory.get().getDisplayIdentity());
        ...
        getLogger().info("getPatientStudies got [{}] studies from site [{}]", studies == null ? "0" : "" + studies.size(), getSite().getSiteNumber());
