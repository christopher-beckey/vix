...
extends AbstractFederationRestProxy 
{
	...
	throws MethodException, ConnectionException 
	{
        ...
        getLogger().info("FederationRestDocumentSetProxyV4.getDocumentSets() --> Transaction Id [{}] initiated, patient Id [{}] to routing token [{}]", transactionId, filter.getPatientId(), routingToken.toRoutingTokenString());
		...
		{
			getLogger().warn("FederationRestDocumentSetProxyV4.getDocumentSets() --> Got null FederationDocumentSetResultType from Federation data source");			
			return null;
		}
        getLogger().info("FederationRestDocumentSetProxyV4.getDocumentSets() -->Transaction Id [{}] returned [{}] FederationDocumentSetResultType.", transactionId, documentResult == null ? "null" : "not null");
        ...
        getLogger().info("FederationRestDocumentSetProxyV4.getDocumentSets() --> Transaction Id [{}] returned response of [{}] DocumentSetResult business object.", transactionId, result == null ? "null" : "not null");
		return result;		
	}
