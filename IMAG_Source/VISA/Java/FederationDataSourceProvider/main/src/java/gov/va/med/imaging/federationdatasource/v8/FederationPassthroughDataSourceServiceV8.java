...
import gov.va.med.imaging.federation.proxy.v8.FederationRestPassthroughProxyV8;
 ...
 *
 */
public class FederationPassthroughDataSourceServiceV8 
extends FederationPassthroughDataSourceServiceV5
{
	private final static String DATASOURCE_VERSION = "8";
	private FederationRestPassthroughProxyV8 proxy = null;	
	 ...
	 */
	public FederationPassthroughDataSourceServiceV8(ResolvedArtifactSource resolvedArtifactSource, String protocol)
	...
	@Override
	protected FederationRestPassthroughProxyV8 getProxy()
	throws ConnectionException
	{
		if(proxy == null)
		{
			...
			proxy = new FederationRestPassthroughProxyV8(proxyServices, getFederationConfiguration());
		}
		return proxy;
	}
