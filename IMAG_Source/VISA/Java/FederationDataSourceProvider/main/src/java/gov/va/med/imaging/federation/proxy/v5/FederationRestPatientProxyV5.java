...
{	
	...
	throws ConnectionException, MethodException
	{
        ...
        getLogger().info("getPatientSitesVisited, Transaction [{}] initiated, patient '{}' to '{}'.", transactionContext.getTransactionId(), patientIcn, routingToken.toRoutingTokenString());
        ...
        getLogger().info("getPatientSitesVisited, Transaction [{}] returned [{}] sites.", transactionContext.getTransactionId(), sites == null ? "null" : "" + (sites.getValues() == null ? "null" : "" + sites.getValues().length));
		List<String> result = FederationRestTranslator.translate(FederationRestTranslator.translateStringArray(sites));
        getLogger().info("getPatientSitesVisited, Transaction [{}] returned response of [{}] site number business objects.", transactionContext.getTransactionId(), result == null ? "null" : "" + result.size());
		return result;		
	}
	...
	{
		TransactionContext transactionContext = TransactionContextFactory.get();
        getLogger().info("getPatientInformation, Transaction [{}] initiated, patient '{}' to '{}'.", transactionContext.getTransactionId(), patientIcn, routingToken.toRoutingTokenString());
        ...
        getLogger().info("getPatientInformation, Transaction [{}] returned [{}] patient.", transactionContext.getTransactionId(), patient == null ? "null" : "not null");
		Patient result = FederationRestTranslator.translate(patient);
        getLogger().info("getPatientInformation, Transaction [{}] returned response of [{}] patient business object.", transactionContext.getTransactionId(), result == null ? "null" : "not null");
		return result;	
	}
	...
	{
		TransactionContext transactionContext = TransactionContextFactory.get();
        getLogger().info("getPatientMeansTest, Transaction [{}] initiated, patient '{}' to '{}'.", transactionContext.getTransactionId(), patientIcn, routingToken.toRoutingTokenString());
        ...
        getLogger().info("getPatientMeansTest, Transaction [{}] returned [{}] patient means test.", transactionContext.getTransactionId(), patientMeansTestResult == null ? "null" : "not null");
		PatientMeansTestResult result = FederationRestTranslator.translate(patientMeansTestResult);
        getLogger().info("getPatientMeansTest, Transaction [{}] returned response of [{}] patient means test business object.", transactionContext.getTransactionId(), result == null ? "null" : "not null");
		return result;	
	}
