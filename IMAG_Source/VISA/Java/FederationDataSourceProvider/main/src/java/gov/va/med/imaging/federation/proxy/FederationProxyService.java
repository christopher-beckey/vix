...
implements ProxyService 
{
	...
	private final static String defaultFederationPassVal = null;
	
	public FederationProxyService(IDSService idsServce, IDSOperation idsOperation, String host, int port)
	{
		...
		this.credentials = defaultFederationPassVal;
