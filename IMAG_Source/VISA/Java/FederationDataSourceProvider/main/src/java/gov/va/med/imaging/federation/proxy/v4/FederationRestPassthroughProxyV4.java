...
extends AbstractFederationRestProxy 
{
	...
	throws MethodException, ConnectionException
	{
        ...
        getLogger().info("executePassthroughMethod, Transaction [{}] initiated, method name '{}' to '{}'.", transactionContext.getTransactionId(), method.getMethodName(), routingToken.toRoutingTokenString());
        ...
        getLogger().info("executePassthroughMethod, Transaction [{}] returned [{}] bytes from webservice.", transactionContext.getTransactionId(), result == null ? "null" : "" + result.length());
		return result;		
	}
