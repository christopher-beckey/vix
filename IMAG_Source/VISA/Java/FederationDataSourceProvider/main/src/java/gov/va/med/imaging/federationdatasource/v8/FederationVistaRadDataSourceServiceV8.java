...
import gov.va.med.imaging.federation.proxy.v8.FederationRestVistaRadProxyV8;
 ...
 *
 */
public class FederationVistaRadDataSourceServiceV8 
extends FederationVistaRadDataSourceServiceV5
{
	private final static String DATASOURCE_VERSION = "8";
	private FederationRestVistaRadProxyV8 proxy = null;
	 ...
	 */
	public FederationVistaRadDataSourceServiceV8(ResolvedArtifactSource resolvedArtifactSource, String protocol)
		throws UnsupportedOperationException
	{
	...
	protected FederationRestVistaRadProxyV8 getProxy()
	throws ConnectionException
	{
		if(proxy == null)
		{
			...
			proxy = new FederationRestVistaRadProxyV8(proxyServices, getFederationConfiguration());
		}
		return proxy;
	}
