...
extends AbstractFederationExternalPackageDataSourceService
{
	...
	throws MethodException, ConnectionException 
	{
		...
		{
			String msg = "FederationExternalPackageDataSourceServiceV4.getStudyFromCprsIdentifier()--> Failed to connect: " + ioX.getMessage();
			getLogger().error(msg);
	...
	public boolean isVersionCompatible() 
	{
		...
		{
            getLogger().warn("FederationExternalPackageDataSourceServiceV4.isVersionCompatible() --> Cannot find proxy service type [{}] at site [{}]", serviceType, siteNumber);
			return false;
		}
	}
}
