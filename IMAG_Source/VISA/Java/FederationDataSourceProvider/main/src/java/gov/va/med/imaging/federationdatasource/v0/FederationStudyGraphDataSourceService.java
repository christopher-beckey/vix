...
extends AbstractFederationStudyGraphDataSourceService
{
	...
	{
        logger.info("getPatientStudies for patient ({}) TransactionContext ({}).", patientIdentifier.toString(), TransactionContextFactory.get().getDisplayIdentity());
		...
		{			
            ...
            logger.info("getPatientStudies got [{}] studies from site [{}]", federationStudies == null ? "0" : "" + federationStudies.length, getSite().getSiteNumber());
