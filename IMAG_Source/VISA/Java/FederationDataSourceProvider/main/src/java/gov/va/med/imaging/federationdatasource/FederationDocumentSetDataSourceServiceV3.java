...
implements DocumentSetDataSourceSpi 
{
	...
	throws MethodException, ConnectionException 
	{
		...
		if(studySet == null)
		{
			getLogger().warn("FederationDocumentSetDataSourceServiceV3.getPatientDocumentSets() --> Got null StudySetResult, cannot convert to DocumentSetResult. Return null.");
			return null;
		}
		...
		{
            getLogger().error("FederationDocumentSetDataSourceServiceV3.getPatientDocumentSets() --> Unable to transform studies into document sets: {}", x.getMessage());
