...
extends FederationRestUserProxyV5
{
	...
	throws MethodException, ConnectionException
	{
        ...
        getLogger().info("verifyElectronicSignature, Transaction [{}] initiated.", transactionContext.getTransactionId());
        ...
        getLogger().info("verifyElectronicSignature, Transaction [{}] returned [{}] electronic signature result webservice object.", transactionContext.getTransactionId(), esig == null ? "null" : "not null");
		ElectronicSignatureResult result = FederationRestTranslator.translate(esig);
        getLogger().info("verifyElectronicSignature, Transaction [{}] returned [{}] electronic signature result.", transactionContext.getTransactionId(), result == null ? "null" : "" + result.isSuccess());
		return result;
	}
