...
import gov.va.med.imaging.federationdatasource.v0.FederationImageDataSourceService;
...
implements DocumentDataSourceSpi 
{
	...
	throws MethodException, ConnectionException 
	{
		...
		{
			throw new MethodException("FederationDocumentDataSourceService.getDocument() --> Unexpected exception converting document URN [" + documentUrn.toString() + "] to image URN: " + x.getMessage());
		}
	...
	throws MethodException, ConnectionException
	{
		...
		{
            Logger.getLogger(this.getClass()).error("FederationDocumentDataSourceService.getDocument() --> Error: {}", x.getMessage());
