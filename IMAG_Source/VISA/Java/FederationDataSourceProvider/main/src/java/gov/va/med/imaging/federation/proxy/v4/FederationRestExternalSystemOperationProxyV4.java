...
extends AbstractFederationRestProxy
{
	...
	throws MethodException, ConnectionException
	{
        ...
        getLogger().info("initiateExamPrefetchOperation, Transaction [{}] initiated, study URN '{}'.", transactionContext.getTransactionId(), studyUrn.toString());
        ...
        getLogger().info("initiateExamPrefetchOperation, Transaction [{}] returned [{}] result.", transactionContext.getTransactionId(), result == null ? "null" : "" + result.isResult());
	...
	throws MethodException, ConnectionException
	{
        ...
        getLogger().info("refreshSiteServiceCache, Transaction [{}] initiated.", transactionContext.getTransactionId());
		...
		FederationRestGetClient getClient = new FederationRestGetClient(url, MediaType.APPLICATION_XML_TYPE, 
				federationConfiguration);
		RestBooleanReturnType result = getClient.executeRequest(RestBooleanReturnType.class);
        getLogger().info("refreshSiteServiceCache, Transaction [{}] returned [{}] result.", transactionContext.getTransactionId(), result == null ? "null" : "" + result.isResult());
	}
	...
	{
		TransactionContext transactionContext = TransactionContextFactory.get();
        getLogger().info("prefetchPatientStudies, Transaction [{}] initiated, patient '{}' to '{}'.", transactionContext.getTransactionId(), patientIcn, routingToken.toRoutingTokenString());
        ...
        getLogger().info("prefetchPatientStudies, Transaction [{}] returned [{}] prefetch request result.", transactionContext.getTransactionId(), result == null ? "null" : "" + result.isResult());
		if(result == null)
		{
			return false;			
		}
	...
	{
		TransactionContext transactionContext = TransactionContextFactory.get();
        getLogger().info("prefetchExamImage, Transaction [{}] initiated, image '{}' with quality list '{}'.", transactionContext.getTransactionId(), imageUrn.toString(), imageFormatQualityList.getAcceptString(true, true));
        ...
        getLogger().info("prefetchExamImage, Transaction [{}] returned [{}] prefetch request result.", transactionContext.getTransactionId(), result == null ? "null" : "" + result.isResult());
		if(result == null)
		{
			return false;			
		}
	...
	{
		TransactionContext transactionContext = TransactionContextFactory.get();
        getLogger().info("prefetchImage, Transaction [{}] initiated, image '{}' with quality list '{}'.", transactionContext.getTransactionId(), imageUrn.toString(), imageFormatQualityList.getAcceptString(true, true));
        ...
        getLogger().info("prefetchImage, Transaction [{}] returned [{}] prefetch request result.", transactionContext.getTransactionId(), result == null ? "null" : "" + result.isResult());
		if(result == null)
		{
			return false;			
		}
	...
	{
		TransactionContext transactionContext = TransactionContextFactory.get();
        getLogger().info("prefetchGai, Transaction [{}] initiated, GAI '{}'.", transactionContext.getTransactionId(), gai.toString());
		setDataSourceMethodAndVersion("prefetchImage");
		Map<String, String> urlParameterKeyValues = new HashMap<String, String>();		
		...
		FederationRestGetClient getClient = new FederationRestGetClient(url, MediaType.APPLICATION_XML_TYPE, 
				federationConfiguration);
		RestBooleanReturnType result = getClient.executeRequest(RestBooleanReturnType.class);
        getLogger().info("prefetchGai, Transaction [{}] returned [{}] prefetch request result.", transactionContext.getTransactionId(), result == null ? "null" : "" + "" + result.isResult());
		if(result == null)
		{
			return false;			
		}
