...
import gov.va.med.imaging.federationdatasource.AbstractFederationImageDataSourceService;
...
{	
	...
	{
        getLogger().info("FederationImageDataSourceService.getImageInformation() --> Image URN [{}], transaction idenity [{}]", imagingUrn.toString(), TransactionContextFactory.get().getDisplayIdentity());
		try
		{
		...
		{
			String msg = "FederationImageDataSourceService.getImageInformation() --> Encountered ServiceException: " + sX.getMessage();
			getLogger().error(msg);
			throw new FederationMethodException(msg, sX);
		}
		catch(IOException ioX) 
		{
			String msg = "FederationImageDataSourceService.getImageInformation() --> Encountered IOException: " + ioX.getMessage();
			getLogger().error(msg);
	...
	throws UnsupportedOperationException, MethodException, ConnectionException, 
		ImageNotFoundException 
	{
        getLogger().info("FederationImageDataSourceService.getImageSystemGlobalNode() --> Image URN [{}], transaction idenity [{}]", imagingUrn.toString(), TransactionContextFactory.get().getDisplayIdentity());
		try
		{
		...
		{
			String msg = "FederationImageDataSourceService.getImageSystemGlobalNode() --> Encountered ServiceException: " + sX.getMessage();
			getLogger().error(msg);
			throw new FederationMethodException(msg, sX);
		}
		catch(IOException ioX) 
		{
			String msg = "FederationImageDataSourceService.getImageSystemGlobalNode() --> Encountered IOException: " + ioX.getMessage();
			getLogger().error(msg);
			throw new FederationConnectionException(msg, ioX);
		}
	}
	...
	throws UnsupportedOperationException, MethodException, ConnectionException, 
		ImageNotFoundException 
	{
        getLogger().info("FederationImageDataSourceService.getImageDevFields() Image URN [{}], transaction idenity [{}]", imagingUrn.toString(), TransactionContextFactory.get().getDisplayIdentity());
		try
		{
		...
		{
			String msg = "FederationImageDataSourceService.getImageDevFields() --> Encountered ServiceException: " + sX.getMessage();
			getLogger().error(msg);
			throw new FederationMethodException(msg, sX);
		}
		catch(IOException ioX) 
		{
			String msg = "FederationImageDataSourceService.getImageDevFields() --> Encountered IOException: " + ioX.getMessage();
			getLogger().error(msg);
			throw new FederationConnectionException(msg, ioX);
		}
	}
