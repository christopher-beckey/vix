...
extends AbstractFederationStudyGraphDataSourceService 
{
	...
	throws MethodException, ConnectionException 
	{
        ...
        getLogger().info("FederationStudyGraphDataSourceServiceV3.getPatientStudies() --> Got [{}] studies from site number [{}]", studies == null ? 0 : studies.size(), getSite().getSiteNumber());
