...
implements DocumentDataSourceSpi 
{
	...
	throws MethodException, ConnectionException 
	{
		...
		{
			String msg = "FederationDocumentDataSourceServiceV3.getDocument(1) --> Error converting document URN [" + documentUrn.toString() + "] to image URN: " + x.getMessage();
			getLogger().error(msg);
	...
	throws MethodException, ConnectionException
	{
		...
		{
			String msg = "FederationDocumentDataSourceServiceV3.getDocument(2) --> Error converting document URN [" + documentUrn.toString() + "] to image URN: " + x.getMessage();
			getLogger().error(msg);
			throw new FederationConnectionException(msg, x);
		}
