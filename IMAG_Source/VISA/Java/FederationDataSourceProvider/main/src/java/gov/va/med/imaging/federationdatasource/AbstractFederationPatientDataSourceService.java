...
implements PatientDataSourceSpi 
{
	...
	{
        logger.info("getPatientIdentificationImage({})  TransactionContext ({}).", patientIdentifier, TransactionContextFactory.get().getTransactionId());
	...
	throws MethodException, ConnectionException {
		throw new UnsupportedServiceMethodException(PatientDataSourceSpi.class, "getPatientPhotoIdentificationImage");
	}
	...
	throws MethodException, ConnectionException
	{
		throw new UnsupportedServiceMethodException(PatientDataSourceSpi.class, "getPatientIdentificationImageInformation");
	}
