 ...
 *
 */
//WFP-RestGetClient is not used.  This class has 13 references.  The proper solution should
//	be to have these references point to FederationRestPostClient.  Then "deprecate" this class.
