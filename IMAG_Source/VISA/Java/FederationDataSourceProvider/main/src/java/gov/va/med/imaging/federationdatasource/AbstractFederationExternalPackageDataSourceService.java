...
implements ExternalPackageDataSourceSpi 
{
	...
	throws MethodException, ConnectionException 
	{
		throw new UnsupportedServiceMethodException(ExternalPackageDataSourceSpi.class, "getRemoteWorkItemListFromDataSource");
	}
	...
	throws MethodException, ConnectionException 
	{
		throw new UnsupportedServiceMethodException(ExternalPackageDataSourceSpi.class, "deleteRemoteWorkItemFromDataSource");
	}
