...
import gov.va.med.imaging.federation.proxy.v8.FederationRestUserProxyV8;
 ...
 *
 */
public class FederationUserDataSourceServiceV8
extends FederationUserDataSourceServiceV6
{
	
	private final static String DATASOURCE_VERSION = "8";
	private FederationRestUserProxyV8 proxy = null;
	 ...
	 */
	public FederationUserDataSourceServiceV8(
	...
	protected FederationRestUserProxyV8 getProxy()
	throws ConnectionException
	{
		if(proxy == null)
		{
			...
			proxy = new FederationRestUserProxyV8(proxyServices, 
