...
public class Utilities
{
	...
	throws ProxyServiceNotFoundException
	{
        logger.debug("createImageUrl for {}", imageUrn);
		...
		String imageUrl = service.getConnectionURL() + "?" + 
		"imageURN=" + imageUrn +
        ...
        logger.debug("createImageUrl - imageUrl {}", imageUrl);
	...
	throws ProxyServiceNotFoundException
	{
		...
		{
            logger.debug("Cannot find proxy service for type '{}', using image", ProxyServiceType.text.getIdsOperationType());
			service = null;
		}
		if(service == null)
		{
