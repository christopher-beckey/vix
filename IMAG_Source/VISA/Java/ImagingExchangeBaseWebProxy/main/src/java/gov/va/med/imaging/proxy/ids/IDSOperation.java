...
public class IDSOperation 
{
	...
	public final static String IDS_OPERATION_EXTERNALPACKAGEDATASOURCE = "ExternalPackageDataSourceSpi";
	public final static String IDS_OPERATION_CONSULTDATASOURCE = "ConsultDataSourceSpi";
	public final static String IDS_OPERATION_INDEXTERMDATASOURCE = "IndexTermDataSourceSpi";
	public final static String IDS_OPERATION_TIUNOTEDATASOURCE = "TIUNoteDataSourceSpi";
