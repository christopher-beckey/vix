...
/**
 * Retrieve an exam image text file only if it is in the local cache.
 * 
 ...
 *
 */
public class VistaRadExamImageTextFileFromCacheServlet
extends AbstractVistaRadExamImageTextFileServlet
{
	private static final long serialVersionUID = 6783799897447850421L;
	...
	{
		return ImagingVistaRadContext.getVistaRadRouter().getExamTextFileFromCacheByImageUrn(imageUrn, 
