 ...
 *
 */
public class AxCommandCommon
{
private final static Logger logger = Logger.getLogger(AxCommandCommon.class);
	
	public final static String axV1InterfaceVersion = "V1";
	...
	public static void setTransactionContext(
			gov.va.med.imaging.ax.webservices.rest.types.RequestorType requestor,
