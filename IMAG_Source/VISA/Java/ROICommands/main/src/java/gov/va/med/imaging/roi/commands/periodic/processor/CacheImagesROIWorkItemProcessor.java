 ...
 *
 */
public class CacheImagesROIWorkItemProcessor
extends AbstractROIWorkItemsProcessor
{
	 ...
	 * @param newStatus
	 */
	public CacheImagesROIWorkItemProcessor()
	{
		super(ROIStatus.STUDY_LOADED.getStatus(), ROIStatus.CACHING_IMAGES.getStatus());
	}
	...
	{
		ROICommandsContext.getRouter().processROICacheStudyImages(workItem);
	}
}
