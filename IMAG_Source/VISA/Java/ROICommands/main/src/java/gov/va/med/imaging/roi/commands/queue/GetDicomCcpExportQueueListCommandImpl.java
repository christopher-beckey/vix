 ...
 *
 */
public class GetDicomCcpExportQueueListCommandImpl
extends AbstractDataSourceCommandImpl<List<DicomExportQueue>, ExportQueueDataSourceSpi>
{
	...
	public GetDicomCcpExportQueueListCommandImpl(RoutingToken routingToken)
	{
		super();
	 ...
	 */
	public GetDicomCcpExportQueueListCommandImpl()
	{
		super();
	...
	{
		return "getDicomCcpExportQueues";
	}
	...
	{
		return spi.getDicomCcpExportQueues(getRoutingToken());
	}
