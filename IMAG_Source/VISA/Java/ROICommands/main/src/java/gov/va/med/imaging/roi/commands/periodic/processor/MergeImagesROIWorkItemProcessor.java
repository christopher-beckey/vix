 ...
 *
 */
public class MergeImagesROIWorkItemProcessor
extends AbstractROIWorkItemsProcessor
{
	public MergeImagesROIWorkItemProcessor()
	{
		super(ROIStatus.ANNOTATIONS_BURNED.getStatus(), ROIStatus.MERGING_IMAGES.getStatus());
	}
	...
	{
		ROICommandsContext.getRouter().processROIMergeImages(workItem);
	}
}
