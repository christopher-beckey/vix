 ...
 *
 */
public class AnnotateImagesROIWorkItemProcessor 
extends AbstractROIWorkItemsProcessor
{
	 ...
	 * @param newStatus
	 */
	public AnnotateImagesROIWorkItemProcessor()
	{
		super(ROIStatus.IMAGES_CACHED.getStatus(), ROIStatus.BURNING_ANNOTATIONS.getStatus());
	}
	...
	{
		ROICommandsContext.getRouter().processROIAnnotateStudyImages(workItem);
	}
