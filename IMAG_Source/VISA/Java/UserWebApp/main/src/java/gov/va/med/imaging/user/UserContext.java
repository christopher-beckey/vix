...
implements ApplicationContextAware 
{
	...
	private static UserContext imagingContext;

	public static UserRouter getRouter()
	{
		UserRouter router = null;
		TransactionContext transactionContext = TransactionContextFactory.get();
		try
		{
			router = FacadeRouterUtility.getFacadeRouter(UserRouter.class);
		} 
		catch (Exception x)
		{
			String msg = "Error getting UserRouter instance.  Application deployment is probably incorrect.";			 
	...
	private static void initializeImagingContext()
	{
		...
		{
			imagingContext = new UserContext();
		}		
	}
