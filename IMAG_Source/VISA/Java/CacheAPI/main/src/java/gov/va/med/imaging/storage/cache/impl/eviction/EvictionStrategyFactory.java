...
{
	private final static Logger LOGGER = Logger.getLogger(EvictionStrategyFactory.class);
	...
	{
		return (singleton = singleton != null ? singleton : new EvictionStrategyFactory());
	}
	...
	public EvictionStrategyMemento createBlankMemento(String evictionStrategyClassname)
	{
		...
		{
            LOGGER.warn("EvictionStrategyFactory.createBlankMemento() --> Encountered InstantiationException: {}", x.getMessage());
			return null;
		} 
		catch (IllegalAccessException x)
		{
            LOGGER.warn("EvictionStrategyFactory.createBlankMemento() --> Encountered IllegalAccessException: {}", x.getMessage());
			return null;
		}
	}
