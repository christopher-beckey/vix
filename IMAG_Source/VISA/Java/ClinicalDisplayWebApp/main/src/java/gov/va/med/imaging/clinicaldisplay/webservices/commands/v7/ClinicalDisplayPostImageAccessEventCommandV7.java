 ...
 *
 */
public class ClinicalDisplayPostImageAccessEventCommandV7
extends AbstractClinicalDisplayPostImageAccessEventCommand
{
	...
	private final gov.va.med.imaging.clinicaldisplay.webservices.soap.v7.ImageAccessLogEventType logEvent;

	public ClinicalDisplayPostImageAccessEventCommandV7(String transactionId,
			gov.va.med.imaging.clinicaldisplay.webservices.soap.v7.ImageAccessLogEventType logEvent)
	{
		super();
		ClinicalDisplayCommandCommonV7.setTransactionContext(logEvent.getCredentials(), transactionId);
	...
	throws URNFormatException
	{
		...
		{
			imageAccessLogEvent = ClinicalDisplayTranslator7.translate(logEvent);
