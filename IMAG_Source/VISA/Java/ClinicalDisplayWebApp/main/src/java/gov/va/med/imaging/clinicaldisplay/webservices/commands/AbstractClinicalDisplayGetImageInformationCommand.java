 ...
 *
 */
public abstract class AbstractClinicalDisplayGetImageInformationCommand
extends AbstractClinicalDisplayWebserviceCommand<String, String>
{
	...
	public AbstractClinicalDisplayGetImageInformationCommand(String imageId, String interfaceVersion, 
	...
	throws MethodException, ConnectionException
	{
		...
		try
		{
			...
			String response = rtr.getImageInformation(urn, isIncludeDeletedImages());
