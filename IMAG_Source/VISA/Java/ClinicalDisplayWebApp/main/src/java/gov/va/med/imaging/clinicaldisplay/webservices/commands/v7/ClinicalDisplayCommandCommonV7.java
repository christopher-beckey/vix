 ...
 *
 */
public class ClinicalDisplayCommandCommonV7
{
	private final static Logger logger = Logger.getLogger(ClinicalDisplayCommandCommonV7.class);
	
	public final static String clinicalDisplayV7InterfaceVersion = "V7";
			...
			String transactionId)
	{
		...
		if(credentials != null)
		{
			...
			if(credentials.getClientVersion() != null)
				transactionContext.setClientVersion(credentials.getClientVersion());
