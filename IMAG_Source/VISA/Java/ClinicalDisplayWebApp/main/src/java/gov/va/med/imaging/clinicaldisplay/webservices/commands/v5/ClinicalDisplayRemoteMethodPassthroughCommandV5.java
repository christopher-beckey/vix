 ...
 *
 */
public class ClinicalDisplayRemoteMethodPassthroughCommandV5
extends AbstractClinicalDisplayRemoteMethodPassthroughCommand
{
	private final PassthroughInputMethod passthroughInputMethod;

	public ClinicalDisplayRemoteMethodPassthroughCommandV5(String transactionId, 
			...
			gov.va.med.imaging.clinicaldisplay.webservices.soap.v5.RemoteMethodInputParameterType inputParameters)
	{
		...
		passthroughInputMethod = 
			ClinicalDisplayCommandCommonV5.getTranslator().transformPassthroughMethod(getMethodName(), 
					inputParameters);
