 ...
 *
 */
public class ClinicalDisplayRemoteMethodPassthroughCommandV6
extends AbstractClinicalDisplayRemoteMethodPassthroughCommand
{
	private final PassthroughInputMethod passthroughInputMethod;

	public ClinicalDisplayRemoteMethodPassthroughCommandV6(String transactionId, 
			...
			gov.va.med.imaging.clinicaldisplay.webservices.soap.v6.RemoteMethodInputParameterType inputParameters)
	{
		...
		passthroughInputMethod = ClinicalDisplayTranslator6.translate(getMethodName(), inputParameters);
