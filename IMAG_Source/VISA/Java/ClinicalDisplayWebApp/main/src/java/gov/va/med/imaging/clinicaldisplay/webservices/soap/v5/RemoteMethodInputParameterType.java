...
public class RemoteMethodInputParameterType  implements java.io.Serializable {
    private gov.va.med.imaging.clinicaldisplay.webservices.soap.v5.RemoteMethodParameterType[] remoteMethodParameter;

    public RemoteMethodInputParameterType() {
    }

    public RemoteMethodInputParameterType(
           gov.va.med.imaging.clinicaldisplay.webservices.soap.v5.RemoteMethodParameterType[] remoteMethodParameter) {
     ...
     */
    public gov.va.med.imaging.clinicaldisplay.webservices.soap.v5.RemoteMethodParameterType[] getRemoteMethodParameter() {
        return remoteMethodParameter;
    }
     ...
     */
    public void setRemoteMethodParameter(gov.va.med.imaging.clinicaldisplay.webservices.soap.v5.RemoteMethodParameterType[] remoteMethodParameter) {
        this.remoteMethodParameter = remoteMethodParameter;
    }

    public gov.va.med.imaging.clinicaldisplay.webservices.soap.v5.RemoteMethodParameterType getRemoteMethodParameter(int i) {
        return this.remoteMethodParameter[i];
    }

    public void setRemoteMethodParameter(int i, gov.va.med.imaging.clinicaldisplay.webservices.soap.v5.RemoteMethodParameterType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:v5.soap.webservices.clinicaldisplay.imaging.med.va.gov", "RemoteMethodInputParameterType"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("remoteMethodParameter");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:v5.soap.webservices.clinicaldisplay.imaging.med.va.gov", "remoteMethodParameter"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:v5.soap.webservices.clinicaldisplay.imaging.med.va.gov", "RemoteMethodParameterType"));
