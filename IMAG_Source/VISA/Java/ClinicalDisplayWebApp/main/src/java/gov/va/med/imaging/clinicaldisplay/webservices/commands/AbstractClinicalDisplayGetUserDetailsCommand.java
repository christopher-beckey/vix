 ...
 *
 */
public abstract class AbstractClinicalDisplayGetUserDetailsCommand<E extends Object>
extends AbstractClinicalDisplayWebserviceCommand<UserInformation, E>
{
	private final String siteId;
	
	public AbstractClinicalDisplayGetUserDetailsCommand(String siteId)
	{
	...
	throws MethodException, ConnectionException
	{
		try
		{
			...
			ClinicalDisplayRouter router = getRouter();
			return router.getUserInformation(routingToken);
		}
