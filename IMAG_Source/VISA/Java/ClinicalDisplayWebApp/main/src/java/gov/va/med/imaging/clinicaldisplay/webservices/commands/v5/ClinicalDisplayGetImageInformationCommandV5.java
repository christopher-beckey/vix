 ...
 *
 */
public class ClinicalDisplayGetImageInformationCommandV5
extends AbstractClinicalDisplayGetImageInformationCommand
{

	public ClinicalDisplayGetImageInformationCommandV5(String imageId, String transactionId,
			gov.va.med.imaging.clinicaldisplay.webservices.soap.v5.UserCredentials credentials)
	{
		super(imageId, ClinicalDisplayCommandCommonV5.clinicalDisplayV5InterfaceVersion, false);
