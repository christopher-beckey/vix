 ...
 *
 */
public class ClinicalDisplayGetImageInformationCommandV7
extends AbstractClinicalDisplayGetImageInformationCommand
{
	public ClinicalDisplayGetImageInformationCommandV7(String imageId, String transactionId,
			gov.va.med.imaging.clinicaldisplay.webservices.soap.v7.UserCredentialsType credentials,
			boolean includeDeletedImages)
	{
		super(imageId, ClinicalDisplayCommandCommonV7.clinicalDisplayV7InterfaceVersion, includeDeletedImages);
