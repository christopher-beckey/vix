 ...
 *
 */
public class ClinicalDisplayCommandCommonV6
{
	private final static Logger logger = Logger.getLogger(ClinicalDisplayCommandCommonV6.class);
	
	public final static String clinicalDisplayV6InterfaceVersion = "V6";
