 ...
 *
 */
public class InternalDicomContext
implements ApplicationContextAware
{
	private static ApplicationContext appContext;
	private static Logger logger = Logger.getLogger(InternalDicomContext.class);

	/**
	 * 
	 * @return
	 */
	public static InternalDicomRouter getRouter() 
	{
		InternalDicomRouter router = null;
		TransactionContext transactionContext = TransactionContextFactory.get();
		try
		{
			router = FacadeRouterUtility.getFacadeRouter(InternalDicomRouter.class);
		} 
		catch (Exception x)
		{
			String msg = "Error getting VistaRadRouter instance.  Application deployment is probably incorrect.";			 
