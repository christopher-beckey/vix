...
public class GetDgwInstrumentListCommandImpl 
extends AbstractDicomStorageDataSourceCommandImpl<List<InstrumentConfig>>
{

	private static final long serialVersionUID = 1L;

	private static final String SPI_METHOD_NAME = "getDgwInstrumentList";

	private final String hostName;
	
	public GetDgwInstrumentListCommandImpl(String hostName)
	{
