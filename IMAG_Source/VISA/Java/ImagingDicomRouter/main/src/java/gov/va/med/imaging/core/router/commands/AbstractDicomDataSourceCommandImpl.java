 ...
 *
 */
public abstract class AbstractDicomDataSourceCommandImpl<R> 
extends AbstractDataSourceCommandImpl<R, DicomDataSourceSpi> 
{
	 ...
	 */
	@Override
	protected Class<DicomDataSourceSpi> getSpiClass() {
		return DicomDataSourceSpi.class;
	}
