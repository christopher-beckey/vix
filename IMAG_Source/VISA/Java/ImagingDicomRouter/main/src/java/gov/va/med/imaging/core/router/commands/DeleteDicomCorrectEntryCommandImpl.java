...
@Deprecated
public class DeleteDicomCorrectEntryCommandImpl 
extends AbstractDicomStorageDataSourceCommandImpl<Boolean>
{

	private static final long serialVersionUID = 1L;

	private static final String SPI_METHOD_NAME = "deleteDicomCorrectEntry";

	private final DicomCorrectEntry dicomCorrectEntry;
	
	public DeleteDicomCorrectEntryCommandImpl(DicomCorrectEntry dicomCorrectEntry) 
	{
		super();
...
//		return spi.deleteDicomCorrectEntry(dicomCorrectEntry);
	}
