 ...
 *
 */
public class DicomCommandCreatorProvider 
extends CommandCreatorProvider
{
	
	public DicomCommandCreatorProvider()
	{
		super();
	}
		...
		return new String []
               {
				...
				"gov.va.med.imaging.core.router.commands.dicom",
	...
	private synchronized static CommandContext getLocalCommandContext(CommandContext baseCommandContext)
	{
		...
		{
			localCommandContext = new DicomCommandContext(baseCommandContext);
		}
