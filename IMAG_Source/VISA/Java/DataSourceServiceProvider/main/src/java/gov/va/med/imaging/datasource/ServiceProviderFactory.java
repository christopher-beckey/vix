...
abstract class ServiceProviderFactory<T extends DataSourceSpi>
{
	...
	throws NoSuchMethodException, IllegalAccessException, InvocationTargetException
	{
        ...
        Provider.logger.debug("{} instance, attempting instantiation using {}.", this.spiType.getSimpleName(), createLogMessage);
        ...
        Provider.logger.info("{} instance, instantiated using {}.", this.spiType.getSimpleName(), createLogMessage);
	       ...
	       InstantiationException
	{
        ...
        Provider.logger.debug("{} instance, instantiated using {}.", this.spiType.getSimpleName(), createLogMessage);
