...
public class TranslatorTestBusinessObjectBuilder 
{
	...
	throws URNFormatException
	{
		...
		study.setDescription("[110201223] Description");
		...
		study.setAlternateExamNumber("110201223");
	...
	throws URNFormatException
	{
		...
		image.setDescription("[110201223] Image description");
		...
		image.setAlternateExamNumber("110201223");
		image.setAbsDiskVolumeIen("AbsDiskVolumeIen");
		image.setFullDiskVolumeIen("FullDiskVolumeIen");
		image.setFullArtifactIen("FullArtifactIen");
		image.setAbsArtifactIen("AbsArtifactIen");
