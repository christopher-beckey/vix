...
public class ImagingExchangeSiteServiceLocator extends org.apache.axis.client.Service implements gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.ImagingExchangeSiteService {
 ...
 */
    ...
    public gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.ImagingExchangeSiteServiceSoap getImagingExchangeSiteServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.ImagingExchangeSiteServiceSoap getImagingExchangeSiteServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.ImagingExchangeSiteServiceSoapStub _stub = new gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.ImagingExchangeSiteServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.ImagingExchangeSiteServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.ImagingExchangeSiteServiceSoapStub _stub = new gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.ImagingExchangeSiteServiceSoapStub(new java.net.URL(ImagingExchangeSiteServiceSoap_address), this);
                _stub.setPortName(getImagingExchangeSiteServiceSoapWSDDServiceName());
                return _stub;
            }
        }
