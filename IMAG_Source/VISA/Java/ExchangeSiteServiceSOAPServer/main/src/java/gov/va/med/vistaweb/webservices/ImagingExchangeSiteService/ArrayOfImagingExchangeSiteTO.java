...
public class ArrayOfImagingExchangeSiteTO  implements java.io.Serializable {
    private gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.ImagingExchangeSiteTO[] imagingExchangeSiteTO;

    public ArrayOfImagingExchangeSiteTO() {
    }

    public ArrayOfImagingExchangeSiteTO(
           gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.ImagingExchangeSiteTO[] imagingExchangeSiteTO) {
     ...
     */
    public gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.ImagingExchangeSiteTO[] getImagingExchangeSiteTO() {
        return imagingExchangeSiteTO;
    }
     ...
     */
    public void setImagingExchangeSiteTO(gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.ImagingExchangeSiteTO[] imagingExchangeSiteTO) {
        this.imagingExchangeSiteTO = imagingExchangeSiteTO;
    }

    public gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.ImagingExchangeSiteTO getImagingExchangeSiteTO(int i) {
        return this.imagingExchangeSiteTO[i];
    }

    public void setImagingExchangeSiteTO(int i, gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.ImagingExchangeSiteTO _value) {
