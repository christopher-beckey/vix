...
public class ImagingExchangeRegionTO  implements java.io.Serializable {
    ...
    private gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.ArrayOfImagingExchangeSiteTO sites;

    private gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.FaultTO faultTO;
    ...
    public ImagingExchangeRegionTO(
           ...
           java.lang.String ID,
           gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.ArrayOfImagingExchangeSiteTO sites,
           gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.FaultTO faultTO) {
           this.name = name;
           this.ID = ID;
           this.sites = sites;
     ...
     * @return sites
     */
    public gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.ArrayOfImagingExchangeSiteTO getSites() {
        return sites;
    }
     ...
     * @param sites
     */
    public void setSites(gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.ArrayOfImagingExchangeSiteTO sites) {
        this.sites = sites;
    }
     ...
     * @return faultTO
     */
    public gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.FaultTO getFaultTO() {
        return faultTO;
    }
     ...
     * @param faultTO
     */
    public void setFaultTO(gov.va.med.vistaweb.webservices.ImagingExchangeSiteService.FaultTO faultTO) {
        this.faultTO = faultTO;
    }
