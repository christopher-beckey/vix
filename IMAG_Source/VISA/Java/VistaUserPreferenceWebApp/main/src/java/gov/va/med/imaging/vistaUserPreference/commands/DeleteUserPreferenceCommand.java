 ...
 *
 */
public class DeleteUserPreferenceCommand
extends AbstractUserPreferenceCommands<String, RestStringType>
{
	...
	public DeleteUserPreferenceCommand(
			String siteNumber,
			String entity,
			String key,
	...
	throws MethodException, ConnectionException
	{
		try
		{
			...
			return getRouter().deleteUserPreference(routingToken, getEntity(), getKey());
		}
		catch(Exception e)
		{
	...
	{
		return "from site [" + getSiteNumber() + "] userID [" + this.getEntity() + "] key [" + this.getKey() + "]";
	}
