 ...
 *
 */
public class GetUserPreferenceUserEntityCommand
...

{
	...
	public GetUserPreferenceUserEntityCommand(
			String siteNumber,
			String userID,
			String key,
	...
	{
		return "from site [" + getSiteNumber() + "] level [" + this.getUserID() + "] key [" + this.getKey() + "]";
	}
