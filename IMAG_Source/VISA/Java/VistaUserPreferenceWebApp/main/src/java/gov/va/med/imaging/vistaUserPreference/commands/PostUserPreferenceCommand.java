 ...
 *
 */
public class PostUserPreferenceCommand
extends AbstractUserPreferenceCommands<String, RestStringType>
{
	...
	public PostUserPreferenceCommand(
			String siteNumber,
			String entity,
			String key,
			String value,
	...
	throws MethodException, ConnectionException
	{
		try
		{
			...
			return getRouter().postUserPreference(routingToken, getEntity(), getKey(), getValue());
		}
		catch(Exception e)
		{
	...
	{
		return "from site [" + getSiteNumber() + "] entity [" + this.getEntity() + "] key [" + this.getKey() + "]";
	}
