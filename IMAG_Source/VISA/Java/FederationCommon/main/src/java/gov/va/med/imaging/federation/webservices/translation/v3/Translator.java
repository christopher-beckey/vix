...
extends AbstractTranslator 
{
	...
	throws ParseException, TranslationException
	{
		...
		if(study.getFirstImage() == null)
			throw new TranslationException("Translator.translate(1) --> First image is null for study Id [" + study.getStudyUrn() + "].");
		...
		gov.va.med.imaging.federation.webservices.types.v3.ObjectOriginType originType =
			AbstractTranslator.translate(gov.va.med.imaging.federation.webservices.types.v3.ObjectOriginType.class, study.getObjectOrigin());
		...
		gov.va.med.imaging.federation.webservices.types.v3.FederationStudyTypeStudyModalities modalitiesType =
			AbstractTranslator.translate(gov.va.med.imaging.federation.webservices.types.v3.FederationStudyTypeStudyModalities.class, study.getModalities());
	...
	throws GlobalArtifactIdentifierFormatException 
	{
		...
		if(filterType != null) 
		{
			...
			{
                getLogger().error("Translator.translate(2) --> Set to null. Parse exception converting from-date [{}]: {}", filterType.getFromDate(), x.getMessage());
				fromDate = null;
			}
			...
			{
                getLogger().error("Translator.translate(2) --> Set to null. Parse exception converting to-date [{}]: {}", filterType.getToDate(), x.getMessage());
				fromDate = null;
			}
			...
			if((requestedStudyIdAsString != null) && (requestedStudyIdAsString.length() > 0))
			{
				...
				{
					String msg = "Translator.translate(2) --> Study Id [" + requestedStudyIdAsString + "] cannot be transformed into a GlobalArtifactIdentifier: " + x.getMessage();
					getLogger().error(msg);
	 ...
	 * @throws TranslationException
	 */
	public static gov.va.med.imaging.federation.webservices.types.v3.FederationVistaRadExamType[] translate(ExamSite examSite) 
	throws TranslationException
	{
		...
		for(Exam exam : examSite)
			result[i++] = AbstractTranslator.translate(gov.va.med.imaging.federation.webservices.types.v3.FederationVistaRadExamType.class, exam);
	 ...
	 * @throws TranslationException
	 */
	public static gov.va.med.imaging.federation.webservices.types.v3.FederationVistaRadExamType translate(Exam exam) 
	throws TranslationException
	{
		gov.va.med.imaging.federation.webservices.types.v3.FederationVistaRadExamType result =
		...
		else
		{
			...
			gov.va.med.imaging.federation.webservices.types.v3.FederationVistaRadExamImagesType examImages = 
				AbstractTranslator.translate(gov.va.med.imaging.federation.webservices.types.v3.FederationVistaRadExamImagesType.class, exam.getImages());
	 ...
	 * 
	 */
	public static gov.va.med.imaging.federation.webservices.types.v3.FederationVistaRadExamImagesType translate(ExamImages images) 
	throws TranslationException
	{
		...
		for(ExamImage examImage : images)
			examImages[count++] = AbstractTranslator.translate(gov.va.med.imaging.federation.webservices.types.v3.FederationVistaRadExamImageType.class, examImage);
	...
	public static gov.va.med.imaging.federation.webservices.types.v3.FederationVistaRadActiveExamsType translate(ActiveExams activeExams) 
	throws TranslationException
	{
		...
		for(int i = 0; i < activeExams.size(); i++)		
			activeExamArray[i] = AbstractTranslator.translate(gov.va.med.imaging.federation.webservices.types.v3.FederationVistaRadActiveExamType.class, activeExams.get(i));
	...
	public static gov.va.med.imaging.federation.webservices.types.v3.FederationVistaRadActiveExamType translate(ActiveExam activeExam)
	{
	 ...
	 * @return
	 */
	public static gov.va.med.imaging.federation.webservices.types.v3.FederationVistaRadPatientRegistrationType translate(PatientRegistration patientRegistration)
	{
	 ...
	 * @throws ParseException
	 */
	public static gov.va.med.imaging.federation.webservices.types.v3.FederationStudyTypeComponentSeries translate(Set<Series> seriesSet) 
	throws ParseException
	{
	 ...
	 * @throws ParseException
	 */
	public static gov.va.med.imaging.federation.webservices.types.v3.FederationSeriesType translate(Series series) 
	throws ParseException
	{
		if(series == null)
			return null;
	...
	throws ParseException
	{
		...
		{
			getLogger().warn("Translator.translate(3) --> Setting null procedure date for image");
	 ...
	 * @return
	 */
	public static PassthroughParameter translate(gov.va.med.imaging.federation.webservices.types.v3.FederationRemoteMethodParameterType parameter)
	{
		...
		gov.va.med.imaging.federation.webservices.types.v3.FederationRemoteMethodParameterValueType parameterValue = parameter.getParameterValue();
	...
	public static gov.va.med.imaging.federation.webservices.types.v3.FederationFilterTypeOrigin translateObjectOrigin(String filterOrigin)
	{
	...
	throws InsufficientPatientSensitivityException, TranslationException
	{
		...
		{
			getLogger().info("Translator.translate(4) --> Study result contains error message, converting into InsufficientPatientSensitivityException");
        ...
        getLogger().info("Translator.translate(4) --> Transaction [{}] returned {} studies", transactionContext.getTransactionId(), studiesType.getStudy() == null ? 0 : studiesType.getStudy().length);
	...
	throws TranslationException
	{
		...
		{
			String msg = "Translator.translate(5) --> Unable to create a Study from the given key elements: " + x.getMessage();
			getLogger().error(msg);
		...
		if(study == null)
			throw new TranslationException(
				"Translator.translate(5) --> Failed to create Study instance from " + 
	...
	public static gov.va.med.imaging.federation.webservices.types.v3.FederationImageAccessLogEventType translate(ImageAccessLogEvent logEvent)
	{
	...
	public static SortedSet<Patient> translate(gov.va.med.imaging.federation.webservices.types.v3.PatientType [] patients)
	{
		...
		for(int i = 0; i < patients.length; i++)
		{
			...
			{
                getLogger().warn("Translator.translate(7) --> Parse exception converting patient ICN [{}]:{}", patients[i].getPatientIcn(), pX);
			}
		}		
		return result;
	}
	...
	public static PatientSensitiveValue translate(gov.va.med.imaging.federation.webservices.types.v3.PatientSensitiveCheckResponseType responseType)
	{
	...
	public static gov.va.med.imaging.federation.webservices.types.v3.FederationRemoteMethodParameterType[] translate(SortedSet<PassthroughParameter> parameters)
	{
		if(parameters == null)
			return null;
	 ...
	 * @return
	 */
	public static gov.va.med.imaging.federation.webservices.types.v3.FederationRemoteMethodParameterMultipleType translate(String [] multiples)
	{
		if(multiples == null)
			return null;
	...
	public static String translateDecodeExamImageAccessInputParameter(String inputParameter)
	{
		...
		String prefix = "";
		String pieces [] = StringUtil.split(inputParameter, StringUtil.CARET);
		for(int i = 0; i < pieces.length; i++)
		{
			if(i == 2)
			{
				...
				{
                    getLogger().warn("Translator.translateDecodeExamImageAccessInputParameter() --> Return null. Error converting string [{}] into ImageURN: {}", pieces[i], urnfX.getMessage());
					return null;
				}
			}
			else
	...
	public static String translateEncodeExamImageAccessInputParameter(String inputParameter)
	{
		...
		for(int i = 0; i < pieces.length; i++)
		{
			if(i == 2)
			{
				...
				{
                    getLogger().warn("Translator.translateEncodeExamImageAccessInputParameter() --> Return null. Error converting string [{}] into ImageURN: {}", pieces[i], urnfX.getMessage());
					return null;
				}
			}
			else
