 ...
 *
 */
public class TestMIXsConnection
extends TestCase
{
	/**
	 * 
	...
	public void testUrlAvailability()
	{
		try
        {
	        URL secureUrl = new URL("mixs://www.google.com");
	        ...
	        //URL url = new URL("mix://www.google.com");
        ...
        {
			fail("Protocol 'mixs' is not available.");
        }
		catch (IOException x)
		{
			x.printStackTrace();
			fail("Protocol 'mixs' failed to connct as https.");
		}
