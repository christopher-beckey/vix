...
implements Serializable
{
	...
	private final Logger LOGGER = Logger.getLogger(WellKnownOID.class);
	...
	WellKnownOID(String[] oidAsString, String description, boolean homeCommunityId) 
	{
		...
		{
            LOGGER.warn("WellKnownOID() --> Unable to initialize WellKnownOID [{}]", oidAsString);
		}
	...
	public boolean isApplicable(String oidAsString)
	{
		...
		{
            LOGGER.warn("WellKnownOID.isApplicable() --> OIDFormatException converting [{}]", oidAsString);
			return false;
		}
	}
