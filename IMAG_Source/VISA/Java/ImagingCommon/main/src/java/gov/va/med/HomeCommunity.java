...
public class HomeCommunity
{
	...
	static
	{
		...
		// Fortify change: moved 'in' and 'reader' into try-with-resources
		try ( InputStream in = HomeCommunity.class.getClassLoader().getResourceAsStream("gov/va/med/HomeCommunityOIDs.txt");
				LineNumberReader reader = new LineNumberReader( new InputStreamReader(in) ))
		{
