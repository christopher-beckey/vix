...
implements Serializable, PatientArtifactIdentifier
{
	...
	protected static final String NEWDATASTRUCTURE_PREFIX = "N";
	protected static final String MUSE_PREFIX = "M";
	
	private boolean isNewDataStructure = false;
	...
	public boolean isNewDataStructure() {
		return isNewDataStructure;
	}

	protected void setNewDataStructure(boolean isNewDataStructure) {
		this.isNewDataStructure = isNewDataStructure;
	}
