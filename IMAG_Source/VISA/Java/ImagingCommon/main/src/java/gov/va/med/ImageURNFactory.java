...
extends URNFactory
{
	...
	private static final Class<?>[] P34_IMAGE_CREATE_METHOD_PARAMETERS = 
		new Class<?>[]{String.class, String.class, String.class, String.class, String.class, String.class};
	private static final Class<?>[] P34_IMAGE_CREATE_WITH_MODALITY_METHOD_PARAMETERS = 
		new Class<?>[]{String.class, String.class, String.class, String.class, String.class, String.class, String.class};
	private static final Class<?>[] MUSE_IMAGE_CREATE_METHOD_PARAMETERS = 
			new Class<?>[]{String.class, String.class, String.class, String.class, String.class};
	private static final Class<?>[] MUSE_IMAGE_CREATE_WITH_MODALITY_METHOD_PARAMETERS = 
		new Class<?>[]{String.class, String.class, String.class, String.class, String.class, String.class};
	...
	throws URNFormatException
	{
		...
		if(imageModality == null)
		{
			String[] vaUrnComponents = new String[]{originatingSiteId, assignedId, studyId, patientId, artifactIenFull, artifactIenAbs};
			return (T)create(expectedClass, URNFactory.FACTORY_METHOD_NAME, P34_IMAGE_CREATE_METHOD_PARAMETERS, vaUrnComponents);
		}
		else
		{
			String[] vaUrnComponents = new String[]{originatingSiteId, assignedId, studyId, patientId, artifactIenFull, artifactIenAbs, imageModality};
			return (T)create(expectedClass, URNFactory.FACTORY_METHOD_NAME, P34_IMAGE_CREATE_WITH_MODALITY_METHOD_PARAMETERS, vaUrnComponents);
	...
	throws URNFormatException
	{
		String msgIdentifier = 
			"site ID[" + originatingSiteId + "], assignedId [" + assignedId + 
			"], studyId [" + studyId + "], patientId [" + patientId + "], museServerId [" + museServerId + "]" 
		...
		if(imageModality == null)
		{
			String[] vaUrnComponents = new String[]{originatingSiteId, assignedId, studyId, patientId, museServerId};
			return (T)create(expectedClass, URNFactory.FACTORY_METHOD_NAME, MUSE_IMAGE_CREATE_METHOD_PARAMETERS, vaUrnComponents);
		}
		else
		{
			String[] vaUrnComponents = new String[]{originatingSiteId, assignedId, studyId, patientId, museServerId, imageModality};
			return (T)create(expectedClass, URNFactory.FACTORY_METHOD_NAME, MUSE_IMAGE_CREATE_WITH_MODALITY_METHOD_PARAMETERS, vaUrnComponents);
