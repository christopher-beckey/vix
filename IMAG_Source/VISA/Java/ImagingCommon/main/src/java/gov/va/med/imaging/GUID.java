...
public class GUID implements Serializable
{
	...
	// OLD: private static int lastSequence = (int)(Math.random() * Integer.MAX_VALUE);
	// NEW: Must use "new" operator (see line 144) and give Integer.MAX_VALUE to ensure positive value
	private static int lastSequence = new SecureRandom().nextInt(Integer.MAX_VALUE);
	...
	static
	{
		...
		{
			hostId = NetUtilities.getUnsafeLocalHostName();
		}
