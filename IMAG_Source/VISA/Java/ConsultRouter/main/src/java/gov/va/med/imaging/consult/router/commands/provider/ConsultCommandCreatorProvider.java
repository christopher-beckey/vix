 ...
 */
package gov.va.med.imaging.consult.router.commands.provider;
 ...
 *
 */
public class ConsultCommandCreatorProvider
extends CommandCreatorProvider
{

	public ConsultCommandCreatorProvider()
	{
	...
	protected String[] getCommandPackageNames() 
	{
		return new String []
           {
				"gov.va.med.imaging.consult.router.commands"
           };
	}
