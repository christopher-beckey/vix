	...
	protected synchronized static ImagingCache getImagingCache()
	{
		if(imagingCache == null)
		{
			...
			try
			{
                ...
                logger.info("Getting reference from context'{}' to imaging cache using name '" + IMAGING_CACHE + "'.", ctx.getNameInNamespace());
				...
				{
                    logger.warn("Error casting object of type '{}', loaded by '{}' to type '{}', loaded by '{}'. \nCreating proxied reference to implementation of ImagingCache.", obj.getClass().getName(), obj.getClass().getClassLoader().getClass().getName(), Router.class.getName(), Router.class.getClassLoader().getClass().getName());
