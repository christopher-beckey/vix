...
implements VistaImagingCodeGeneratorDataSourceService, PathologyDataSourceSpi
{
	...
	throws MethodException, ConnectionException
	{
        ...
        logger.info("getCases ({}, days='{}'{}) TransactionContext ({}).", released == true ? "released" : "unreleased", days, requestingSiteId == null ? "" : " requestingSiteId='" + requestingSiteId + "'", TransactionContextFactory.get().getDisplayIdentity());
	...
	throws MethodException, ConnectionException
	{
        ...
        logger.info("getPatientCases ({}) TransactionContext ({}).", patientIdentifier, TransactionContextFactory.get().getDisplayIdentity());
		VistaSession localVistaSession = null;
		try 
		{
			localVistaSession = getVistaSession();
	...
	throws MethodException, ConnectionException
	{
        ...
        logger.info("lockCase ({}, {}) TransactionContext ({}).", pathologyCaseUrn.toString(), lock, TransactionContextFactory.get().getDisplayIdentity());
		VistaSession localVistaSession = null;
		try 
		{
			localVistaSession = getVistaSession();			
	...
	throws MethodException, ConnectionException
	{
        ...
        logger.info("addCaseAssistance ({}, {}) TransactionContext ({}).", pathologyCaseUrn.toString(), assistanceType, TransactionContextFactory.get().getDisplayIdentity());
		VistaSession localVistaSession = null;
		try 
		{
			localVistaSession = getVistaSession();			
	...
	throws MethodException, ConnectionException
	{
        ...
        logger.info("getSiteTemplate ({}) TransactionContext ({}).", sb.toString(), TransactionContextFactory.get().getDisplayIdentity());
		VistaSession localVistaSession = null;
		try 
		{
	...
	throws MethodException, ConnectionException
	{
        ...
        logger.info("saveSiteTemplate ({}) TransactionContext ({}).", apSection, TransactionContextFactory.get().getDisplayIdentity());
		VistaSession localVistaSession = null;
		try 
		{			
			localVistaSession = getVistaSession();
	...
	throws MethodException, ConnectionException
	{
        ...
        logger.info("updateReadingSiteList ({}, delete[{}]) TransactionContext ({}).", readingSite.getSiteId(), delete, TransactionContextFactory.get().getDisplayIdentity());
		VistaSession localVistaSession = null;
		try 
		{
			localVistaSession = getVistaSession();
	...
	throws MethodException, ConnectionException
	{
        ...
        logger.info("updateAcquisitionSiteList ({}, delete[{}]) TransactionContext ({}).", acquisitionSite.getSiteId(), delete, TransactionContextFactory.get().getDisplayIdentity());
		VistaSession localVistaSession = null;
		try 
		{
			localVistaSession = getVistaSession();
	...
	throws MethodException, ConnectionException
	{
        ...
        logger.info("getPathologyCaseReport ({}) TransactionContext ({}).", pathologyCaseUrn.toString(), TransactionContextFactory.get().getDisplayIdentity());
		VistaSession localVistaSession = null;
		try 
		{
			localVistaSession = getVistaSession();
	...
	throws MethodException, ConnectionException
	{
        ...
        logger.info("getSupplementalReports ({}) TransactionContext ({}).", pathologyCaseUrn.toString(), TransactionContextFactory.get().getDisplayIdentity());
		VistaSession localVistaSession = null;
		try 
		{
			localVistaSession = getVistaSession();
	...
	throws MethodException, ConnectionException
	{
        ...
        logger.info("getTemplateData ({}) TransactionContext ({}).", pathologyCaseUrn.toString(), TransactionContextFactory.get().getDisplayIdentity());
		VistaSession localVistaSession = null;
		try 
		{
			localVistaSession = getVistaSession();
	...
	throws MethodException, ConnectionException
	{
        ...
        logger.info("reserveCase ({}, {}) TransactionContext ({}).", pathologyCaseUrn.toString(), lock, TransactionContextFactory.get().getDisplayIdentity());
		VistaSession localVistaSession = null;
		try 
		{
			localVistaSession = getVistaSession();			
	...
	throws MethodException, ConnectionException
	{
        ...
        logger.info("checkElectronicSignatureNeeded ({}) TransactionContext ({}).", apSection, TransactionContextFactory.get().getDisplayIdentity());
		VistaSession localVistaSession = null;
		try 
		{
			localVistaSession = getVistaSession();			
	...
	throws MethodException, ConnectionException
	{
        ...
        logger.info("getPathologyFields ({}, {}) TransactionContext ({}).", pathologyField, searchParameter, TransactionContextFactory.get().getDisplayIdentity());
		VistaSession localVistaSession = null;
		try 
		{
			localVistaSession = getVistaSession();			
	...
	throws MethodException, ConnectionException
	{
        ...
        logger.info("updateConsultationStatus ({}, {}) TransactionContext ({}).", pathologyCaseConsultationUrn.toString(), consultationUpdateStatus, TransactionContextFactory.get().getDisplayIdentity());
		VistaSession localVistaSession = null;
		try 
		{
			localVistaSession = getVistaSession();			
	...
	throws MethodException, ConnectionException
	{
        ...
        logger.info("copyCase ({}) TransactionContext ({}).", pathologyCaseUrn.toString(), TransactionContextFactory.get().getDisplayIdentity());
		VistaSession localVistaSession = null;
		try 
		{
			localVistaSession = getVistaSession();
