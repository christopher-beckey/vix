...
public abstract class AbstractProcessVeinsPeriodicCommand extends
	...
	private static final Logger LOGGER = Logger.getLogger(AbstractProcessVeinsPeriodicCommand.class);
	...
	public RoutingToken getRoutingToken() {
		if (routingToken == null) {
			try {
                ...
                LOGGER.warn("AbstractProcessVeinsPeriodicCommand.getRoutingToken() --> Encountered RoutingTokenFormatException: {}", rtfe.getMessage());
			}
		}
		return routingToken;
	}
