...
extends AbstractDataSourceCommandImpl<PatientSensitiveValue, PatientDataSourceSpi>
{
	...
	throws ConnectionException, MethodException 
	{
		...
		String resultLog = (sensitiveLevel == null ? "null" : "" + sensitiveLevel.getSensitiveLevel());
        getLogger().info("Got patient sensitive level [{}] for patient '{}' from site '{}'", resultLog, getPatientIdentifier(), getSiteNumber());
