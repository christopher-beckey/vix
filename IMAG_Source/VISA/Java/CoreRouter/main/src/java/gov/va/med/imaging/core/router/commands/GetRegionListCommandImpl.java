...
extends AbstractCommandImpl<List<Region>> 
{
	...
	private static final Logger logger = Logger.getLogger(GetRegionListCommandImpl.class);
			...
			throws MethodException, ConnectionException
	{
        ...
        {
        	String msg = "GetRegionListCommandImpl.callSynchronouslyInTransactionContext() --> Configured site resolution service failed to resolve all regions: " + me.getMessage();
        	logger.error(msg);
        	throw new MethodException(msg, me);
        } 
        catch (ConnectionException ce)
        {
        	String msg = "GetRegionListCommandImpl.callSynchronouslyInTransactionContext() --> Configured site resolution service was unable to contact data source: " + ce.getMessage();
        	logger.error(msg);
