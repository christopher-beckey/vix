...
extends AbstractCommandImpl<List<VixSiteServerHealth>>
{
	...
	private static final Logger logger = Logger.getLogger(GetVixSiteServerHealthListByRegionCommandImpl.class);
	...
	{
        logger.info("GetVixSiteServerHealthListByRegionCommandImpl.callSynchronouslyInTransactionContext() --> Retrieving VIX Server health for region number [{}], forceRefresh [{}]", this.regionNumber, this.forceRefresh);
	...
	throws MethodException, MethodConnectionException
	{
        ...
        {
			String msg = "GetVixSiteServerHealthListByRegionCommandImpl.getVIXSitesInRegion() --> Configured site resolution service is unable to contact data source: " +  e.getMessage();
        	logger.error(msg);
	...
	protected String parameterToString()
	{
		...
		sb.append(this.forceRefresh.toString());
