...
public class GetWorkItemModalitiesCommandImpl 
extends AbstractDicomImporterDataSourceCommandImpl<List<ImporterFilter>>
{

	private static final long serialVersionUID = 1L;

	private static final String SPI_METHOD_NAME = "getWorkItemModalities";

	public GetWorkItemModalitiesCommandImpl() {
	}
	...
	{
		return spi.getWorkItemModalities();
	}
