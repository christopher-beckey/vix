...
implements CommandFactory
{
	...
	private final synchronized ServiceLoader<CommandFactoryProvider> getProviderLoader()
	{
		...
		if (providerServiceLoader == null)
		{
            getLogger().info("ServiceLoader being created under context class loader [{}].", providerClassLoader == null ? "context class loader " + CommandFactoryProvider.class.getClassLoader().toString() : "specified class loader" + providerClassLoader.toString());
