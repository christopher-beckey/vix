...
extends FacadeRouter
{
	...
	@FacadeRouterMethod(asynchronous=false, isChildCommand=true, commandClassName="PostViewerPreCacheWorkItemsFromDataSourceCommand")
	public abstract Boolean postViewerPreCacheWorkItems(RoutingToken routingToken, SiteConnection siteConnection, List<WorkItem> items)
	throws MethodException, ConnectionException;
