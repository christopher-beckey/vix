...
public class ProcessVeinsFailedArchivePeriodicCommandImpl extends
	...
	private int placeId;
	private Logger logger = null; //Logger.getLogger(ProcessVeinsPeriodicCommandImpl.class);
	...
	public Logger getLogger() {
		if (logger == null)
		{
			logger = Logger.getLogger(ProcessVeinsPeriodicCommandImpl.class);
		}
		return logger;
	}
	...
	public String getMessageBody() throws MethodException, ConnectionException {
		...
		messageBuilder.append(NetUtilities.getUnsafeLocalHostName());
