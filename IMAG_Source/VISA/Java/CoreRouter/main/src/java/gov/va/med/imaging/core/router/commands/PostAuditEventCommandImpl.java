...
extends AbstractDataSourceCommandImpl<Boolean, EventLoggingDataSourceSpi> {
	...
	public RoutingToken getRoutingToken() {
		if(this.routingToken == null){
			try {
                ...
                getLogger().warn("{}: Failed to create Routing Token.", this.getClass().getName());
			}
		}
	...
	protected Boolean getCommandResult(EventLoggingDataSourceSpi spi)
        ...
        getLogger().info("Audit Event: {}; {}: {}", auditEvent.getEvent(), auditEvent.getHostname(), auditEvent.getApplicationName());
