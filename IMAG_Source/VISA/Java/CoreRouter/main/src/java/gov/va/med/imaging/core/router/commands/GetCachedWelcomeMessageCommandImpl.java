...
extends AbstractCommandImpl<WelcomeMessage>
{
	...
	throws MethodException, ConnectionException
	{
		...
		if(result != null)
		{
            ...
            getLogger().info("Welcome message for routing token '{}' found in cache.", getRoutingToken().toRoutingTokenString());
			return result;
		}
		else
		{
			transactionContext.setItemCached(false);
            getLogger().info("Welcome message for routing token '{}' NOT found in cache.", getRoutingToken().toRoutingTokenString());
