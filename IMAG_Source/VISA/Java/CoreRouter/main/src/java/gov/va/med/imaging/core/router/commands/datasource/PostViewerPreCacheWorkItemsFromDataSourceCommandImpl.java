 ...
 *
 */
public class PostViewerPreCacheWorkItemsFromDataSourceCommandImpl 
extends AbstractDataSourceCommandImpl<Boolean, ViewerServicesDataSourceSpi> {
	 ...
	 * @param searchName
	 */
	public PostViewerPreCacheWorkItemsFromDataSourceCommandImpl(RoutingToken routingToken, SiteConnection siteConnection,
			List<WorkItem> items)
	{
