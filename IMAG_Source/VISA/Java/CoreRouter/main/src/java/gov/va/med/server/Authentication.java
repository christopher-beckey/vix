...
public class Authentication
{
	...
	public static Principal authenticate(String siteId, String accessCode, String verifyCode)
	{
		...
		{
			logger.warn("Authentication.authenticate(1) --> Failed to acquire a reference to the authentication server adapter. Return null.");
			return null;
		}
	...
	public static Principal authenticate(String siteId, X509Certificate[] certs)
	{
		...
		if(authentication == null)
		{
			logger.warn("Authentication.authenticate(2) --> Failed to acquire a reference to the authentication server adapter. Return null.");
			return null;
		}
		...
		String md5a2)
	{
		...
		if(authentication == null)
		{
			logger.warn("Authentication.authenticate(3) --> Failed to acquire a reference to the authentication server adapter. Return null.");
			return null;
		}
