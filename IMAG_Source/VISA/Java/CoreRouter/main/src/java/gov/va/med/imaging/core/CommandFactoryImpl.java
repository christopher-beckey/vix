...
implements CommandFactory
{
	...
	private final static Logger logger = Logger.getLogger(CommandFactoryImpl.class);
		...
		Object[] parameters)
	{
		...
		{
            logger.warn("CommandFactoryImpl.createCommand() --> The command name [{}] is not a valid command class name according to the defined semantics: {}", commandClassName, x.getMessage());
			return null;
		}
			...
			Class<?>[] parameterTypes, Object[] parameters)
	{
		...
		{
            logger.warn("CommandFactoryImpl.isCommandSupported() --> The command name [{}] is not a valid command class name according to the defined semantics: {}", commandClassName, x.getMessage());
			return false;
		}
			...
			throws IllegalArgumentException
	{
		...
		{
            logger.warn("CommandFactoryImpl.isCollectionCommandSupported() --> The command name [{}] is not a valid command class name according to the defined semantics: {}", commandClassName, x.getMessage());
			return false;
		}
			...
			throws IllegalArgumentException
	{
		...
		{
            logger.warn("CommandFactoryImpl.isMapCollectionCommandSupported() --> The command name [{}] is not a valid command class name according to the defined semantics: {}", commandClassName, x.getMessage());
			return false;
		}
			...
			Class<?>[] initArgTypes, Object[] initArgs)
	{
		...
		{
            logger.warn("CommandFactoryImpl.createNonTypesafeCommand() --> The command name [{}] is not a valid command class name according to the defined semantics: {}", commandClassName, x.getMessage());
			return null;
		}
	...
	{
		return (commandCreator == null ? new CommandCreator(commandContext) : commandCreator);
	}
