...
extends AbstractCommandImpl<java.lang.Void>
{
	...
	private static final Logger logger = Logger.getLogger(GetTransactionLogEntriesCommandImpl.class);
	...
	{
		logger.info ("GetTransactionLogEntriesCommandImpl.callSynchronouslyInTransactionContext() --> Starts processing.....");
		...
		{
            logger.warn("GetTransactionLogEntriesCommandImpl.callSynchronouslyInTransactionContext() --> Encountered ConnectionException: {}", cX.getMessage());
		...
		{
            logger.warn("GetTransactionLogEntriesCommandImpl.callSynchronouslyInTransactionContext() --> Failed to get log entries: {}", mX.getMessage());
	...
	{
		return "GetTransactionLogEntriesCommandImpl: many params";
	}
}
