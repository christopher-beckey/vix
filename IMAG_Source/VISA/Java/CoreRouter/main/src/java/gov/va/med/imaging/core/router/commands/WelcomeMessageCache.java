	...
	public static void cacheWelcomeMessage(RoutingToken routingToken, WelcomeMessage welcomeMessage)
	{
		try
		{
			if(welcomeMessage != null)
			{
				...
				WelcomeMessageCacheValueItem cacheItem = new WelcomeMessageCacheValueItem(routingToken, welcomeMessage);
		...
		{
            logger.warn("WelcomeMessageCache.cacheWelcomeMessage() --> Error caching welcome message for routing token [{}: {}", routingToken.toRoutingTokenString(), ex.getMessage());
		}
	}
