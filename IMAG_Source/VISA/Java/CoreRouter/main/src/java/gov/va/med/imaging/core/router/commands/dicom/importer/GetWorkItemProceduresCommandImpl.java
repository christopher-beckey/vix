...
public class GetWorkItemProceduresCommandImpl 
extends AbstractDicomImporterDataSourceCommandImpl<List<ImporterFilter>>
{

	private static final long serialVersionUID = 1L;

	private static final String SPI_METHOD_NAME = "getWorkItemProcedures";

	public GetWorkItemProceduresCommandImpl() {
	}
	...
	{
		return spi.getWorkItemProcedures();
	}
