...
public interface ITIUNoteRestProxy {
	...
	public abstract Boolean isTIUNoteValid(RoutingToken globalRoutingToken, TIUItemURN tiuNoteUrn, 
			PatientTIUNoteURN noteUrn, String typeIndex)
	throws MethodException, ConnectionException;
