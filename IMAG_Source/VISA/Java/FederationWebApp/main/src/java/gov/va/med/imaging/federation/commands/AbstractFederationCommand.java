 ...
 */
package gov.va.med.imaging.federation.commands;
 ...
 *
 */
public abstract class AbstractFederationCommand<D, E extends Object>
extends AbstractWebserviceCommand<D, E>
{

	public AbstractFederationCommand(String methodName)
	{
		super(methodName);
	}
	 ...
	 */
	@Override
	protected FederationRouter getRouter()
	{
