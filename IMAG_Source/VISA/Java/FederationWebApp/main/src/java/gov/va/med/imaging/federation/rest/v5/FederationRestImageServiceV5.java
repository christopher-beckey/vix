...
import gov.va.med.imaging.federation.rest.v4.FederationRestImageServiceV4;
 ...
 *
 */
@Path(FederationRestUri.federationRestUriV5 + "/" + FederationImageRestUri.imageServicePath)
public class FederationRestImageServiceV5 
extends FederationRestImageServiceV4
{	
	@Override
