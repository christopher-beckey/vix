...
import gov.va.med.imaging.federation.rest.v4.FederationRestStudyGraphServiceV4;
 ...
 *
 */
@Path(FederationRestUri.federationRestUriV5 + "/" + FederationStudyGraphRestUri.studyServicePath)
public class FederationRestStudyGraphServiceV5 
extends FederationRestStudyGraphServiceV4
{
	@Override
