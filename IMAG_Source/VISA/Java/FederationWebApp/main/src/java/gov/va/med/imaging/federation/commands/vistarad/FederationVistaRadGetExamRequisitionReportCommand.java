 ...
 *
 */
public class FederationVistaRadGetExamRequisitionReportCommand
extends AbstractFederationVistaRadCommand<String, String>
{
	private final String examId;
	private final String interfaceVersion;

	public FederationVistaRadGetExamRequisitionReportCommand(String examId, String interfaceVersion)
	{
		super("getVistaRadRequisitionReport");
		this.examId = examId;
