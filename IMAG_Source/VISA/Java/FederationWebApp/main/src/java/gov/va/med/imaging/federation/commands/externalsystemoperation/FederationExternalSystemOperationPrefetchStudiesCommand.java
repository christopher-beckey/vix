...
extends AbstractFederationCommand<Boolean, RestBooleanReturnType>
{
	...
	throws MethodException, ConnectionException
	{
		...
		{
			String msg = "FederationExternalSystemOperationPrefetchStudiesCommand.executeRouterCommand() --> Error translating given filter: " + x.getMessage();
			getLogger().error(msg);
		...
		{
			String msg = "FederationExternalSystemOperationPrefetchStudiesCommand.executeRouterCommand() --> Encountered routing exception: " + rtfX.getMessage();
			getLogger().error(msg);
			// must throw new instance of exception or else Jersey translates it to a 500 error
