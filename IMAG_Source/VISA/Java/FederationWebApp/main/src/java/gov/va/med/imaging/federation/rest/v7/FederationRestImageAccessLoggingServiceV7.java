 ...
 */
package gov.va.med.imaging.federation.rest.v7;
 ...
 *
 */
@Path(FederationRestUri.federationRestUriV7 + "/" + FederationImageAccessLoggingUri.imageAccessLoggingServicePath)
public class FederationRestImageAccessLoggingServiceV7
