 ...
 *
 */
public class FederationExternalSystemOperationPrefetchExamImageCommand
extends AbstractFederationVistaRadCommand<Boolean, RestBooleanReturnType>
{
	...
	public FederationExternalSystemOperationPrefetchExamImageCommand(String imageUrn, 
			FederationImageFormatQualitiesType imageFormatQualitiesType,
			boolean includeTextFile, String interfaceVersion)
	{
		super("prefetchImage");
	...
	throws MethodException, ConnectionException
	{
		try
		{
			...
			return router.prefetchExamImageInstance(imageUrn, 
					getImageFormatQualityList(), isIncludeTextFile());			
		}
