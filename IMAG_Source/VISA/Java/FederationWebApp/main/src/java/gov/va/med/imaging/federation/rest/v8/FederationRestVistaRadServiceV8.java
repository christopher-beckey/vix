...
import gov.va.med.imaging.federation.rest.v5.FederationRestVistaRadServiceV5;
 ...
 *
 */
@Path(FederationRestUri.federationRestUriV8 + "/" + FederationVistaRadRestUri.vistaradServicePath)
public class FederationRestVistaRadServiceV8 
extends FederationRestVistaRadServiceV5
{	
	@Override
