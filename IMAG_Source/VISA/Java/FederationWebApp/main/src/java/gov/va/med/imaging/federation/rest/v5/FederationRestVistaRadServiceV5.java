...
import gov.va.med.imaging.federation.rest.v4.FederationRestVistaRadServiceV4;
 ...
 *
 */
@Path(FederationRestUri.federationRestUriV5 + "/" + FederationVistaRadRestUri.vistaradServicePath)
public class FederationRestVistaRadServiceV5 
extends FederationRestVistaRadServiceV4 
{	
	@Override
