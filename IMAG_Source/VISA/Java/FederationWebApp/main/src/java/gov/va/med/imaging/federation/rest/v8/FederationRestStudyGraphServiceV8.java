...
import gov.va.med.imaging.federation.rest.v5.FederationRestStudyGraphServiceV5;
 ...
 *
 */
@Path(FederationRestUri.federationRestUriV8 + "/" + FederationStudyGraphRestUri.studyServicePath)
public class FederationRestStudyGraphServiceV8 
extends FederationRestStudyGraphServiceV5
{
	@Override
