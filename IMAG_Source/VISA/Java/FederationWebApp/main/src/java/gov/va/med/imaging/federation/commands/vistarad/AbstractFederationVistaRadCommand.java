 ...
 *
 */
public abstract class AbstractFederationVistaRadCommand
<D extends Object, E extends Object>
extends AbstractFederationCommand<D, E>
{
	public AbstractFederationVistaRadCommand(String methodName)
	{
		super(methodName);
	}
	...
	{
		getTransactionContext().setImagingSecurityContextType(ImagingSecurityContextType.MAGJ_VISTARAD.toString());
	}	
