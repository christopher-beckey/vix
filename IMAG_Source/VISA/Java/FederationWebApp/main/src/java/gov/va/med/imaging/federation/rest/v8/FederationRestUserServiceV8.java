...
import gov.va.med.imaging.federation.rest.v6.FederationRestUserServiceV6;

/**
 * @author VHAISLTJAHJB
 *
 */
@Path(FederationRestUri.federationRestUriV8 + "/" + FederationUserRestUri.userServicePath)
public class FederationRestUserServiceV8
extends FederationRestUserServiceV6
{
	@Override
