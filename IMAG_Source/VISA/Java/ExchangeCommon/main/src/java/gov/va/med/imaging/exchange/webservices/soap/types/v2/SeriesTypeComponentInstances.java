...
public class SeriesTypeComponentInstances  implements java.io.Serializable {
    private gov.va.med.imaging.exchange.webservices.soap.types.v2.InstanceType[] instance;
     ...
     * @return instance
     */
    public gov.va.med.imaging.exchange.webservices.soap.types.v2.InstanceType[] getInstance() {
        return instance;
    }
     ...
     * @param instance
     */
    public void setInstance(gov.va.med.imaging.exchange.webservices.soap.types.v2.InstanceType[] instance) {
        this.instance = instance;
    }

    public gov.va.med.imaging.exchange.webservices.soap.types.v2.InstanceType getInstance(int i) {
        return this.instance[i];
    }

    public void setInstance(int i, gov.va.med.imaging.exchange.webservices.soap.types.v2.InstanceType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:v2.types.soap.webservices.exchange.imaging.med.va.gov", ">SeriesType>component-instances"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("instance");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:v2.types.soap.webservices.exchange.imaging.med.va.gov", "instance"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:v2.types.soap.webservices.exchange.imaging.med.va.gov", "InstanceType"));
