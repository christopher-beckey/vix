 ...
 *
 */
public class ExchangeArtifactResultError 
implements ArtifactResultError
{
	...
	public ExchangeArtifactResultError(String codeContext, String location, ArtifactResultErrorCode errorCode, ArtifactResultErrorSeverity severity)
	{
