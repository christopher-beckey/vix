 ...
 *
 */
public class ROICancelWorkItemCommand
extends AbstractROICommand<Boolean, RestBooleanReturnType>
{
	private final String guid;
	
	public ROICancelWorkItemCommand(String guid)
	{
	...
	{
		return getRouter().cancelROIWorkItem(getGuid());
	}
