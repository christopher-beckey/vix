 ...
 *
 */
public class ROIGetUserWorkItemsCommand
extends AbstractROICommand<List<WorkItem>, ROIRequestType[]>
{

	/**
	 * @param methodName
	 */
	public ROIGetUserWorkItemsCommand()
	{
		super("getUserWorkItems");
	}
	...
	{
		return getRouter().getUserROIRequests();
	}
	 ...
	 */
	@Override
	protected ROIRequestType[] translateRouterResult(List<WorkItem> routerResult)
