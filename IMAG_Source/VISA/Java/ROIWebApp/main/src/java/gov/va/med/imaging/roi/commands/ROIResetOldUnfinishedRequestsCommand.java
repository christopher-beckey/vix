 ...
 *
 */
public class ROIResetOldUnfinishedRequestsCommand
extends AbstractROICommand<Boolean, RestBooleanReturnType>
{

	public ROIResetOldUnfinishedRequestsCommand()
	{
		super("resetOldUnfinishedRequests");
	}
	...
	{
		getRouter().processOldUnfinishedROIRequests();
		return true;
	}
