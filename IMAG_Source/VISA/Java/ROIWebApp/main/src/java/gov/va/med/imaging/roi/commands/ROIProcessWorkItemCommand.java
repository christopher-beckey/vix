 ...
 *
 */
public class ROIProcessWorkItemCommand
extends AbstractROICommand<Boolean, RestBooleanReturnType>
{
	private final String guid;
	
	public ROIProcessWorkItemCommand(String guid)
	{
		super("processWorkItem");
		this.guid = guid;
	}
	...
	{
		getRouter().processROIWorkItem(getGuid());
		return true;
	}
	...
	{
		return "for ROI work item (" + getGuid() + ")";
	}
	...
	{
		return RestCoreTranslator.translate(true);
	}
	...
	protected Map<WebserviceInputParameterTransactionContextField, String> getTransactionContextFields()
	{
		...
		transactionContextFields.put(WebserviceInputParameterTransactionContextField.urn, getGuid());
