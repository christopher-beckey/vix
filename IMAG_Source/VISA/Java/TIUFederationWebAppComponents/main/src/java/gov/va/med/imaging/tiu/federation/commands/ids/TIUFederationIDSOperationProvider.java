package gov.va.med.imaging.tiu.federation.commands.ids;
...
public class TIUFederationIDSOperationProvider 
extends IDSOperationProvider {
	...
	public List<ImagingOperation> getImagingOperations() {
		...
		operations.add(new ImagingOperation("TIUNoteDataSourceSpi", "/restservices/V10/"));
		return operations;
	}
