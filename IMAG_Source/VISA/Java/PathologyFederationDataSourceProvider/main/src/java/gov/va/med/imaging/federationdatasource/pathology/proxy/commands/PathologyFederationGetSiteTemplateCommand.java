...
extends AbstractPathologyFederationRestProxyGetCommand<RestStringArrayType, List<String>>
{
	...
	{
		return "for AP Sections '" + PathologyFederationRestTranslator.translateStringListToDelimitedString(getApSections(), StringUtil.CARET) + "' to site '" + getGlobalRoutingToken().toRoutingTokenString() + "'.";
	}
	...
	protected Map<String, String> getUrlParametersKeyValues()
	{
		...
		urlParameterKeyValues.put("{apSections}", PathologyFederationRestTranslator.translateStringListToDelimitedString(getApSections(), StringUtil.CARET));
