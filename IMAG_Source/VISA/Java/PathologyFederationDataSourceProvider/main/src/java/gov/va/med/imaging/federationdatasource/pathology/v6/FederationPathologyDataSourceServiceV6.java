...
implements PathologyDataSourceSpi
{
	...
	private final static Logger logger = Logger.getLogger(FederationPathologyDataSourceServiceV6.class);
	...
	throws SecurityException
	{
		...
		{
            getLogger().warn("Cannot find proxy service type '{}' at site [{}]", getProxyServiceType().toString(), getSite().getSiteNumber());
			return false;
		}
	}
