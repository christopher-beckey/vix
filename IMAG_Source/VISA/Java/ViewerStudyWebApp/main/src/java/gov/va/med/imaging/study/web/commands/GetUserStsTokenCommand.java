...
public class GetUserStsTokenCommand
extends AbstractViewerStudyWebCommand<String, RestStringType>
{
	 ...
	 * @param methodName
	 */
	public GetUserStsTokenCommand(String appName, String stsToken)
	{
		super("getUserStsToken");
	...
	{
		return getRouter().getUserStsToken(appName, stsToken);
	}
