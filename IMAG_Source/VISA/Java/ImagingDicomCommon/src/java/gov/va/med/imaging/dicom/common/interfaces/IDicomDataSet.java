...
public interface IDicomDataSet {
     ...
     * Important: Should call setReceivedTransferSyntax() method before calling this method.
     * @return byte[]	an array of the Part10 DICOM file.  This includes the Preamble and Group 0002 elements.
     */
