...
implements SiteProtocolPreferenceFactory
{
	...
	private final SortedSet<ProtocolPreference> preferences = new TreeSet<ProtocolPreference>(new ProtocolPreferenceComparator());
...
//		);
	...
	class ProtocolPreferenceComparator
	implements Comparator<ProtocolPreference>,Serializable
	{
		private static final long serialVersionUID = -3972810998919767605L;
