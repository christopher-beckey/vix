...
public class SiteServiceConfiguration implements Serializable {
	...
	public static SiteServiceConfiguration createDefault(
		...
		config.setMaxRestRetryAttempts(50);
		config.setMaxRestRetryDelay(90);
		return config;
	}
	...
	private int maxRestRetryAttempts;
	private int maxRestRetryDelay;
	...
	public String getVhaSitesXmlFileNameFromSiteServiceDir() {
		return "C:\\SiteService\\"+ defaultVhaSitesXmlFileName;
	}
	...
	public int getMaxRestRetryAttempts() {
		return maxRestRetryAttempts;
	}

	public void setMaxRestRetryAttempts(int maxRestRetryAttempts) {
		this.maxRestRetryAttempts = maxRestRetryAttempts;
	}

	public long getMaxRestRetryDelayMillis() {
		return maxRestRetryDelay * 1000L;
	}

	public long getMaxRestRetryDelay() {
		return maxRestRetryDelay;
	}

	public void setMaxRestRetryDelay(int maxRestRetryDelay) {
		this.maxRestRetryDelay = maxRestRetryDelay;
	}
}
