...
extends Provider
{
	...
	private SiteResolutionProvider(String name, double version, String info)
	{
        ...
        logger.info("SiteResolutionProvider adding service [{}] {} V{} implemented by '{}'.", SiteResolutionDataSourceSpi.class.getSimpleName(), SITE_SERVICE_PROTOCOL, SITE_SERVICE_PROTOCOL_VERSION, SiteResolver.class.getName());
		services.add(
			new ProviderService(
				this, 
