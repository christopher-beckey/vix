...
// import com.ibm.wsdl.extensions.http.HTTPConstants; // substitute for axis?
 ...
 *
 */
public abstract class AbstractMixProxy 
...
implements IMixProxy 
{
	...
	protected AbstractMixProxy(ProxyServices proxyServices, 
...
// ***		getMethod.setRequestHeader( HTTPConstants.HEADER_PRAGMA, "no-cache");
		...
		else if (result >= HttpStatus.SC_INTERNAL_SERVER_ERROR)
		{
			...
			{
                logger.warn("Transaction [{}] returned error with null input stream indicating image did not exist, throwing ImageNotFoundException.", transactionIdentifier);
