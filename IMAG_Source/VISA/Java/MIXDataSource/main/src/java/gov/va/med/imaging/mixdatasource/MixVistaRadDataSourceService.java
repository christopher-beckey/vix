 ...
 *
 */
public class MixVistaRadDataSourceService 
extends MixStudyGraphDataSourceService
implements VistaRadDataSourceSpi
{
	private final Logger logger = Logger.getLogger(MixVistaRadDataSourceService.class);
     ...
     */
    public static MixVistaRadDataSourceService create(ResolvedArtifactSource resolvedArtifactSource, String protocol)
    throws ConnectionException, UnsupportedProtocolException
    {
    	return new MixVistaRadDataSourceService(resolvedArtifactSource, protocol);
    }
	
	public MixVistaRadDataSourceService(ResolvedArtifactSource resolvedArtifactSource, String protocol)
	throws UnsupportedProtocolException
	{
...
//	
	...
	throws MethodException, ConnectionException 
	{
		...
		try
		{
			return MixVistaRadTranslator.translate(result);	
		}
