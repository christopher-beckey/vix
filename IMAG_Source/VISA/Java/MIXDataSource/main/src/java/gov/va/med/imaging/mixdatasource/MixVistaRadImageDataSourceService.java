 ...
 *
 */
public class MixVistaRadImageDataSourceService 
extends MixImageDataSourceService 
implements VistaRadImageDataSourceSpi 
{
	private final static Logger logger = 
		Logger.getLogger(MixVistaRadImageDataSourceService.class);
     ...
     */
    public static MixVistaRadImageDataSourceService create(ResolvedArtifactSource resolvedArtifactSource, String protocol)
    throws ConnectionException, UnsupportedProtocolException
    {
    	return new MixVistaRadImageDataSourceService(resolvedArtifactSource, protocol);
    }
	
	public MixVistaRadImageDataSourceService(ResolvedArtifactSource resolvedArtifactSource, String protocol)
	throws UnsupportedProtocolException
	{
