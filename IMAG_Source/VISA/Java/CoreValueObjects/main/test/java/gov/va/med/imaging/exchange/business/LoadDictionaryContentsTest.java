...
public class LoadDictionaryContentsTest extends DicomCommonTestBase {
    ...
    public void testLoadingModalityDICFile() throws Exception{
        ...
        try{
            ...
            TESTLOGGER.info("Modality_test.dic contains {} entries.", modalityList.size());
        }
    ...
    public void testLoadingCTParmsDICFile(){
        ...
        try{
            ...
            TESTLOGGER.info("CT_Param_test.dic contains {} entries.", parameterList.size());
        }
        catch (DicomDictionaryException dde){
            TESTLOGGER.info("Exception thrown.");
