...
extends VersionableDataSourceSpi
{
	...
	/**
	 * Update work item service. Modality and Procedure are required to update the cross-reference
	 * @param workItemId
	 * @param modality
	 * @param procedure
	 * @param service
	 ...
	 * @throws ConnectionException
	 */
	public abstract String updateWorkItemService(
			String service, 
			String modality,
			String procedure,
			String newService)
	 ...
	 * @param SCWorkItemQueryParameters
	 * @return List<StorageCommitWorkItem>
	 * @throws MethodException
	 * @throws ConnectionException
	 */
	public abstract List<StorageCommitWorkItem> listSCWorkItems(SCWorkItemQueryParameters parameters) 
	throws MethodException, ConnectionException; 
