...
implements TransactionLogEntry 
{
	...
	private final String securityTokenApplicationName;
	
	private static final Logger logger = Logger.getLogger(TransactionContextLogEntrySnapshot.class);
	
	public TransactionContextLogEntrySnapshot(TransactionContext context)
	{
		super();
		logger.trace("Constructing a TransactionContextLogEntrySnapshot object. Hi");
		...
		this.securityTokenApplicationName = context.getSecurityTokenApplicationName();
		
		logger.trace("Constructed a new TransactionContextLogEntrySnapshot object. Bye");
	}
