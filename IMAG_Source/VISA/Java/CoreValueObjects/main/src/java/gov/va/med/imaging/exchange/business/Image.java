...
implements Serializable, Comparable<Image>, RoutingToken 
{
	...
	private Date lastAccessDateTime = null;
	private String fullFilespec;
	private String absFilespec;
	private String fullFilepath;
	private String absFilepath;
	private String fullArtifactIen;
	private String absArtifactIen;
	private String fullDiskVolumeIen;
	private String absDiskVolumeIen;
	private String museServerId;
	private boolean isImageInNewDataStructure = false;
    ...
    public static Image create(
    		String originatingSiteId, String imageId, String studyId, 
    		PatientIdentifier patientIdentifier, 
    		String absArtifactIen, String fullArtifactIen,
    		String imageModality, boolean isNewDataStructure) 
    throws URNFormatException
    {
    	ImageURN imageUrn = null;
    	if(isNewDataStructure){
    		imageUrn= ImageURNFactory.create(originatingSiteId, imageId, studyId, 
    				patientIdentifier.getValue(), fullArtifactIen, absArtifactIen, imageModality, P34ImageURN.class);
    	}
    	else{
    		imageUrn= ImageURNFactory.create(originatingSiteId, imageId, studyId, 
    				patientIdentifier.getValue(), imageModality, ImageURN.class);
    	...
    	return create( imageUrn, isNewDataStructure );
    	}
    ...
    throws URNFormatException
    {
    	...
    	if(isNewDataStructure){
    		imageUrn= ImageURNFactory.create(originatingSiteId, imageId, studyId, 
    				patientIdentifier.getValue(), imageModality, P34ImageURN.class);
    	}
    	else{
    		imageUrn= ImageURNFactory.create(originatingSiteId, imageId, studyId, 
    				patientIdentifier.getValue(), imageModality, ImageURN.class);
    ...
    public static Image create(String originatingSiteId, String imageId, String studyId, 
    		PatientIdentifier patientIdentifier, String museServerId,
    		String imageModality, boolean isNewDataStructure, boolean isMuse) 
    throws URNFormatException
    {
    	ImageURN imageUrn = null;
    	if(isMuse){
    		imageUrn= ImageURNFactory.create(originatingSiteId, imageId, studyId, 
    				patientIdentifier.getValue(), museServerId, imageModality, MuseImageURN.class);
    	}
    	else{
    		imageUrn= ImageURNFactory.create(originatingSiteId, imageId, studyId, 
    				patientIdentifier.getValue(), imageModality, ImageURN.class);
    	...
    	return create( imageUrn, isNewDataStructure, isMuse );
    }
    ...
    public static Image create(ImageURN imageUrn, boolean isImageInNewDataStructure)
    {
    	return new Image(imageUrn, isImageInNewDataStructure);
    }

    public static Image create(ImageURN imageUrn, boolean isImageInNewDataStructure, boolean isMuse)
    {
    	return new Image(imageUrn, isImageInNewDataStructure, isMuse);
    }
    ...
    private Image(GlobalArtifactIdentifier globalArtifactIdentifier)
    {
        ...
        absFilename = fullFilename = bigFilename = description = procedure = absLocation = fullLocation = imageNumber = 
            ...
            siteAbbr = imageUid = qaMessage = absDiskVolumeIen = fullDiskVolumeIen = "";
        imgType = 0;
        procedureDate = null;
        errorMessage = "";
    }

    private Image(GlobalArtifactIdentifier globalArtifactIdentifier, boolean isImageInNewDataStructure)
    {
    	this.globalArtifactIdentifier = globalArtifactIdentifier;
    	this.isImageInNewDataStructure = isImageInNewDataStructure;
        absFilename = fullFilename = bigFilename = description = procedure = absLocation = fullLocation = imageNumber = 
            dicomSequenceNumberForDisplay = dicomImageNumberForDisplay = patientDFN = patientName = imageClass =  
            siteAbbr = imageUid = qaMessage = absDiskVolumeIen = fullDiskVolumeIen = "";
        imgType = 0;
    ...
    private Image(GlobalArtifactIdentifier globalArtifactIdentifier, boolean isImageInNewDataStructure, boolean isMuse)
    {
    	this.globalArtifactIdentifier = globalArtifactIdentifier;
    	this.isImageInNewDataStructure = isImageInNewDataStructure;
    	this.isMuse = isMuse;
	...
	public String toString() 
	{
		...
		output += "AbsArtifactIen: " + absArtifactIen + "\n";
		output += "FullFilename: " + fullArtifactIen + "\n";
		...
		output += "AlternateExamNumber: " + alternateExamNumber + "\n";
		output += "IsImageInNewDataStructure: " + isImageInNewDataStructure + "\n";
			...
			if(!this.getSiteNumber().equals(this.consolidatedSiteNumber))
			{
				...
				if(imageUrn != null)
				{
					try
					{
                        ...
                        logger.debug("Updating image '{}' with new site ID, created new URN '{}'.", imageUrn.toString(), newUrn.toString());
						...
						image.absArtifactIen = this.absArtifactIen;
						image.fullArtifactIen = this.fullArtifactIen;
						image.absDiskVolumeIen = this.absDiskVolumeIen;
						image.fullDiskVolumeIen = this.fullDiskVolumeIen;
						image.isImageInNewDataStructure = this.isImageInNewDataStructure;
                        image.accessionNumber = this.accessionNumber;
						return image;
					}
	...
	public boolean isImageInNewDataStructure() {
		return isImageInNewDataStructure;
	}

	public String getFullFilespec() {
		return fullFilespec;
	}

	public void setFullFilespec(String fullFilespec) {
		this.fullFilespec = fullFilespec;

	}

	public String getAbsFilespec() {
		return absFilespec;
	}

	public void setAbsFilespec(String absFilespec) {
		this.absFilespec = absFilespec;

	}

	public void setImageInNewDataStructure(boolean isImageInNewDataStructure) {
		this.isImageInNewDataStructure = isImageInNewDataStructure;
	}
	...
	public String getFullArtifactIen() {
		return fullArtifactIen;
	}

	public void setFullArtifactIen(String fullArtifactIen) {
		this.fullArtifactIen = fullArtifactIen;
        if(this.globalArtifactIdentifier instanceof P34ImageURN){
        	((P34ImageURN) this.globalArtifactIdentifier).setArtifactIenFull(this.fullArtifactIen);
        }

	}

	public String getAbsArtifactIen() {
		return absArtifactIen;
	}

	public void setAbsArtifactIen(String absArtifactIen) {
		this.absArtifactIen = absArtifactIen;
        if(this.globalArtifactIdentifier instanceof P34ImageURN){
        	((P34ImageURN) this.globalArtifactIdentifier).setArtifactIenAbs(this.absArtifactIen);
        }

	}

	public String getFullDiskVolumeIen() {
		return fullDiskVolumeIen;
	}

	public void setFullDiskVolumeIen(String fullDiskVolumeIen) {
		this.fullDiskVolumeIen = fullDiskVolumeIen;
	}

	public String getAbsDiskVolumeIen() {
		return absDiskVolumeIen;
	}

	public void setAbsDiskVolumeIen(String absDiskVolumeIen) {
		this.absDiskVolumeIen = absDiskVolumeIen;
	}
