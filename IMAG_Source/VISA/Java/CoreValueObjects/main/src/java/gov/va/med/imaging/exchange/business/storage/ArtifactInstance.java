...
public class ArtifactInstance implements PersistentEntity, Serializable {
	...
	private String absoluteFilespec;
	private String diskVolumePhysicalPathspec;
	...
	public String getAbsoluteFilespec() {
		return absoluteFilespec;
	}

	public void setAbsoluteFilespec(String absoluteFilespec) {
		this.absoluteFilespec = absoluteFilespec;
	}

	public String getDiskVolumePhysicalPathspec() {
		return diskVolumePhysicalPathspec;
	}

	public void setDiskVolumePhysicalPathspec(String diskVolumePhysicalPathspec) {
		this.diskVolumePhysicalPathspec = diskVolumePhysicalPathspec;
	}
