...
implements Serializable, Iterable<Image>
{
	...
	private boolean isSeriesInNewDataStructure = false;
	
	// Quoc added this for VAI-678
	@MockDataGenerationField(pattern="[A-Z]")
	...
	public boolean isSeriesInNewDataStructure() {
		return isSeriesInNewDataStructure;
	}

	public void setSeriesInNewDataStructure(boolean isSeriesInNewDataStructure) {
		this.isSeriesInNewDataStructure = isSeriesInNewDataStructure;
	}
