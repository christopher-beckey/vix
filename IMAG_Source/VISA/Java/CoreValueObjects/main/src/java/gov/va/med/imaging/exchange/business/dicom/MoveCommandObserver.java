...
public class MoveCommandObserver implements Observer {
	...
	private boolean sendDicomDataSetsAbort = false;
	...
	public boolean isSendDicomDataSetsAbort() {
		return sendDicomDataSetsAbort;
	}


	public void setSendDicomDataSetsAbort(boolean sendDicomDataSetsAbort) {
		this.sendDicomDataSetsAbort = sendDicomDataSetsAbort;
	}
