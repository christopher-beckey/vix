...
public class SiteConnection
{
	...
	public final static String siteConnectionVVSS = "VVSS";
	public final static String siteConnectionVVS = "VVS";
	 ...
	 * @param modality
	 */
	public SiteConnection(String protocol, String server, int port, String modality)
	{
		super();
		this.protocol = protocol;
		this.server = server;
