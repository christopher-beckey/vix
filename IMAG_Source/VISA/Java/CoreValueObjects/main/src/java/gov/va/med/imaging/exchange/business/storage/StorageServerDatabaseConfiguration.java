...
public class StorageServerDatabaseConfiguration 
{
	...
	private List<NetworkLocationInfo> networkLocations;
	...
	private Map<Integer, NetworkLocationInfo> networkLocationIndexByIen;
	...
	public NetworkLocationInfo getNetworkLocation(int networkLocationIen){
		return this.networkLocationIndexByIen.get(networkLocationIen);
	}
	...
	public synchronized void initializeConfiguration(
			...
			List<Place> places,
			List<NetworkLocationInfo> networkLocations) throws StorageConfigurationException
			
	{
		...
		createNetworkLocationIndexByIen();
	...
	private void createNetworkLocationIndexByIen() 
	{
		networkLocationIndexByIen = new HashMap<Integer, NetworkLocationInfo>();
		for (NetworkLocationInfo networkLocation: networkLocations)
		{
			networkLocationIndexByIen.put(new Integer(networkLocation.getNetworkLocationIEN()), networkLocation);
		}
	}
