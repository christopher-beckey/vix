...
implements Site, Serializable
{
	...
	public static final String ALIEN_SITE_PREFIX = "200";
	...
	private final String regionStorageId;
	private final String authenticatedSiteNumber;
	...
	public static String[] getCVIXProtocols()
	{
		return Messages.getString("SiteImpl.CVIX_PROTOCOLS").split(","); //$NON-NLS-1$
	}
	...
	throws MalformedURLException
	{
		...
		//if (siteNumber.startsWith(ALIEN_SITE_PREFIX))
		//	for(String protocol : getCVIXProtocols())
		//		siteUrls.add( 
		//			new URL(
		//				protocol, 
		//				isProtocolAccessingVista(protocol) ? vistaServer : acceleratorServer, 
	...
	throws MalformedURLException
    {
		this(
			...
			siteConnections,
			createDefaultSiteURLs(siteNumber, vistaServer, vistaPort, acceleratorServer, acceleratorPort) 
		);
    }
	...
	public SiteImpl(
	        ...
	        boolean sitePatientLookupable,
			boolean siteUserAuthenticatable,		
			String regionStorageId,
			String authenticatedSiteNumber,
			Map<String, SiteConnection> siteConnections) 
		throws MalformedURLException
	    {
			this(
		...
		public SiteImpl(
				...
				URL... servers)
			{
			    ...
			    this.regionStorageId = regionStorageId;
			    this.authenticatedSiteNumber = authenticatedSiteNumber;
			}
			...
			public SiteImpl(
					...
					URL... servers)
				{
					this(regionId, siteNumber, siteName, siteAbbr, 
							sitePatientLookupable, siteUserAuthenticatable,
							regionStorageId, authenticatedSiteNumber,					
		...
		URL... servers)
	{
	    ...
	    this.siteUserAuthenticatable = siteUserAuthenticatable; 
	    this.siteConnections = siteConnections;
	    this.regionStorageId = null;
	    this.authenticatedSiteNumber = null;
	}
	...
	/* (non-Javadoc)
	 * @see gov.va.med.imaging.exchange.business.Site#getRegionStorageId()
	 */
	@Override
	public String getRegionStorageId()
	{
		return regionStorageId;
	}

	public String getAuthenticatedSiteNumber()
	{
		return authenticatedSiteNumber;
	}
