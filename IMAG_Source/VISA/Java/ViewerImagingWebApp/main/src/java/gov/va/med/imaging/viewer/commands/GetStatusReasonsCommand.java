 ...
 *
 */
public class GetStatusReasonsCommand
extends AbstractViewerImagingCommands<List<ImageAccessReason>, StatusReasonsType>
{
	private String siteNumber;
	private String interfaceVersion;

	public GetStatusReasonsCommand(
			String siteNumber,
			String interfaceVersion)
	{
		super("getStatusReasonsCommand");
	...
	throws MethodException, ConnectionException
	{
		try
		{
			...
			reasonTypes.add(ImageAccessReasonType.changingImageStatus);
	 ...
	 */
	@Override
	public Integer getEntriesReturned(StatusReasonsType translatedResult)
	{
	 ...
	 */
	@Override
	protected Class<StatusReasonsType> getResultClass()
	{
		return StatusReasonsType.class;
	}
	 ...
	 */
	@Override
	protected StatusReasonsType translateRouterResult(List<ImageAccessReason> routerResult)
	throws TranslationException, MethodException
	{
		return ViewerImagingRestTranslator.translateStatusReasons(routerResult);
	}
