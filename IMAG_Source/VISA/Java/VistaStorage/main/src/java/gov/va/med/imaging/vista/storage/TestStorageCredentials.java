 ...
 * @author vhaisltjahjb
 *
 * This class is used only in the unit test
 */

public class TestStorageCredentials 
implements StorageCredentials
{
	...
	public TestStorageCredentials(String siteNumber, String username, String password)
	{
