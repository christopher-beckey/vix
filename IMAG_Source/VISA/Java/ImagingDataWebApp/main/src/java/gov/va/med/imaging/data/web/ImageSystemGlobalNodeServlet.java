 ...
 * http://localhost:8080/ImagingDisplayWebApp/image/globalnodes?studyUrn=urn:vastudy:050-5391-7&siteNumber=050&accessCode=boating3&verifyCode=boating3..
 */
public class ImageSystemGlobalNodeServlet
extends HttpServlet
{
	private static final long serialVersionUID = -5069787811096261240L;
	private final static Logger logger = Logger.getLogger(ImageSystemGlobalNodeServlet.class);
	...
	throws ServletException, IOException
	{
		...
		{	
			...
			String result = router.getImageSystemGlobalNode(urn);
			
			response.setStatus(HttpServletResponse.SC_OK);
			response.setContentType("text/xml");
			PrintWriter writer = response.getWriter();
			writer.write("<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>");
			writer.write("<getImageSystemGlobalNode-response>");
