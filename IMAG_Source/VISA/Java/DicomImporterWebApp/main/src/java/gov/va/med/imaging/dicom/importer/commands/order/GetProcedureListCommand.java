 ...
 *
 */
public class GetProcedureListCommand 
extends AbstractDicomImporterCommand<List<Procedure>, String>
{
	...
	public GetProcedureListCommand(String siteId, String imagingLocationIen, String procedureIen, String interfaceVersion)
	{
	...
	@Override
	protected List<Procedure> executeRouterCommand() 
	throws MethodException, ConnectionException 
	{
		DicomImporterRouter router = getRouter();		
		List<Procedure> result = router.getProcedureList(siteId, imagingLocationIen, procedureIen);
	...
	@Override
	protected String translateRouterResult(List<Procedure> routerResult) 
	throws TranslationException 
	{
		XStream xstream = ImporterUtils.getXStream();
		xstream.alias("ArrayOfProcedure", List.class);
