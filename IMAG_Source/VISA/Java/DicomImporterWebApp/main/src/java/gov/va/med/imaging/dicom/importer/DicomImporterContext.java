 ...
 *
 */
public class DicomImporterContext 
implements ApplicationContextAware 
{
	private static final Logger LOGGER = Logger.getLogger(DicomImporterContext.class);
	...
	private static DicomImporterContext imagingContext;

	public static DicomImporterRouter getRouter()
	{
		DicomImporterRouter router = null;
		TransactionContext transactionContext = TransactionContextFactory.get();
		try
		{
			router = FacadeRouterUtility.getFacadeRouter(DicomImporterRouter.class);
		} 
		catch (Exception x)
		{
			String msg = "DicomImporterContext.getRouter() --> Error getting DicomImporterRouter instance: " + x.getMessage();			 
	...
	private static void initializeImagingContext()
	{
		...
		{
			imagingContext = new DicomImporterContext();
		}		
	}
