 ...
 */
package gov.va.med.imaging.dicom.importer.commands;
 ...
 *
 */
public class IsImporterVersionCompatibleCommand 
extends AbstractDicomImporterCommand<String, String>
{
	private final String interfaceVersion;
	
	public IsImporterVersionCompatibleCommand(String interfaceVersion)
	{
		super("IsImporterVersionCompatibleCommand");
	...
	throws MethodException, ConnectionException 
	{
		...
		String result = router.getImporterVersionCompatible(getLocalRoutingToken());
