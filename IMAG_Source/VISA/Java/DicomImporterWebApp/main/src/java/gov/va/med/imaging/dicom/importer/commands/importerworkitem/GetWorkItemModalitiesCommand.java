 ...
 *
 */
public class GetWorkItemModalitiesCommand 
extends AbstractDicomImporterCommand<List<ImporterFilter>, String>
{
	private static Logger logger = LogManager.getLogger(GetWorkItemModalitiesCommand.class);

	private final String interfaceVersion;
	
	public GetWorkItemModalitiesCommand(String interfaceVersion)
	{
		super("getWorkItemModalitiesCommand");
			...
			throws MethodException, ConnectionException 
	{
		...
		List<ImporterFilter> modalities = router.getWorkItemModalities();
		setEntriesReturned(modalities.size());
		return modalities;
	}
	...
	@Override
	protected String translateRouterResult(List<ImporterFilter> modalities) 
	throws TranslationException 
	{
    	...
    	return xstream.toXML(modalities);
	}
