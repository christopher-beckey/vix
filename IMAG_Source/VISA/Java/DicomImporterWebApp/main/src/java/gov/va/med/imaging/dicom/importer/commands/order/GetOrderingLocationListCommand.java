 ...
 *
 */
public class GetOrderingLocationListCommand 
extends AbstractDicomImporterCommand<List<OrderingLocation>, String>
{
	private final String interfaceVersion;
	private final String siteId;
	
	public GetOrderingLocationListCommand(String siteId, String interfaceVersion)
	{
	...
	@Override
	protected List<OrderingLocation> executeRouterCommand() 
	throws MethodException, ConnectionException 
	{
		DicomImporterRouter router = getRouter();		
		List<OrderingLocation> result = router.getOrderingLocationList(siteId);
	...
	@Override
	protected String translateRouterResult(List<OrderingLocation> routerResult) 
	throws TranslationException 
	{
		XStream xstream = ImporterUtils.getXStream();
		xstream.alias("ArrayOfOrderingLocation", List.class);
