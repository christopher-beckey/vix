 ...
 *
 */
public class GetWorkItemSourcesCommand 
extends AbstractDicomImporterCommand<List<ImporterFilter>, String>
{
	private static Logger logger = LogManager.getLogger(GetWorkItemSourcesCommand.class);

	private final String interfaceVersion;
	
	public GetWorkItemSourcesCommand(String interfaceVersion)
	{
		super("getWorkItemSourcesCommand");
	...
	throws MethodException, ConnectionException 
	{
		...
		List<ImporterFilter> sources = router.getWorkItemSources();
		setEntriesReturned(sources.size());
		return sources;
	}
	...
	@Override
	protected String translateRouterResult(List<ImporterFilter> sources) 
