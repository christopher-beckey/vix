 ...
 *
 */
public abstract class AbstractDicomImporterCommand<D, E extends Object>
extends AbstractWebserviceCommand<D, E>
{
	...
	public AbstractDicomImporterCommand(String methodName)
	{
		super(methodName);
	}
	...
	{
		return DicomImporterContext.getRouter();
	}
	...
	{
    	return ImporterUtils.getXStream();
