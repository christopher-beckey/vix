...
public interface TransactionContextHttpHeaders
{
	...
	public final static String httpHeaderCacheFilename = "xxx-filename";
	...
	public final static String httpHeaderStorageSiteNumber = "xxx-storageSiteNumber";
	public final static String httpHeaderStorageUsername = "xxx-storageUsername";
	public final static String httpHeaderStorageKey = "xxx-storagePassword";
