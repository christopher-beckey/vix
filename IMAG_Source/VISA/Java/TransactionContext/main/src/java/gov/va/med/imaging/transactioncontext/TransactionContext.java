...
extends Principal
{
	...
	/**
	 * The Cached image Filename received by the data source before any image conversion is done
	 * @return
	 */
	...
	/**
	 * One of the Credentials requires to access image file 
	 */
	...
	/**
	 * Is this a viewer process? 
	 */
	public Boolean isViewerProcess();
	public void setViewerProcess(Boolean viewerProcess);

	
	/**
	 * viewer http servlet request method (POST/GET/HEAD/etc) 
	 */
	public String getHttpServletRequestMethod();
	public void setHttpServletRequestMethod(String httpServletRequestMethod);

	/**
	 * Is this a viewer head request? 
	 */
	public Boolean isViewerHeadRequest();
	public void setViewerHeadRequest(Boolean viewerHeadRequest);

	/**
	 * Get/set the name of the application used when generating an "Internal" security token
	 * @return
	 */
