...
implements TransactionContext
{
   ...
   public void setVixSoftwareVersion(String vixSoftwareVersion)
   {
	...
	public void setViewerProcess(Boolean viewerProcess) {
		this.viewerProcess = viewerProcess;
	}

	@Override
	public String getHttpServletRequestMethod() {
		return this.httpServletRequestMethod;
	}
