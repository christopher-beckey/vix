...
implements ImageAnnotationDataSourceSpi
{
	...
	throws MethodException, ConnectionException
	{
        ...
        logger.info("getImageAnnotations ({}) TransactionContext ({}).", imagingUrn.toString(), TransactionContextFactory.get().getDisplayIdentity());
		VistaSession localVistaSession = null;
		try 
		{
			localVistaSession = getVistaSession();
	...
	throws MethodException, ConnectionException
	{
        ...
        logger.info("getAnnotationDetails ({}), ({}) TransactionContext ({}).", imagingUrn.toString(), imageAnnotationUrn.toString(), TransactionContextFactory.get().getDisplayIdentity());
		VistaSession localVistaSession = null;
		try 
		{
			localVistaSession = getVistaSession();
	...
	throws MethodException, ConnectionException
	{
        ...
        logger.info("storeImageAnnotationDetails ({}) TransactionContext ({}).", imagingUrn.toString(), TransactionContextFactory.get().getDisplayIdentity());
		VistaSession localVistaSession = null;
		try 
		{
			localVistaSession = getVistaSession();
	...
	throws MethodException, ConnectionException
	{
        ...
        logger.info("getMostRecentAnnotationDetails ({}) TransactionContext ({}).", imagingUrn.toString(), TransactionContextFactory.get().getDisplayIdentity());
		VistaSession localVistaSession = null;
		try 
		{
			localVistaSession = getVistaSession();
