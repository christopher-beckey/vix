...
extends PersistentGroupSet
{
	...
	throws CacheException
	{
		...
		{
			// Fortify change: added codes to normalize 'name' for line 110
			String name = FilenameUtils.normalize(childDir.getName());		// the file name and the Instance name are the same
