...
import gov.va.med.imaging.cache.ImagingCacheManagementServiceImpl;
...
extends HttpMethodHackServlet 
{
	...
	throws ServletException, IOException 
	{
		...
		response.getWriter().write(StringEscapeUtils.escapeHtml(CacheManagementService.buildQueryString(cacheItemPath.createParentPath())));
	}
