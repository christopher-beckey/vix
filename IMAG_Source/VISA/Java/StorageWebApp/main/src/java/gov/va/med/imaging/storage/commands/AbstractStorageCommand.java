...
import gov.va.med.imaging.storage.StorageContext;
 ...
 *
 */
public abstract class AbstractStorageCommand<D, E extends Object>
extends AbstractWebserviceCommand<D, E>
{
	...
	public AbstractStorageCommand(String methodName)
	{
		super(methodName);
	}
	...
	@Override
	protected StorageRouter getRouter() {
		return StorageContext.getRouter();
	}
