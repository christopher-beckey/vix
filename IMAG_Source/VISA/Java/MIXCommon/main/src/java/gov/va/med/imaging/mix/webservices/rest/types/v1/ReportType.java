...
public class ReportType  implements java.io.Serializable {
    ...
    private gov.va.med.imaging.mix.webservices.rest.types.v1.ReportTypeProcedureCodes procedureCodes;
    ...
    public ReportType(
           ...
           gov.va.med.imaging.mix.webservices.rest.types.v1.ReportTypeProcedureCodes procedureCodes,
     ...
     */
    public gov.va.med.imaging.mix.webservices.rest.types.v1.ReportTypeProcedureCodes getProcedureCodes() {
        return procedureCodes;
    }
     ...
     */
    public void setProcedureCodes(gov.va.med.imaging.mix.webservices.rest.types.v1.ReportTypeProcedureCodes procedureCodes) {
        this.procedureCodes = procedureCodes;
    }
