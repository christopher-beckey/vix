...
public class StudyTypeComponentSeries  implements java.io.Serializable {
    private gov.va.med.imaging.mix.webservices.rest.types.v1.SeriesType[] series;
     ...
     * @return series
     */
    public gov.va.med.imaging.mix.webservices.rest.types.v1.SeriesType[] getSeries() {
        return series;
    }
     ...
     * @param series
     */
    public void setSeries(gov.va.med.imaging.mix.webservices.rest.types.v1.SeriesType[] series) {
        this.series = series;
    }

    public gov.va.med.imaging.mix.webservices.rest.types.v1.SeriesType getSeries(int i) {
        return this.series[i];
    }

    public void setSeries(int i, gov.va.med.imaging.mix.webservices.rest.types.v1.SeriesType _value) {
