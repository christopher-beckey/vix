...
public class ReportStudyListResponseType  implements java.io.Serializable {
    private boolean partialResponse;

    private gov.va.med.imaging.mix.webservices.rest.types.v1.StudyType[] studies;

    private gov.va.med.imaging.mix.webservices.rest.types.v1.ErrorResultType[] errors;

    public ReportStudyListResponseType() {
    }

    public ReportStudyListResponseType(
           boolean partialResponse,
           gov.va.med.imaging.mix.webservices.rest.types.v1.StudyType[] studies,
           gov.va.med.imaging.mix.webservices.rest.types.v1.ErrorResultType[] errors) {
     ...
     * @return studies
     */
    public gov.va.med.imaging.mix.webservices.rest.types.v1.StudyType[] getStudies() {
        return studies;
    }
     ...
     * @param studies
     */
    public void setStudies(gov.va.med.imaging.mix.webservices.rest.types.v1.StudyType[] studies) {
        this.studies = studies;
    }

    public gov.va.med.imaging.mix.webservices.rest.types.v1.StudyType getStudies(int i) {
        return this.studies[i];
    }

    public void setStudies(int i, gov.va.med.imaging.mix.webservices.rest.types.v1.StudyType _value) {
     ...
     * @return errors
     */
    public gov.va.med.imaging.mix.webservices.rest.types.v1.ErrorResultType[] getErrors() {
        return errors;
    }
     ...
     * @param errors
     */
    public void setErrors(gov.va.med.imaging.mix.webservices.rest.types.v1.ErrorResultType[] errors) {
        this.errors = errors;
    }

    public gov.va.med.imaging.mix.webservices.rest.types.v1.ErrorResultType getErrors(int i) {
        return this.errors[i];
    }

    public void setErrors(int i, gov.va.med.imaging.mix.webservices.rest.types.v1.ErrorResultType _value) {
        this.errors[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ReportStudyListResponseType)) return false;
        ReportStudyListResponseType other = (ReportStudyListResponseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ReportStudyListResponseType.class, true);
