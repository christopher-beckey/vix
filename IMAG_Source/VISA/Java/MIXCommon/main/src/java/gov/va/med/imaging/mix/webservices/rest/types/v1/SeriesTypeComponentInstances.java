...
public class SeriesTypeComponentInstances  implements java.io.Serializable {
    private gov.va.med.imaging.mix.webservices.rest.types.v1.InstanceType[] instance;
     ...
     * @return instance
     */
    public gov.va.med.imaging.mix.webservices.rest.types.v1.InstanceType[] getInstance() {
        return instance;
    }
     ...
     * @param instance
     */
    public void setInstance(gov.va.med.imaging.mix.webservices.rest.types.v1.InstanceType[] instance) {
        this.instance = instance;
    }

    public gov.va.med.imaging.mix.webservices.rest.types.v1.InstanceType getInstance(int i) {
        return this.instance[i];
    }

    public void setInstance(int i, gov.va.med.imaging.mix.webservices.rest.types.v1.InstanceType _value) {
