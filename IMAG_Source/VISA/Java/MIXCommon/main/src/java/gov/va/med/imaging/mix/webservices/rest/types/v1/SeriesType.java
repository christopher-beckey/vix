...
public class SeriesType  implements java.io.Serializable {
    ...
    private gov.va.med.imaging.mix.webservices.rest.types.v1.SeriesTypeComponentInstances componentInstances;
    ...
    public SeriesType(
           ...
           int imageCount,
           gov.va.med.imaging.mix.webservices.rest.types.v1.SeriesTypeComponentInstances componentInstances) {
     ...
     */
    public gov.va.med.imaging.mix.webservices.rest.types.v1.SeriesTypeComponentInstances getComponentInstances() {
        return componentInstances;
    }
     ...
     */
    public void setComponentInstances(gov.va.med.imaging.mix.webservices.rest.types.v1.SeriesTypeComponentInstances componentInstances) {
        this.componentInstances = componentInstances;
    }
