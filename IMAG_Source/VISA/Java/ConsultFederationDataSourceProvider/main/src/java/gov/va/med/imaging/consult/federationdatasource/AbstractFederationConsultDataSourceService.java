package gov.va.med.imaging.consult.federationdatasource;
...
public abstract class AbstractFederationConsultDataSourceService 
...
implements ConsultDataSourceSpi {
	...
	private final static Logger logger = Logger.getLogger(AbstractFederationConsultDataSourceService.class);
	
	public abstract String getDataSourceVersion();
	protected final VftpConnection federationConnection;

	public AbstractFederationConsultDataSourceService(ResolvedArtifactSource resolvedArtifactSource, String protocol) {
	...
	public List<Consult> getPatientConsults(RoutingToken globalRoutingToken, PatientIdentifier patientIdentifier)
		...
		throw new UnsupportedServiceMethodException(ConsultDataSourceSpi.class, "getPatientConsults");
	}
