 ...
 *
 */
public abstract class AbstractExchangeWebserviceCommand<D, E extends Object>
extends AbstractWebserviceCommand<D, E>
{
	public AbstractExchangeWebserviceCommand(String methodName)
	{
		super(methodName);
	}

	@Override
	protected ExchangeRouter getRouter()
	{
		return ImagingExchangeContext.getExchangeRouter();
	}
	...
	public E executeExchangeCommand() 
