...
extends VistaImagingStudyGraphDataSourceService
{
	...
	@Override
	protected VistaQuery getPatientGroupsVistaQuery(VistaSession vistaSession, String patientDfn,
	...
	throws IOException, InvalidVistaCredentialsException, VistaMethodException
	{
		...
		return VistaImagingCommonUtilities.createMagImageListQuery(vistaSession, patientDfn, studyFilter, false);
	}
