...
{	
	...
	throws InvalidVistaCredentialsException, VistaMethodException, IOException
	{
        ...
        getLogger().info("RPC call complete, received '{}' bytes", vistaResponse.length());
	...
	@Override
	public List<WorkItem> getRemoteWorkItemListFromDataSource(RoutingToken globalRoutingToken, String idType,
			String patientId, String cptCode) throws MethodException, ConnectionException {
		return null;
	}
