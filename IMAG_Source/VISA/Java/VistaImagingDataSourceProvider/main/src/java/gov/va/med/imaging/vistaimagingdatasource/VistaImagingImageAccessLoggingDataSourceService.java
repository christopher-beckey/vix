...
implements ImageAccessLoggingSpi 
{
	...
	throws UnsupportedOperationException, MethodException, ConnectionException 
	{
        ...
        logger.info("LogImageAccessEvent({}), TransactionContext ({}).", logEvent.getImageIen(), TransactionContextFactory.get().getDisplayIdentity());
	...
	{
        logger.info("logImagePrint({}), TransactionContext ({}).", event.getImageIen(), TransactionContextFactory.get().getDisplayIdentity());
	...
	throws MethodException, IOException, ConnectionException 
	{
        logger.info("logImageCopy({}), TransactionContext ({}).", event.getImageIen(), TransactionContextFactory.get().getDisplayIdentity());
	...
	throws MethodException, IOException, ConnectionException 
	{
        logger.info("logPatientIdMismatch({}), TransactionContext ({}).", event.getImageIen(), TransactionContextFactory.get().getDisplayIdentity());
	...
	throws MethodException, IOException, ConnectionException 
	{
        logger.info("LogImageAccess({}:Base32{{}}), TransactionContext ({}).", event.getDecodedImageIen(), event.getImageIen(), TransactionContextFactory.get().getDisplayIdentity());
	...
	throws MethodException, ConnectionException
	{
        ...
        logger.info("LogImagingLogEvent({}), TransactionContext ({}).", logEvent.toString(), TransactionContextFactory.get().getDisplayIdentity());
		VistaSession vistaSession = null;
		try 
		{
			vistaSession = getVistaSession();
