...
//	private Logger logger = Logger.getLogger(this.getClass());
	...
	throws MethodException, ConnectionException {
		VistaCommonUtilities.setDataSourceMethodAndVersion("updateWorkItemService", getDataSourceVersion());
		WorkItemDAO dao = new WorkItemDAO(this);
		return dao.updateWorkItemService(service, modality, procedure, newService);
	}
	...
	@Override
	public  List<StorageCommitWorkItem> listSCWorkItems(SCWorkItemQueryParameters queryParams) throws MethodException, ConnectionException 
	{
		SCWorkItemDAO dao = new SCWorkItemDAO(this);
		return dao.findByCriteria(queryParams);
	}
