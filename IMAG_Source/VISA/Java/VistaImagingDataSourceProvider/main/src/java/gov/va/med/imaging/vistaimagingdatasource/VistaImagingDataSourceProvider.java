	...
	private VistaImagingDataSourceProvider(String name, double version, String info)
	{
		...
		services.add(
				new ProviderService(
					this, 
					StudyGraphDataSourceSpi.class,
					VistaImagingStudyGraphDataSourceServiceV3.SUPPORTED_PROTOCOL,
					4.0F,
					VistaImagingStudyGraphDataSourceServiceV3.class)
			);
		services.add(
			new ProviderService(
				this, 
		...
		*/
		...
		services.add(
			new ProviderService(
				...
				AbstractBaseVistaImagingExternalPackageDataSourceService.SUPPORTED_PROTOCOL,
				3.0F,
				VistaImagingExternalPackageDataSourceServiceV3.class)
			);			
		services.add(
			new ProviderService(
				this, 
				...
				AbstractBaseVistaImagingExternalPackageDataSourceService.SUPPORTED_PROTOCOL,
				4.0F,
				VistaImagingExternalPackageDataSourceServiceV4.class)
			);			
		services.add(
			new ProviderService(
				this, 
				...
				AbstractBaseVistaImagingExternalPackageDataSourceService.SUPPORTED_PROTOCOL,
				5.0F,
				VistaImagingExternalPackageDataSourceServiceV5.class)
			);			
		services.add(
			new ProviderService(
				this, 
				...
				AbstractBaseVistaImagingExternalPackageDataSourceService.SUPPORTED_PROTOCOL,
				6.0F,
				VistaImagingExternalPackageDataSourceServiceV6.class)
			);			
		...
		services.add(
				new ProviderService(
					...
					VistaImagingStudyGraphDataSourceService.SUPPORTED_PROTOCOL,
					4.0F,
					VistaImagingPatientArtifactDataSourceServiceV4.class)
				);
		services.add(
				new ProviderService(
					this,
