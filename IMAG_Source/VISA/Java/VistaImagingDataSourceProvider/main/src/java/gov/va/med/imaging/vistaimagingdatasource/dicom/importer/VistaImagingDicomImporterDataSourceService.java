...
implements DicomImporterDataSourceSpi, VistaSessionFactory
{
	...
	throws MethodException, ConnectionException 
	{
		WorkItemSourceDAO dao = new WorkItemSourceDAO(this);
		return dao.getWorkItemSources();
	}
	...
	throws MethodException, ConnectionException 
	{
		WorkItemModalityDAO dao = new WorkItemModalityDAO(this);
		return dao.getWorkItemModalities();
	}
	...
	throws MethodException, ConnectionException 
	{
		WorkItemProcedureDAO dao = new WorkItemProcedureDAO(this);
		return dao.getWorkItemProcedures();
	}
