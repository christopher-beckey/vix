...
implements RoutingOverrideSpi
{
		...
		SiteResolutionDataSourceSpi siteResolver) throws ConnectionException, MethodException
	{
		...
		if(logger.isDebugEnabled()){logger.debug("VistaDelegateRedirector.resolve(ResolvedArtifactSource,Class<? extends VersionableDataSourceSpi>,Method,Object[],SiteResolutionDataSourceSpi,Resolver) called.");}
