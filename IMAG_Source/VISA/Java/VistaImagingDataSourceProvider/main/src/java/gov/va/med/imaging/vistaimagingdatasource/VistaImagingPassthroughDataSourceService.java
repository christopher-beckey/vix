...
implements PassthroughDataSourceSpi 
{
	...
	throws MethodException, ConnectionException 
	{
        ...
        logger.info("executePassthroughMethod({}) TransactionContext ({}).", method, TransactionContextFactory.get().getTransactionId());
		try
		{
            ...
            logger.info("Received result of '{}' bytes.", rtn == null ? "null" : "" + rtn.length());
