...
implements VistaSessionFactory, StorageDataSourceSpi 
{
	...
	throws MethodException, ConnectionException
	{
		...
		if (dbConfig == null || !dbConfig.isInitialized() || !dbConfig.isValid())
		{
			...
			NetworkLocationInfoDAO networkLocationInfoDAO = new NetworkLocationInfoDAO(this);
			...
			List<NetworkLocationInfo> networkLocations =  networkLocationInfoDAO.findAll();
	
			// Create and initialize the storage configuration
			dbConfig = new StorageServerDatabaseConfiguration();
			dbConfig.initializeConfiguration(providerFactory, artifactDescriptors, retentionPolicies, retentionPolicyProviderMappings, providers, providerAvailabilityTimes, places, networkLocations);
		}
...
//		return clonedConfig;
	...
	@Override
	public List<NetworkLocationInfo> findAllNetworkLocations() 
		throws MethodException, ConnectionException {
		NetworkLocationInfoDAO dao = new NetworkLocationInfoDAO(this);
		return dao.findAll();
	}
