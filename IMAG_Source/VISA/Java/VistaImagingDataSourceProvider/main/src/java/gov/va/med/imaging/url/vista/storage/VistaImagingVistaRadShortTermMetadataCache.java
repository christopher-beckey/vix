...
public class VistaImagingVistaRadShortTermMetadataCache
{
	...
	public void cacheImages(StudyURN studyUrn, ExamImages examImages)
	{
		if(logger.isDebugEnabled()){
            logger.debug("Caching exam images associated with exam '{}' in short term metadata cache.", studyUrn.toString());}
	...
	public void cacheImages(ImageURN imageUrn, ExamImages examImages)
	{
		...
		{
            logger.error("Error creating studyURN from imageURN '{}' to cache exam images, {}", imageUrn.toString(), urnfX.getMessage());
		}		
	}
	...
	public ExamImages getCacheImages(StudyURN studyUrn)
	{
		...
		synchronized (imageListCache)
		{
			...
			{				
				...
				if(logger.isDebugEnabled()){
                    logger.debug("Found '{}' exam images associated with exam '{}'.", images.size(), studyUrn.toString());}
			}
		}
		return images;
	}
	...
	public ExamImages getCacheImages(ImageURN imageUrn)
	{
		...
		{
            logger.error("Error creating studyURN from imageURN '{}' to get cached exam images, {}", imageUrn.toString(), urnfX.getMessage());
			return null;
		}
	}
