...
public class VistaImagingShortTermMetadataCache
{
	...
	public void cacheImages(StudyURN studyUrn, List<Image> images)
	{
		if(logger.isDebugEnabled()){
            logger.debug("Caching images associated with study '{}' in short term metadata cache.", studyUrn.toString());}
	...
	public void cacheImages(ImageURN imageUrn, List<Image> images)
	{
		...
		{
            logger.error("Error creating studyURN from imageURN '{}' to cache images, {}", imageUrn.toString(), urnfX.getMessage());
		}		
	}
	...
	public List<Image> getCacheImages(StudyURN studyUrn)
	{
		...
		synchronized (imageListCache)
		{
			...
			{				
				...
				if(logger.isDebugEnabled()){
                    logger.debug("Found '{}' images associated with study '{}'.", images.size(), studyUrn.toString());}
			}
		}
		return images;
	}
	...
	public List<Image> getCacheImages(ImageURN imageUrn)
	{
		...
		{
            logger.error("Error creating studyURN from imageURN '{}' to get cached images, {}", imageUrn.toString(), urnfX.getMessage());
			return null;
		}
	}
