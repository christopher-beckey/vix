 ...
 *
 */
public class TransactionLogEntrySecurityTokenApplicationName
extends TransactionLogEntryElement
{
	...
	{
		return getTransactionLogEntry().getSecurityTokenApplicationName() == null ?
				"" :
				"" + getTransactionLogEntry().getSecurityTokenApplicationName();
	}
