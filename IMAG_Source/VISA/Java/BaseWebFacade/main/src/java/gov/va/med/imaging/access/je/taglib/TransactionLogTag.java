...
extends BodyTagSupport 
{
	...
	private final static Logger LOGGER = Logger.getLogger(TransactionLogTag.class);
	...
	private DatasourceProtocol datasourceProtocol;
	...
	private int requestedRowsPerPage;
	private int actualRowsPerPage = 0;
    ...
    {
    	return this.startDate == null ? null : formatDate(this.startDate);
    }
	public void setStartDateAsString(String startDateAsString)
    {	
		this.startDate = startDateAsString == null ? null : parseDate(startDateAsString);
    }
    ...
    {
    	return this.endDate == null ? null : formatDate(this.endDate);
    }
	public void setEndDateAsString(String endDateAsString)
    {
		this.endDate = endDateAsString == null ? null : parseDate(endDateAsString);
    }
	...
	throws JspException
    {
		...
		{
			String msg = "TransactionLogTag.doStartTag() --> Unable to acquire a reference to the TransactionLogger: " + x.getMessage();
			LOGGER.error (msg);
	    ...
	    if(currentTransactionLogEntry == null)
	    {
	    	if(getEmptyResultMessage() != null)
	    		...
	    		{
                    LOGGER.error("TransactionLogTag.doStartTag() --> Unable to write empty result set message: {}", ioX.getMessage());
	    		}
