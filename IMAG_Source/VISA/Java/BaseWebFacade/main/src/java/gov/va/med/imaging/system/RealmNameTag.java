...
extends TagSupport
{
	...
	private  static final Logger LOGGER = Logger.getLogger(RealmNameTag.class);
	...
	throws JspException
    {
		...
		if(tc != null)
		{
            ...
            {
                LOGGER.error("RealmNameTagdoStartTag() --> Encountered IOException: {}", e.getMessage());
	        	throw new JspException("RealmNameTagdoStartTag() --> Encountered IOException", e);
            }
		}
