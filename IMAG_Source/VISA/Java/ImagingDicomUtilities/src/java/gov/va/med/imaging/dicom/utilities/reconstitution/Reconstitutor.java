...
public class Reconstitutor {
    ...
    public IDicomDataSet assembleDicomObject(String textFilename,
        ...
        try{
            ...
            //A better design would have the OriginalPixelDataInfo object
    ...
    public byte[] assembleDicomStream(SizedInputStream sizedTextStream, 
        ...
        try ( InputStreamReader inReader = new InputStreamReader(sizedTextStream.getInStream());
            ...
            toolkitDDS = textParser.createDicomDataSet(bufferReader, originalPixelData);
        	...
        	throw new GenericDicomUtilitiesTGAFileException("Failure to assemble Dicom Object. IOException occurred.", ioe);
		}
    }
