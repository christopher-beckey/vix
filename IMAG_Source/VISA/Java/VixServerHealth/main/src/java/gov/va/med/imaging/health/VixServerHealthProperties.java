...
public class VixServerHealthProperties 
{
	...
	public final static String VIX_DICOM_SERVICES_STORE_SCU_AETITLE = "AeTitle";
	public final static String VIX_DICOM_SERVICES_STORE_SCU_SOPCLASS = "SopClass";
	public final static String VIX_DICOM_SERVICES_STORE_SCU_TOTAL_VIX_SEND_TO_AE_FAILURES = "TotalVixSendToAEFailures";
