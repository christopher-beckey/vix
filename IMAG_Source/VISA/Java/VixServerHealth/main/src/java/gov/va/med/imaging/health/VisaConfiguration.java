...
public class VisaConfiguration
{
	...
	private void determineConfiguration(VisaConfigurationType visaConfigurationType, boolean calculateChecksums)
	{
		try {
			...
			logger.error("Error reading lib directory", e);
		}
	}
	...
	private synchronized static File getLibDirectory() throws IOException
	{
		if(libDirectory == null)
		{
			...
			libDirectory = FileUtilities.getFile(tomcatDir + File.separatorChar + "lib");
