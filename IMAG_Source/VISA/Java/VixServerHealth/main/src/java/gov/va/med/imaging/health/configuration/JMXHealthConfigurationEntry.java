...
implements Serializable
{
			...
			boolean listThreadPoolData, boolean listThreadProcessingTime, boolean includeAwiv, boolean includeHdig)
	{
		...
		{
            logger.info("Realm '{}' specified, adding entries to include in health monitor results", realmSiteNumber);
		...
		else
		{
			...
			Hashtable<String, String> VixDicomServicesActivityKeys = new Hashtable<String, String>();
			VixDicomServicesActivityKeys.put( "type", "VixDicomServicesStats" );
			VixDicomServicesActivityKeys.put( "name", "VixSendToAEFailures");
			VixDicomServicesActivityKeys.put("number", "*");
			entries.add(new JMXHealthConfigurationEntry(ImagingMBean.VIX_MBEAN_DOMAIN_NAME, 
					VixServerHealthProperties.VIX_DICOM_SERVICES_STORE_SCU_AETITLE, "AeTitle", 
					VixDicomServicesActivityKeys, true, true));
			entries.add(new JMXHealthConfigurationEntry(ImagingMBean.VIX_MBEAN_DOMAIN_NAME, 
					VixServerHealthProperties.VIX_DICOM_SERVICES_STORE_SCU_SOPCLASS, "SopClass", 
					VixDicomServicesActivityKeys, true, true));
			entries.add(new JMXHealthConfigurationEntry(ImagingMBean.VIX_MBEAN_DOMAIN_NAME, 
					VixServerHealthProperties.VIX_DICOM_SERVICES_STORE_SCU_TOTAL_VIX_SEND_TO_AE_FAILURES, "TotalVixSendToAEFailures", 
					VixDicomServicesActivityKeys, true, true));
