...
public class EncryptionUtils {
	...
	public static String encrypt(String inString)
    {
		...
		// OLD: Random r = new Random();
		// NEW: Creating SecureRandom with the "new" operator is equivalent to SecureRandom.getInstance("SHA1PRNG").
		// Do this way to avoid try/catch with getInstance() method
