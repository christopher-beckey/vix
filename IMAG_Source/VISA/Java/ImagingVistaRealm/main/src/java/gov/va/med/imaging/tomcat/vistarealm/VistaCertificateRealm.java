...
implements Realm, org.apache.catalina.Lifecycle, AbstractVistaRealm, VistaCertificateRealmMBean
{
	...
	{
        logger.info("{} ctor()", VistaCertificateRealm.class.getCanonicalName());
	}
	...
	*/
	...
	//{
	//	return null; //getParentContainerRealm() == null ? null : getParentContainerRealm().getRoles(principal);
	//}
	...
	*/
	...
	public Principal authenticate(X509Certificate certs[])
	{
		...
		{
            logger.debug("User '{}' has been authenticated by X509Certificate.", name);
