 ...
 *
 */
public class LogSensitivePatientAccessCommand 
extends AbstractPatientCommand<Boolean, Boolean>
{
	private final PatientIdentifier patientIdentifier;
	private final String interfaceVersion;
	
	public LogSensitivePatientAccessCommand(PatientIdentifier patientIdentifier,  String interfaceVersion)
	{
	...
	throws MethodException, ConnectionException 
	{
		...
		Boolean result= 
			router.postSensitivePatientAccess(getLocalRoutingToken(), patientIdentifier);
