...
implements ApplicationContextAware
{
	...
	private static Logger logger = Logger.getLogger(PatientContext.class);
	...
	private static PatientContext imagingContext;

	public static PatientRouter getRouter()
	{
		PatientRouter router = null;
		TransactionContext transactionContext = TransactionContextFactory.get();
		try
		{
			router = FacadeRouterUtility.getFacadeRouter(PatientRouter.class);
		}
		catch (Exception x)
		{
			String msg = "Error getting PatientRouter instance.  Application deployment is probably incorrect.";
	...
	private static void initializeImagingContext()
	{
		...
		{
			imagingContext = new PatientContext();
		}
	}
