...
public class BusinessObjectToDicomSCUTranslator {
	...
	private static final String patIdTag = "0010,0020";
...
//	======================================= Query support =======================================
	...
	{
		if(HISChanges == null || HISChanges.isEmpty()){
			return;
		}
		try 
		{
                    ...
                    if (!(tag == null)){
                        ...
                        if(tag2 == null){
                            ...
                            if(value != null){
                            	...
                            	if(tag.equals(patIdTag)){
                            		IDicomElement patientId = dataSet.getDicomElement(patIdTag);
                            		String temp = patientId.getStringValue();
                            		if(temp != null){
                        				String[] formats = StringUtil.split(temp, StringUtil.CARET);
                        				if (formats.length > 1)
                        				{
	                            			if(temp.contains("-")){
	                            				value = formats[1];
                    			...
                    			dataSet.insertDicomElement(tag, tag2, value.trim());
                            }
                        }
                        else{
