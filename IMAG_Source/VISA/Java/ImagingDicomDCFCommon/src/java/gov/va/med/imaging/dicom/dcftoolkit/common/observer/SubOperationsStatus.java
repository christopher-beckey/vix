...
public class SubOperationsStatus {
    ...
    private int subOperationCompleteStatus = 0;
    ...
    private void updateCompleteStatusBasedOnSubOperations(){
    	if(this.subOperationCompleteStatus == SubOperationsStatus.SUCCESS){
    		if(this.getFailedSubOperations() > 0){
    			this.subOperationCompleteStatus = SubOperationsStatus.WARNING;
    		}
    	}
    }
}
