...
//        }
	...
	public double getDecimalValue() {
		...
		try
		{
            ...
            logger.error(dcse.getMessage());
            logger.error("{}: Failure to get decimal value.", this.getClass().getName());
			// log exception
	...
	public int getIntValue() {
		...
		catch (DCSException dcse)
		{
			// log exception
            logger.error(dcse.getMessage());
            logger.error("{}: Failure to get Int value.", this.getClass().getName());
		}
		return intValue;
	}
	...
	public String getStringValue() {
		...
		catch (DCSException dcse)
		{
			// log exception
            logger.error(dcse.getMessage());
            logger.error("{}: Failure to get String value", this.getClass().getName());
		}
		return stringValue;
	}
	...
	public String getSequenceElementStringValue(String seqtag) {
		...
		catch (DCSException dcse)
		{
			// log exception
            logger.error(dcse.getMessage());
            logger.error("{}: Failure to get Sequence Element String value.", this.getClass().getName());
		}
		return stringValue;		
	}
