...
public class MockDicomDataElement implements IDicomElement {
	 ...
	 * @param vr
	 */	
	public MockDicomDataElement(String tagName, int vm, short vr, String stringValue) {
	 ...
	 * @param vr
	 */
	public MockDicomDataElement(String tagName, int vm, short vr, String[] stringValueArray) {
	 ...
	 * @param vr
	 */
	public MockDicomDataElement(String tagName, int vm, short vr, double decimalValue) {
	 ...
	 * @param vr
	 */
	public MockDicomDataElement(String tagName, int vm, short vr, double[] decimalValueArray) {
	 ...
	 * @param vr
	 */
	public MockDicomDataElement(String tagName, int vm, short vr, int intValue) {
	 ...
	 * @param vr
	 */
	public MockDicomDataElement(String tagName, int vm, short vr, int[] intValueArray) {
	 ...
	 * @param vr
	 */	
	public MockDicomDataElement(String tagName, String seqTagName, String seqTagValue) {
	 ...
	 * @param vr
	 */
	public MockDicomDataElement(String tagName, String seqTagName, String[] seqTagValueArray) {
