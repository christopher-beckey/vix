 ...
 *
 */
public class FederationClientLinkTag 
extends AbstractLinkTag
{
	private static final long serialVersionUID = 1L;
	private static final String[] permissableRoles = new String[]{"developer"};
	
	private final static String href = "/Vix/secure/FederationTestClient.jspx";
	private final static String elementBody = "Federation";
	
	private String targetSiteNumber;
	private String siteNumber;
	private String patientId;
	private final static String protocolOverride = "vftp";
