 ...
 *
 */
public class ExchangeVistaRadImageDataSourceServiceV2
extends ExchangeImageDataSourceServiceV2 
implements VistaRadImageDataSourceSpi 
{
     ...
     */
    public static ExchangeVistaRadImageDataSourceServiceV2 create(ResolvedArtifactSource resolvedArtifactSource, String protocol)
    throws ConnectionException, UnsupportedProtocolException
    {
    	return new ExchangeVistaRadImageDataSourceServiceV2(resolvedArtifactSource, protocol);
    }
	
	public ExchangeVistaRadImageDataSourceServiceV2(ResolvedArtifactSource resolvedArtifactSource, String protocol)
	throws UnsupportedProtocolException
	{
