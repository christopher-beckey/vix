 ...
 *
 */
public class AbstractExchangeTest extends TestCase {
	
	public AbstractExchangeTest() 
	{
		super(AbstractExchangeTest.class.toString());
	}
	
	protected Site site;
	
	public AbstractExchangeTest(String name)
	{
		super(name);
