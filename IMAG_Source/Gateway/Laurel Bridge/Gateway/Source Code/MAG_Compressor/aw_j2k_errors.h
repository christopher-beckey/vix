 ...
 *
 * $Workfile: aw_j2k_errors.h $    $Revision: 1 $   
 * Last Modified: $Date: 11/04/10 10:16a $ by: $Author: Admin $
 *
 **********************************************************************/
#ifndef _ERRORS_H_
#define _ERRORS_H_
static const char id_errors_h[] = "@(#) $Header: /Baseline/Source Code/MAG_Compressor/aw_j2k_errors.h 1     11/04/10 10:16a Admin $ Aware Inc.";
