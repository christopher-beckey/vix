...
#define	MIR_IMPLEMENTATIONCLASSUID		"1.2.840.113654.2.3.1995.2.10.2"
#define	MIR_IMPLEMENTATIONVERSIONNAME		"MIRCTN22OCT98"
...
#define	DICOM_SOPCLASSNM			"1.2.840.10008.5.1.4.1.1.5"
#else
...
#define	DICOM_SOPCLASSSTANDALONEPETCURVE	"1.2.840.10008.5.1.4.1.1.129"
	...
	//
#define	DICOM_SOPCLASSVLENDOSCOPY	"1.2.840.10008.5.1.4.1.1.77.1.1"
#define DICOM_SOPCLASSVLMICROSCOPY	"1.2.840.10008.5.1.4.1.1.77.1.2"
#define DICOM_SOPCLASSVLSLIDECOORDS	"1.2.840.10008.5.1.4.1.1.77.1.3"
#define DICOM_SOPCLASSVLPHOTO		"1.2.840.10008.5.1.4.1.1.77.1.4"
	//
	// Digital X-Ray SOP Classes
	//
#define	DICOM_SOPCLASSDXPRESENT		 "1.2.840.10008.5.1.4.1.1.1.1"
#define	DICOM_SOPCLASSDXPROCESS		 "1.2.840.10008.5.1.4.1.1.1.1.1"
#define	DICOM_SOPCLASSDXMAMMOPRES	 "1.2.840.10008.5.1.4.1.1.1.2"
#define	DICOM_SOPCLASSDXMAMMOPROC	 "1.2.840.10008.5.1.4.1.1.1.2.1"
#define	DICOM_SOPCLASSDXORALPRES	 "1.2.840.10008.5.1.4.1.1.1.3"
#define	DICOM_SOPCLASSDXORALPROC	 "1.2.840.10008.5.1.4.1.1.1.3.1"
