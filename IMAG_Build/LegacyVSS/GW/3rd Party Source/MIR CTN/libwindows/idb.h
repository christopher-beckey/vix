...
#define	IDB_PN_QLENGTH	(DICOM_PN_LENGTH*2)
...
CONDITION CBDel_CollectStudies(TBL_FIELD * field, long count, void *ctx);
CONDITION CBDel_CollectSeries(TBL_FIELD * field, long count, void *ctx);
CONDITION CBDel_CollectImages(TBL_FIELD * field, long count, void *ctx);

CONDITION CBIns_CollectInstances(TBL_FIELD * field, long count, void *ctx);

void IDB_DestroyGlobalLists(void);

CONDITION CBSel_CollectPatients(TBL_FIELD * fp, long count, void *ctx);
CONDITION CBSel_CollectStudies(TBL_FIELD * fp, long count, void *ctx);
CONDITION CBSel_CollectPatientsStudies(TBL_FIELD * fp, long count, void *ctx);
CONDITION CBSel_CollectSeries(TBL_FIELD * fp, long count, void *ctx);
CONDITION CBSel_CollectImages(TBL_FIELD * fp, long count, void *ctx);
CONDITION CBSel_CollectInstances(TBL_FIELD * fp, long count, void *ctx);
