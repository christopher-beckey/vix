...
static char rcsid[] = "$Revision: 1 $ $RCSfile: tbl_sqlserver.c,v $";
						  ...
						  const TBL_FIELD *fp)
{
  ...
  case TBL_FLOAT8:
	  ...
	  break;
  case TBL_STRING:
	  sprintf(temp, "%s \'%s\' ", punctuation, fp->Value.Value.String);
	  break;
