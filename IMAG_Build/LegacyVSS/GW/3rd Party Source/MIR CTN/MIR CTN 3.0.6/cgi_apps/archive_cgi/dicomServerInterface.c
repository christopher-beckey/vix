...
** Author, Date:
** Intent:
** Last Update:		$Author: Vhaiswstarkm $, $Date: 11/04/10 9:27a $
** Source File:		$Source: /sw2/prj/ctn/cvs/cgi_apps/archive_cgi/dicomServerInterface.c,v $
** Revision:		$Revision: 1 $
** Status:		$State: Exp $
*/

static char rcsid[] = "$Revision: 1 $ $RCSfile: dicomServerInterface.c,v $";
