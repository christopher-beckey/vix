...
CONDITION
DMAN_Open(char *databaseName, char *requestingTitle,
	  char *respondingTitle, DMAN_HANDLE ** handle);
CONDITION DMAN_Close(DMAN_HANDLE ** handle);
CONDITION
...
CONDITION DMAN_Insert(DMAN_HANDLE ** handle, DMAN_GENERICRECORD * workRecord);
CONDITION DMAN_Delete(DMAN_HANDLE ** handle, DMAN_GENERICRECORD * workRecord);
/*CONDITION
DMAN_Set(DMAN_HANDLE ** handle, DMAN_GENERICRECORD * workRecord,
	 DMAN_CRITERIA criteria, DMAN_GENERICRECORD * criteriaRecord);
*/

/* Define a higher level of functions that provide specific services
** for the application.
*/

CONDITION
DMAN_LookupApplication(DMAN_HANDLE ** handle, char *title,
...
DMAN_ApplicationAccess(DMAN_HANDLE ** handle, const char *requestingTitle,
		       const char *respondingTitle, CTNBOOLEAN * accessFlag);
CONDITION
DMAN_LookupStorage(DMAN_HANDLE ** handle, char *applicationTitle,
...
DMAN_VerifyPrintServerCFG(DMAN_HANDLE ** handle, char *requestingTitle,
		  char *respondingTitle, int gqID, CTNBOOLEAN * accessFlag);
CONDITION
DMAN_LookupFISAccess(DMAN_HANDLE ** handle, char *applicationTitle,
		     DMAN_FISACCESS * fis);
CONDITION
...
char *DMAN_Message(CONDITION condition);
