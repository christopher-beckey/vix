...
// Missing UIDs (with 2004 standard):
#define DEFLATEDEXPLICITVRLITTLEENDIAN		"1.2.840.10008.1.2.1.99"
#define JPEGLSLOSSLESSIMAGECOMPRESSION		"1.2.840.10008.1.2.4.80"
#define JPEGLSLOSSYNEARLOSSLESSIMAGECOMPRESSION	"1.2.840.10008.1.2.4.81"
#define RLELOSSLESS				"1.2.840.10008.1.2.5"
#define MEDIASTORAGEDIRECTORYSTORAGE		"1.2.840.10008.1.3.10"
#define MODALITYPERFORMEDPROCEDURESTEPRETRIEVE	"1.2.840.10008.3.1.2.3.4"
#define MODALITYPERFORMEDPROCEDURESTEPNOTIFICATION	"1.2.840.10008.3.1.2.3.5"
#define PRINTERCONFIGURATIONRETRIEVAL		"1.2.840.10008.5.1.1.16.376"
#define PRINTERCONFIGURATIONRETRIEVALSOPINSTANCE	"1.2.840.10008.5.1.1.17.376"
#define PRESENTATIONLUT				"1.2.840.10008.5.1.1.23"
#define BASICPRINTIMAGEOVERLAYBOX		"1.2.840.10008.5.1.1.24.1"
#define PRINTQUEUESOPINSTANCE			"1.2.840.10008.5.1.1.25"
#define PRINTQUEUEMANAGEMENT			"1.2.840.10008.5.1.1.26"
#define PULLPRINTREQUEST			"1.2.840.10008.5.1.1.31"
#define PULLSTOREDPRINTMANAGEMENTMETA		"1.2.840.10008.5.1.1.32"
...
#define VLIMAGESTORAGERETIRED			"1.2.840.10008.5.1.4.1.1.77.1"
#define VLMULTIFRAMEIMAGESTORAGERETIRED		"1.2.840.10008.5.1.4.1.1.77.2"
#define MAMMOGRAPHYCADSR			"1.2.840.10008.5.1.4.1.1.88.50"
...
#define CARDIOLOGYELECTROPHYSIOLOGYWAVEFORMSTORAGE	"1.2.840.10008.5.1.4.1.1.9.3.1"
#define BASICVOICEAUDIOWAVEFORMSTORAGE		"1.2.840.10008.5.1.4.1.1.9.4.1"
#define GENERALPURPOSEWORKLISTMANAGEMENTMETA	"1.2.840.10008.5.1.4.32"
