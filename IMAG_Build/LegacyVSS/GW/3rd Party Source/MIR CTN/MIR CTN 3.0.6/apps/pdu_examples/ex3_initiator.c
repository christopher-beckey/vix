...
**			requests one SOP Class with multiple presentation
**			contexts, each presentation context requesting a
**			different transfer syntax.
**  Usage:
**	ex3_initiator node port
**
** Last Update:		$Author: Vhaiswstarkm $, $Date: 11/04/10 9:24a $
** Source File:		$RCSfile: ex3_initiator.c,v $
** Revision:		$Revision: 1 $
** Status:		$State: Exp $
*/

static char rcsid[] = "$Revision: 1 $ $RCSfile: ex3_initiator.c,v $";
...
{
    char msg[] = "\
    ex3_initiator [-c callingTitle][-d FAC][-m maxPDU][-t title][-v] node port\n\
    \n\
