...
static SOPCLASSPERMITTEDSRV classPermittedSrvTable[] = {
    ...
    /* Even more storage SOP Classes (2004) */
    { MULTIFRAMESINGLEBITSECONDARYCAPTUREIMAGESTORAGE, storageSOPClass, 2 },
    { MULTIFRAMEGRAYSCALEBYTESECONDARYCAPTUREIMAGESTORAGE, storageSOPClass, 2 },
    { MULTIFRAMEGRAYSCALEWORDSECONDARYCAPTUREIMAGESTORAGE, storageSOPClass, 2 },
    { MULTIFRAMETRUECOLORSECONDARYCAPTUREIMAGESTORAGE, storageSOPClass, 2 },
    { VLIMAGESTORAGERETIRED, storageSOPClass, 2 },
    { VLMULTIFRAMEIMAGESTORAGERETIRED, storageSOPClass, 2 },
    { GENERALECGWAVEFORMSTORAGE, storageSOPClass, 2 },
    { AMBULATORYECGWAVEFORMSTORAGE, storageSOPClass, 2 },
    { HEMODYNAMICWAVEFORMSTORAGE, storageSOPClass, 2 },
    { CARDIOLOGYELECTROPHYSIOLOGYWAVEFORMSTORAGE, storageSOPClass, 2 },
    { BASICVOICEAUDIOWAVEFORMSTORAGE, storageSOPClass, 2 },
    ...
    DIM_OF(mppsSOPClass)},
    {DICOM_SOPGPWORKLIST_FIND, generalCFindSOPClass,
    DIM_OF(generalCFindSOPClass)},
