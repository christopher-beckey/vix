...
** Source File:		$Source: /home/smm/ctn/ctn/facilities/messages/msgsupport.c,v $
** Revision:		$Revision: 1 $
** Status:		$State: Exp $
*/

static char rcsid[] = "$Revision: 1 $ $RCSfile: msgsupport.c,v $";
...
CONDITION
MSGPRV_BuildObject(DCM_OBJECT ** object,
		   DCM_ELEMENT * required, int requiredCount,
		   DCM_FLAGGED_ELEMENT * conditional, int conditionalCount)
{
    int
        index;
    CONDITION
    ...
    cond = DCM_ModifyElements(object, required, requiredCount,
