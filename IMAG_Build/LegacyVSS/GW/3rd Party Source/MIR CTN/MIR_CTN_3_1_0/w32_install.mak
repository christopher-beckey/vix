...
directories:
	scripts\createdirectory $(CTN_TARGET)
	scripts\createdirectory $(CTN_TARGET)\bin
	scripts\createdirectory $(CTN_TARGET)\lib
	scripts\createdirectory $(CTN_TARGET)\runtime
	scripts\createdirectory $(CTN_TARGET)\ctn_install
...
library_r:
	...
	copy Release\ctn_lib.lib $(CTN_TARGET)\lib
	cd ..\..
...
java_r:
	...
	copy Release\javactn.dll C:\usr\mesa\ctn\bin
	cd ..\..
...
runtime_x:
	cd runtime
	copy ctn_cfg.txt C:\usr\mesa\ctn\runtime
	cd ..
