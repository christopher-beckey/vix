...
** Intent:		Test program for Sybase TBL Delete functions
** Last Update:		$Author: Vhaiswstarkm $, $Date: 3/28/11 4:39p $
** Source File:		$RCSfile: ttdelete.c,v $
** Revision:		$Revision: 1 $
** Status:		$State: Exp $
*/

static char rcsid[] = "$Revision: 1 $ $RCSfile: ttdelete.c,v $";
