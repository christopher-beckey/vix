...
**		Washington University School of Medicine
**
** Module Name(s):	dicom_x_disp.h
** Author, Date:	David E. Beecher, 28-Jun-93
** Intent:		Include file for x-based display program for
**			dicom images.
** Last Update:		$Author: Vhaiswstarkm $, $Date: 3/28/11 4:35p $
** Source File:		$RCSfile: dcm_x_disp.h,v $
** Revision:		$Revision: 1 $
** Status:		$State: Exp $
*/

#ifndef _DCMXDISP_IS_IN
#define _DCMXDISP_IS_IN
...
#define DICOMXDISP		FORM_COND (FAC_APP, SEV_INFORM, 9)
#define DICOMXDISP_NO8BIT	FORM_COND (FAC_APP, SEV_FATAL, 64)

/*
 * Function Prototypes
 */
CONDITION LoadGrayMap(int n);
CONDITION InitializeX(int ncolors);
CONDITION CreateGC(void);
void Refresh(void);
#endif
