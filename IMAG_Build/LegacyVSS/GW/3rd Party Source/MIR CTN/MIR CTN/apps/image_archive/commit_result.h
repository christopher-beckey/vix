...
** Module Name(s):
**
** Author, Date:	Steve Moore, 21-Mar-97
** Intent:
**
** Last Update:		$Author: Vhaiswstarkm $, $Date: 11/04/10 9:10a $
** Source File:		$RCSfile: commit_result.h,v $
** Revision:		$Revision: 1 $
** Status:		$State: Exp $
*/
...
establishCommitResultAssociation(char *transactionUID,
		   DUL_NETWORKKEY ** key, DUL_ASSOCIATIONKEY ** association,
	 DUL_ASSOCIATESERVICEPARAMETERS * params, DMAN_HANDLE ** dmanHandle,
