...
static char rcsid[] = "$Revision: 1 $ $RCSfile: dcm_rm_group.c,v $";
...
main(int argc, char **argv)
{
	...
	* object;
    ...
    cond = DCM_WriteFile(&object, DCM_ORDERLITTLEENDIAN, outputFile);
    if (cond != DCM_NORMAL) {
	COND_DumpConditions();
	THR_Shutdown();
	return (1);
...
{
    char msg[] = "\
Usage: dcm_rm_group [-b] [-t] [-v] filein fileout group [group...]\n\
\n\
