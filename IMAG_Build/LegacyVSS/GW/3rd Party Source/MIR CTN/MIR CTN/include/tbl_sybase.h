...
** Source File:		$RCSfile: tbl_sybase.h,v $
** Revision:		$Revision: 1 $
** Status:		$State: Exp $
*/


#ifndef _TBL_SYBASE_IS_IN
#define _TBL_SYBASE_IS_IN 1
...
static void
    ...
    Add_Criteria_to_Sybuf(DBPROCESS *, const TBL_CRITERIA *),
...
static int
    ...
    syb_msg_handler(DBPROCESS *, DBINT, int, int, char *, char *, char *, int);
