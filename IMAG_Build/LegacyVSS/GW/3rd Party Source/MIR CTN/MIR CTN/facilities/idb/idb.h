...
CONDITION IDB_Delete(IDB_HANDLE ** handle, long level, char *uid, CTNBOOLEAN flag);

CONDITION
IDB_Select(IDB_HANDLE ** handle, IDB_QUERY_MODEL model, long begin_level,
       long end_level, IDB_Query * pssi, long *count, CONDITION(callback()),
	   void *ctx);
CONDITION
...
CONDITION CBDel_CollectStudies(TBL_FIELD * field, int count, void *ctx);
CONDITION CBDel_CollectSeries(TBL_FIELD * field, int count, void *ctx);
CONDITION CBDel_CollectImages(TBL_FIELD * field, int count, void *ctx);

CONDITION CBIns_CollectInstances(TBL_FIELD * field, int count, void *ctx);

void IDB_DestroyGlobalLists(void);

CONDITION CBSel_CollectPatients(TBL_FIELD * fp, int count, void *ctx);
CONDITION CBSel_CollectStudies(TBL_FIELD * fp, int count, void *ctx);
CONDITION CBSel_CollectPatientsStudies(TBL_FIELD * fp, int count, void *ctx);
CONDITION CBSel_CollectSeries(TBL_FIELD * fp, int count, void *ctx);
CONDITION CBSel_CollectImages(TBL_FIELD * fp, int count, void *ctx);
CONDITION CBSel_CollectInstances(TBL_FIELD * fp, int count, void *ctx);
