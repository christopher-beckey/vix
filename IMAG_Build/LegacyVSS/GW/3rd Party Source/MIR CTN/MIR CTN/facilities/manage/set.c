...
static char rcsid[] = "$Revision: 1 $ $RCSfile: set.c,v $";
...
#ifdef SMM
static CONDITION
setAE(TBL_HANDLE ** handle,
      DMAN_APPLICATIONENTITY * workRecord, DMAN_CRITERIA criteria,
	 ...
	 DMAN_CRITERIA criteria, DMAN_GENERICRECORD * criteriaRecord)
{
	...
	* prv;
	...
	cond = setAE(&prv->applicationEntityHandle,
		     (DMAN_APPLICATIONENTITY *) workRecord,
		     criteria, (DMAN_APPLICATIONENTITY *) criteriaRecord);
	break;
