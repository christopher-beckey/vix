...
if(_1&&_1!=this.titleProperty){_4.append("var prop = obj['",_1,"'];","if (isc.isA.Number(prop)) {","if (prop > 0) prop = '1' + prop.stringify(12,true);","else {","prop = 999999999999 + prop;","prop = '0' + prop.stringify(12,true);","}","} else if (isc.isA.Date(prop)) prop = prop.getTime();","if (prop != null) value += prop + ':';")}
...
return _2.toString()}}
,isc.A.getBlockHTML=function isc_DetailViewer_getBlockHTML(_1){if(_1.getLength==null){var _2=[];for(var i=0;i<_1.length;i++){_2[i]=_1[i]}
_1=_2}
var _4=_1.getLength();var _5="<TABLE BORDER=0 CELLSPACING=0 CLASS="+this.blockStyle+" WIDTH="+(this.useInnerWidth&&!this.isPrinting?this.getInnerWidth():"'100%'")+" CELLPADDING="+this.cellPadding+(this.clipValues?" STYLE='table-layout:fixed'":"");_5+=">";var _6=this.fields;for(var _7=0,_8=_6.length;_7<_8;_7++){var _9=_6[_7];if(!_9||_9.hidden||_9.visible==false)continue;if(_9.showIf){if(!isc.isA.Function(_9.showIf)){isc.Func.replaceWithMethod(_9,"showIf","viewer,valueList")}
...
if(!this.$568||(_2==0&&!this.printChunkOnly)){_31.append("<TABLE role='presentation' BORDER=0",_39,((!_13&&!this.isPrinting)?" ID="+this.getTableElementId():null),(this.tableStyle&&isc.Browser.isDOM?" CLASS='"+this.tableStyle+this.$ob:isc.$ad)," CELLSPACING=",this.cellSpacing," CELLPADDING=",this.cellPadding," STYLE='",(isc.Browser.isDOM&&!_38&&this.fixedColumnWidths?"table-layout:fixed;overflow:hidden;wrap:false;":""),(!_30?_37+(this.isRTL()?"-right: ":"-left:")+_34+"px;"+_37+(this.isRTL()?"-left:":"-right:")+_35+"px;":""),(this.cacheDOM&&this.$514>0?"margin-top:"+this.$514+"px;":""),(this.$27y!=null&&!(isc.Browser.isIE&&this.$r9)?"visibility:hidden;":""),"'>",(isc.Browser.isMoz?"<TBODY>":""));var _45=0,_46=0,_47=this.$54p();if(isc.Browser.isStrict&&((isc.Browser.isMoz&&isc.Browser.version>=17)||(isc.Browser.isSafari||isc.Browser.isIE))){if((isc.Browser.isIE&&!isc.Browser.isIE8)||(isc.Browser.isSafari&&isc.Browser.safariVersion<530))
{_46=this.$54q()}
...
);isc.evalBoundary;isc.B.push(isc.A.getCellValue=function isc_GridRenderer_getCellValue(_1,_2,_3){return this.emptyCellValue}
...
);isc.evalBoundary;isc.B.push(isc.A.dragStop=function isc_GridRenderer_dragStop(){this.fireSelectionUpdated()}
...
this.$286.showClickMask(this.$32w,(this.stopOnErrors?isc.EH.SOFT_CANCEL:isc.EH.SOFT),_1)}}
...
,isc.A.updateSorter=function isc_ListGrid_updateSorter(){if(this.destroying||this.destroyed)return;if(!this.sorter||this.sorter.destroying||this.sorter.dsestroyed)return;if(this.$rm||this.$qz){this.delayCall("updateSorter");return}
...
,isc.A.setSort=function isc_ListGrid_setSort(_1){if(this.logIsInfoEnabled("sorting"))this.logInfo("Entering setSort","sorting");if(_1&&!isc.isAn.Array(_1))_1=[_1];if(!this.fields&&!this.getDataSource()){if(this.logIsInfoEnabled("sorting")){this.logInfo("setSort() not performing sort - no fields","sorting")}
return false}
...
return}}
var _2=[],_1=_1||[],_3;if(this.$73p){for(var i=0;i<this.$73p.length;i++){var _5=this.$73p[i],_6=_1.find("property",_5.property);if(!_6){_2.add(isc.shallowClone(_5));if(this.logIsInfoEnabled("sorting")){this.logInfo("In setSort - marking field "+_5.property+" for removal","sorting")}}}}
...
var _7=[];for(var i=0;i<_1.length;i++){var _8=_1[i],_9=this.getUnderlyingField(_8.property),_10=this.getField(_8.property),_11=null;if(!_9){var _12=this.getAllFields();_9=!_12?null:_12.find("displayField",_8.property)}
...
this.removeChild(_1)}
,isc.A.removeChild=function isc_TileLayout_removeChild(_1,_2){this.tiles.removeWhere("ID",_1.ID);if(this.$585){this.$585.removeWhere("ID",_1.ID)}
if(this.$584&&this.$584!=this.$585){this.$584.removeWhere("ID",_1.ID)}
if(this.$586){this.$586.removeWhere("ID",_1.ID)}
this.invokeSuper(isc.TileLayout,"removeChild",_1,_2);this.reLayout()}
...
var _8=_2&&_2.userFormula?_2.userFormula.formulaVars:{};for(var _9 in _8){var _10=_3.find("mappingKey",_9),_11=_3.find("name",_8[_9]),_12=_11?_11.mappingKey:null;if(_12!=null){_11.mappingKey=_10.mappingKey;_10.mappingKey=_12}}
...
,isc.A.fieldIsUsed=function isc_c_FormulaBuilder_fieldIsUsed(_1,_2){if(!_1||!_2)return false;if(this.allowEscapedKeys&&_1.indexOf("#{"+_2+"}")>=0){return true}else{var _3=this.allowEscapedKeys?"#"+_2:_2,_4=new RegExp("(^|[^A-Z]+)"+_3+"($|[^A-Z]+)");if(_4.test(_1))return true}
return false}
,isc.A.getUsedFields=function isc_c_FormulaBuilder_getUsedFields(_1,_2,_3){var _4=this.getAvailableFields(_2,_3),_5=[];if(!_4||!_1)return _5;_4=_4.sortByProperties(["mappingKey"],[false],[function(_8,_9,_10){var _6=_8[_9];if(_6.length==1)_6='  '+_6;else if(_6.length==2)_6=' '+_6;return _6}]);for(var i=0;i<_4.length;i++){var _8=_4.get(i);if(this.fieldIsUsed(_1,_8.mappingKey))_5.add(_8)}
return _5}
,isc.A.getFieldDetailsFromValue=function isc_c_FormulaBuilder_getFieldDetailsFromValue(_1,_2,_3,_4){var _5=isc.shallowClone(_2),_6=this.getFieldIdProperty(_4),_7={usedFields:[],missingFields:[]};for(var _8 in _5){var _9=_5[_8],_10=this.fieldIsUsed(_1,_8),_11=_3.findIndex(_6,_9);if(!_3[_11]){if(!_10){isc.logWarn("Field "+_9+" is not in the list of available fields.  "+"However, it is not used in the formula either - ignoring.");delete _2[_8]}else{isc.logWarn("Field "+_9+" is not in the list of available-fields");_7.missingFields.add(_9)}}else{var _12=isc.addProperties({},_3[_11]);_12.mappingKey=_8;_7.usedFields.add(_12)}}
return _7}
