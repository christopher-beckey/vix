 ...
 * Version v8.2p_2014-06-12 (2014-06-12)
 ...
 */
if(typeof isomorphicDir == 'undefined'){isomorphicDir = 'gov.va.med.imaging.capture.configuration.CaptureImageConfiguration/sc/';}
...
,isc.A.toCurrencyString=function isc_Numbe_toCurrencyString(_1,_2,_3,_4){var _5=this<0,_6=this<0?Math.ceil(this):Math.floor(this),_7=Math.abs(Math.round((this-_6)*100)),_8=isc.StringBuffer.create();_6=Math.abs(_6);if(!isc.isA.String(_1))_1="$";if(!isc.isA.nonemptyString(_2))_2=".";if(_3==null)_3=true;if(_5)_8.append("-");if(_4!=true)_8.append(_1);_8.append(_6.stringify(1));if(_3){_8.append(_2);_8.append(_7.stringify(2))}else if(_7!=0){_8.append(_2);if(_7%10==0)_8.append(_7/ 10);else _8.append(_7.stringify(2))}
if(_4==true)_8.append(_1);return _8.toString()}
...
,isc.A.createLogicalDate=function isc_Date_createLogicalDate(_1,_2,_3,_4){var d=new Date();d.setHours(12,0,0,0);_1=(_1!=null?_1:d.getFullYear());_2=(_2!=null?_2:d.getMonth());_3=(_3!=null?_3:d.getDate());d.setFullYear(_1,_2,_3);if(_4){var _6=(d.getFullYear()==_1&&d.getMonth()==_2&&d.getDate()==_3);if(!_6)return null}
...
return _12}}
,isc.A.getLogicalDateOnly=function isc_Date_getLogicalDateOnly(_1){if(!isc.isA.Date(_1)){isc.logWarn("getLogicalDateOnly() passed invalid value:"+_1+". Returning null.");return null}
...
return this.createLogicalDate(_2,_3,_4)}
,isc.A.getLogicalTimeOnly=function isc_Date_getLogicalTimeOnly(_1){if(!isc.isA.Date(_1)){isc.logWarn("getLogicalTimeOnly() passed invalid value:"+_1+". Returning null.");return null}
...
,isc.A.getJulianDayNumber=function isc_Date_getJulianDayNumber(_1,_2,_3){var y=_1,m=_2+1,d=_3;if(m<=2){--y;m+=12}
var a=parseInt(y/ 100),b=parseInt(a/ 4),c=2-a+b,e=parseInt(365.25*(y+4716)),f=parseInt(30.6001*(m+1))
return c+d+e+f-1524}
,isc.A.$1091=function isc_Date__getWeekdayCounts(){var _1=isc.Date.getWeekendDays();var _2=_1.$1092;if(!_2){var _3={},_4=0;for(var i=0;i<_1.length;++i){if(!_3[_1[i]]){++_4;_3[_1[i]]=true}}
_2=[];for(var d=0;d<=6;++d){var _7=0;var _8=[0];for(var _9=1;_9<7;++_9){if(!_3[(d+_9-1)%7])++_7;_8.push(_7)}
_2[d]=_8}
_2.$1093=_4;_1.$1092=_2}
return _2}
,isc.A.$1094=function isc_Date__getDayDiff(_1,_2,_3,_4){var _5,_6;var _7=isc.Date.compareDates(_1,_2);var _8=(_7>0?1:-1);if(_7>=0){if(_4!==false){_5=isc.Date.getLogicalDateOnly(_1);_6=isc.Date.getLogicalDateOnly(_2)}else{_5=_1;_6=_2}}else{if(_4!==false){_5=isc.Date.getLogicalDateOnly(_2);_6=isc.Date.getLogicalDateOnly(_1)}else{_5=_2;_6=_1}}
var _9=isc.Date.getJulianDayNumber(_5.getFullYear(),_5.getMonth(),_5.getDate()),_10=isc.Date.getJulianDayNumber(_6.getFullYear(),_6.getMonth(),_6.getDate());if(_3){var _11=_10-_9;var _12=isc.Date.$1091();return _8*(parseInt(_11/ 7)*(7-_12.$1093)+_12[_5.getDay()][_11%7])}else{return _8*(_10-_9)}}
...
return _11}
);isc.B._maxIndex=isc.C+35;isc.A=Date.prototype;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$em=[,,,,"/",,,,,"/",,,,null];isc.A.$en="MDY";isc.A.$eo="DMY";isc.A.$ep="YMD";isc.A.$en="MDY";isc.A.$w0="0";isc.A.$68f=[null,null];isc.B.push(isc.A.duplicate=function isc_Dat_duplicate(){var _1=new Date();_1.setTime(this.getTime());_1.logicalDate=this.logicalDate;_1.logicalTime=this.logicalTime;return _1}
...
,isc.A.parseInput=function isc_c_Time_parseInput(_1,_2,_3,_4,_5){var _6=null,_7=null,_8=null,_9=null,_10;var _11,_12;if(isc.isA.Date(_1)){_3=true;_6=_1.getUTCHours();_7=_1.getUTCMinutes();_8=_1.getUTCSeconds();_9=_1.getUTCMilliseconds()}else if(_1){for(var i=0;i<isc.Time.$he.length;i++){var _14=isc.Time.$he[i].exec(_1);if(_14)break}
...
,isc.A.createLogicalTime=function isc_c_Time_createLogicalTime(_1,_2,_3,_4,_5){var _6=new Date(null);if(_1==null)_1=0;if(_2==null)_2=0;if(_3==null)_3=0;if(_4==null)_4=0;if(_5){_6.setUTCHours(_1,_2,_3,_4)}else{_6.setHours(_1,_2,_3,_4)}
...
,isc.A.compareLogicalTimes=function isc_c_Time_compareLogicalTimes(_1,_2){if(!isc.isA.Date(_1)||!isc.isA.Date(_2))return false;_1=isc.Date.getLogicalTimeOnly(_1);_2=isc.Date.getLogicalTimeOnly(_2);var _3=_1.getHours(),_4=_1.getMinutes(),_5=_1.getSeconds(),_6=_1.getMilliseconds();var _7=_2.getHours(),_8=_2.getMinutes(),_9=_2.getSeconds(),_10=_2.getMilliseconds();var _11=_6+1000*(_5+60*(_4+60*_3));var _12=_10+1000*(_9+60*(_8+60*_7));return _11>_12?-1:(_12>_11?1:0)}
...
,isc.A.getUTCHoursDisplayOffset=function isc_c_Time_getUTCHoursDisplayOffset(_1,_2){var _3=this.currentlyInDST?-(this.dstDeltaHours):0;if(this.adjustForDST){if(_1.getTimezoneOffset()==this.januaryDstOffset){if(this.southernHemisphere){_3+=this.dstDeltaHours}}else{if(!this.southernHemisphere){_3+=this.dstDeltaHours}}}
return(_2!=null?_2:this.UTCHoursDisplayOffset)+(this.adjustForDST?_3:0)}
...
if(_4.keyName&&(_4.blockingTab=true||_6!=false))
{_3.$85t[_3.$85t.length]=_4.keyName;if(_4.blockingTab)_4.blockingTab=null}
_3.$885=_4.ctrlKey;_3.$886=_4.altKey;if(_6!=false&&(_5||(isc.Browser.isMoz&&_4.keyName==this.$je&&this.shiftKeyDown())))
...
if(_9||_10){_5=false;isc.EH.lastEvent.blockingTab=true}
if(_9){this.logInfo("Widget:"+_3.$ke+" explicitly marked as requesting synthetic "+"tab index mgmt. Intercepting keyDown to achieve this.","syntheticTabIndex");_3.syntheticTabSource=_3.$ke}}
return _5}
...
if(_1)this.getMouseEventProperties(_1);var _3=this,_4=_3.lastEvent,_5=!_2?_4.keyTarget||_4.target:_4.target;_4.keyboardContextMenu=!_2;_4.eventType="contextMenu";if(!_2){_4.x=_5?_5.getPageLeft():0;_4.y=_5?_5.getPageTop():0}
...
return _2[_1]}
);isc.evalBoundary;isc.B.push(isc.A.handleDragMove=function isc_c_EventHandler_handleDragMove(){var _1=this,_2=_1.lastEvent;isc.$54j=true;_1.dropTarget=_1.getDropTarget(_2);isc.$54j=false;if(_1.$lq&&_1.dynamicBackMask){var _3=false;var _4=_1.dragMoveTarget?_1.dragMoveTarget:_1.dragTarget;var _5=_4.getRect();for(var i=0;i<_1.$lq.length;i++){var _7=_1.$lq[i];if(isc.Canvas.rectsIntersect(_7.rect,_5))
...
,isc.A.$86l=function isc_Canvas__childReflowComplete(_1){if(this.overflow!=isc.Canvas.VISIBLE&&this.$417){delete this.$417;var _2=false,_3,_4;if(this.$86m!=null&&this.$86m!=this.getScrollTop()){_2=true;_4=this.$86m;delete this.$86m}
...
if(this.$112j()){var _4=this.getHandle();var _5,_6=_4.firstChild,_7=_4.lastChild;if(_6){_5=_4.ownerDocument.createRange();_5.setStartBefore(_6);_5.setEndAfter(_7);var _8=_5.getBoundingClientRect();_2=Math.ceil(_8.width);var _9=_3.getBoundingClientRect().left-_3.scrollLeft;if(_8.left<_9)_2+=_8.left-_9}
_2+=isc.Element.getHPaddingSize(_4)}else if(this.allowNativeContentPositioning){this.$sv=true;if(isc.Browser.isSafari||(isc.Browser.isMoz&&((_3.scrollWidth||_3.offsetWidth)<=parseInt(_3.style.width))))
{_2=isc.Element.getScrollWidth(this.getHandle())}else{_2=isc.Element.getScrollWidth(_3)}
delete this.$sv}else{var _10=this.children,_11=_10&&_10.length>0,_12=0;if(!_11||this.allowContentAndChildren){if(isc.Browser.isSafari&&this.overflow==isc.Canvas.VISIBLE){_2=this.getHandle().scrollWidth;if(this.useClipDiv&&this.padding==null){_2+=isc.Element.$sw(this.styleName)}}else{_12=(_3.scrollWidth||_3.offsetWidth);if(_12!=null&&_12!=this.$n1){_2=_12;if(isc.Browser.isOpera){_2-=(this.getLeftBorderSize()+this.getLeftPadding())}
if(isc.Browser.isMoz)_2-=this.$sx();if(isc.Browser.isMoz&&this.getScrollingMechanism()==isc.Canvas.NESTED_DIV)
{var _13=this.getHandle().offsetLeft;if(_13<0)_13=-_13;_2-=_13}}
if(isc.Browser.isSafari||(isc.Browser.isMoz&&_2<=parseInt(_3.style.width)))
{var _4=this.getHandle(),_14=_4.scrollWidth||_4.offsetWidth;if(_14>_2)_2=_14}}}
if(_11){var _15=this.$sy(this.children);_2=Math.max(_15,_2);if(this.$qe!=null){var _16=this.$qe[0];_2=Math.max(_2,_16)}}}
...
if(this.$112j()){var _4=this.getHandle(),_5,_6=_4.firstChild,_7=_4.lastChild,_8;_2=_3.scrollHeight;if(_6){_5=_4.ownerDocument.createRange();_5.setStartBefore(_6);if(_7.tagName=="BR"||_7.tagName=="P"){_4.insertAdjacentHTML("beforeend","&nbsp;");var _9=_4.lastChild;_5.setEndAfter(_9);_8=_5.getBoundingClientRect();_2=Math.ceil(_8.height);_4.removeChild(_9)}else{_5.setEndAfter(_7);_8=_5.getBoundingClientRect();_2=Math.ceil(_8.height)}
_2+=isc.Element.getVPaddingSize(_4);var _10=_3.getBoundingClientRect().top-_3.scrollTop;if(_8.top<_10)_2+=_8.top-_10}}else if(this.allowNativeContentPositioning){this.$s0=true;if(isc.Browser.isSafari||(isc.Browser.isMoz&&((_3.scrollHeight||_3.offsetHeight)<=parseInt(_3.style.height))))
{_2=isc.Element.getScrollHeight(this.getHandle())}else{_2=isc.Element.getScrollHeight(_3)}
delete this.$s0}else{var _11=(this.children&&this.children.length>0);if(!_11||this.allowContentAndChildren){if(isc.Browser.isSafari&&this.overflow==isc.Canvas.VISIBLE){_2=this.getHandle().scrollHeight;if(this.useClipDiv&&this.padding==null){_2+=isc.Element.$s1(this.styleName)}}else{var _12=(_3.scrollHeight||_3.offsetHeight);if(_12!=null&&_12!=this.$n1){_2=_12;if(isc.Browser.isMoz)_2-=this.$s2();if(this.useClipDiv&&(isc.Browser.isSafari||(isc.Browser.isMoz&&_2<=parseInt(_3.style.height))))
{var _4=this.getHandle(),_13=_4.scrollHeight||_4.offsetHeight;if(_13>_2)_2=_13}}}}
if(_11){var _14=this.$s3(this.children);if(_14>_2){_2=_14}
if(this.$qe!=null){var _15=this.$qe[1];_2=Math.max(_2,_15)}}}
...
_1.bottom=0}
return(this.$tk=_1)}
,isc.A.setTopPadding=function isc_Canvas_setTopPadding(_1){this.$tp=null;this.topPadding=_1;if(isc.isA.Number(_1))_1+="px";if(this.isDrawn())this.getHandle().style.paddingTop=_1}
,isc.A.setLeftPadding=function isc_Canvas_setLeftPadding(_1){this.$tp=null;this.leftPadding=_1;if(isc.isA.Number(_1))_1+="px";if(this.isDrawn())this.getHandle().style.paddingLeft=_1}
,isc.A.setRightPadding=function isc_Canvas_setRightPadding(_1){this.$tp=null;this.rightPadding=_1;if(isc.isA.Number(_1))_1+="px";if(this.isDrawn())this.getHandle().style.paddingRight=_1}
,isc.A.setBottomPadding=function isc_Canvas_setBottomPadding(_1){this.$tp=null;this.bottomPadding=_1;if(isc.isA.Number(_1))_1+="px";if(this.isDrawn())this.getHandle().style.paddingBottom=_1}
...
,isc.A.childResettingHandleForAdjustOverflow=function isc_Canvas_childResettingHandleForAdjustOverflow(){if(this.oveflow==isc.Canvas.VISIBLE){if(this.parentElement)this.parentElement.childResettingHandleForAdjustOverflow()}else{this.$1051=this.getScrollLeft();this.$1052=this.getScrollTop()}}
,isc.A.childResetHandleForAdjustOverflowComplete=function isc_Canvas_childResetHandleForAdjustOverflowComplete(){if(this.overflow!=isc.Canvas.VISIBLE){this.scrollTo(this.$1051,this.$1052);this.$1051=this.$1052=null}}
...
{if(!_12&&_1==this.$nx)return;this.$5y(_7-_2,_8-_3,this.$pg)}}else if(this.overflow==_5.HIDDEN){this.$q5(this.left,this.top,this.getWidth(),this.getHeight());if(isc.Browser.isIE&&this.isRTL()){this.scrollLeft=this.getClipHandle().scrollLeft}
...
if(this.isRTL()&&this.hscrollOn&&!_25){var _34=this.getClipHandle().scrollLeft;this.scrollLeft=_34}
...
);isc.evalBoundary;isc.B.push(isc.A.canScroll=function isc_Canvas_canScroll(_1){var _2=_1?this.getScrollHeight():this.getScrollWidth(),_3=_1?this.getViewportHeight():this.getViewportWidth();return(_2>_3)}
...
);isc.evalBoundary;isc.B.push(isc.A.setCursor=function isc_Canvas_setCursor(_1){if(_1&&_1!=this.cursor){this.cursor=_1;this.$k2()}}
...
if(isc.Browser.isMoz||isc.Browser.isWebKit){this.$y9(_7,_15,_9,_10,3,5,_14,_1)}else{this.$y9(_7,null,_9,_10,3,5,_14,_1)}
_1.append("</TR><TR HEIGHT=",this.$y7,">");this.$y9(_7,this.$y7,_9,_10,6,8,_14,_1);_1.append("</TR></TABLE>");return _1.toString()}
,isc.A.$y9=function isc_EdgedCanvas__writeEdgeCells(_1,_2,_3,_4,_5,_6,_7,_8){for(var i=_5;i<=_6;i++){var _10=this.$y0[i];var _11=this.getEdgeStyleName(_10),_12=_11?this.$4n:null;if(_7[_10]||(this.showCenter&&_10==isc.Canvas.CENTER)){_8.append(_1,(_2==null?"''":_2),_12,_11,_3,this.getEdgePrefix(_10),isc.$ag,_10,_4)}else{if(this.centerBackgroundColor&&_10==isc.Canvas.CENTER){_8.append("<TD ",_12,_11," style='background-color:",this.centerBackgroundColor,"'></TD>")}else{_8.append(this.$61h,_12,_11,this.$61i)}}}}
...
return null}
,isc.A.createLocatorFallbackPath=function isc_c_AutoTest_createLocatorFallbackPath(_1,_2){var _3=[];for(var _4 in _2){var _5=_2[_4];if(isc.isA.String(_5)){_5=_5.replaceAll("/",this.slashMarker);_5=escape(_5)}
