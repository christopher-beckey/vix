...
return 1}
return _7}
,isc.A.compareDates=function isc_DataSource_compareDates(_1,_2,_3,_4){var _5=this.getField(_3),_6=_4?this.getField(_4):null;if((_5&&_5.type=="datetime")||(_6&&_6.type=="datetime")){return Date.compareDates(_1,_2)}else if((_5&&_5.type=="time")||(_6&&_6.type=="time")){return isc.Time.compareLogicalTimes(_1,_2)}else{return Date.compareLogicalDates(_1,_2)}}
...
var _7;if(isc.isA.Date(_65)&&isc.isA.Date(_6)){_7=(_69.compareDates(_65,_6,_45)==0)}else _7=(_65==_6);if(_68.negate)return!_7;else return _7};var _8=function(_65,_66,_45,_67,_68,_69){var _9=_65,_10=_65,_6=isc.DataSource.getPathValue(_66,_45);if(_67.start)_9=_67.start;if(_67.end)_10=_67.end;if(_69.$59v){if(_6==null||(_68.lowerBounds&&_9==null)||(_68.upperBounds&&_10==null)){return _69.$59u}}
