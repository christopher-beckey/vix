...
,isc.A.$102=function isc_DynamicForm__itemsDrawn(){var _1=this.items;for(var i=0;i<_1.length;i++){if(_1[i]){if(_1[i].visible)_1[i].drawn();else if(isc.CanvasItem&&isc.isA.CanvasItem(_1[i])){_1[i].ensureCanvasCleared()}}}}
...
if(isc.Browser.isMoz)_13[6]=(_14<0?"ignore;":"normal;");_13[7]=_3?"cursor:default;":null;_13[9]=_14;if(isc.Canvas.ariaEnabled()&&!isc.Canvas.useLiteAria()){_13[10]=" ";if(_1.prompt){_13[10]=" aria-label='"+_1.prompt.replaceAll("'","&apos;")+"' "}
...
,isc.A.$66v=function isc_FormItem__getInFieldHintStyle(){if(this.isDisabled())return this.textBoxStyle+"DisabledHint";return this.textBoxStyle+"Hint"}
...
,isc.A.getImplicitSave=function isc_FormItem_getImplicitSave(){if(this.form==null)return false;return(this.implicitSave!=null?this.implicitSave:this.form.implicitSave)}
...
,isc.A.$844=function isc_FormItem__performValidateOnEditorExit(_1){if(this.form==null)return;if(this.validateOnExit||this.form.validateOnExit){if(this.$84r||(this.form.isNewRecord&&this.form.isNewRecord())||!this.compareValues(_1,this.$75h))
{this.validate()}
...
if(_8.criteria.length==1)_8=_8.criteria[0];if(_8.criteria&&_8.criteria.length==0)_8=null;return _8}
...
,isc.A.ensureCanvasCleared=function isc_CanvasItem_ensureCanvasCleared(){if(this.canvas&&this.canvas.isDrawn()){this.canvas.clear();this.containerWidget.$t5=true;this.containerWidget.$t6("CanvasItem canvas cleared")}}
...
return false;if(this.isReadOnly())return true;if((isc.EventHandler.ctrlKeyDown()||isc.EventHandler.altKeyDown()||isc.EH.metaKeyDown())&&(_2.characterValue===null||_2.characterValue<128)){return true}
...
,isc.A.hide=function isc_PickListMenu_hide(_1,_2,_3,_4){var _5=this.isVisible()&&this.isDrawn();this.invokeSuper(isc.PickListMenu,"hide",_1,_2,_3,_4);if(!this.formItem)return;if(_5&&this.showModal)this.formItem.focusInItem();this.formItem.$19g=null;if(_5)this.formItem.$19h();delete this.formItem.$19i;this.clearLastHilite()}
...
);isc.B._maxIndex=isc.C+10;isc.ClassFactory.defineClass("TimeItem","TextItem");isc.A=isc.TimeItem;isc.A.DEFAULT_TIME="00:00:00";isc.A=isc.TimeItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.allowExpressions=true;isc.A.changeOnBlur=true;isc.A.changeOnKeypress=false;isc.A.width=100;isc.A.timeFormatter="toShort24HourTime";isc.A.allowEmptyValue=true;isc.B.push(isc.A.handleKeyPress=function isc_TimeItem_handleKeyPress(){var _1=this.Super("handleKeyPress",arguments);if(_1!=false){var _2=isc.EH.getKey();if(_2=="Enter"){this.updateValue()}}
return _1}
);isc.B._maxIndex=isc.C+1;isc.A=isc.TimeItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.short24TimeFormat="HH:MM";isc.A.shortTimeFormat="HH:MM [am|pm]";isc.A.long24TimeFormat="HH:MM:SS";isc.A.longTimeFormat="HH:MM:SS [am|pm]";isc.A.formatterMap={toTime:{mask:"[0-1]#:[0-6]#:[0-6]# [ap]m",formatter:"toPaddedTime"},to24HourTime:{mask:"[0-2]#:[0-6]#:[0-6]#",formatter:"toPadded24HourTime"},toPaddedTime:{mask:"[0-1]#:[0-6]#:[0-6]# [ap]m"},toPadded24HourTime:{mask:"[0-2]#:[0-6]#:[0-6]#"},toShortTime:{mask:"[0-1]#:[0-6]# [ap]m",formatter:"toShortPaddedTime"},toShort24HourTime:{mask:"[0-2]#:[0-6]#",formatter:"toShortPadded24HourTime"},toShortPaddedTime:{mask:"[0-1]#:[0-6]# [ap]m"},toShortPadded24HourTime:{mask:"[0-2]#:[0-6]#"}};isc.B.push(isc.A.getOperator=function isc_TimeItem_getOperator(_1){if(!this.operator)return"equals";return this.operator}
,isc.A.getHint=function isc_TimeItem_getHint(){if(!this.showHint)return"";if(this.hint!=null)return this.hint;var _1=this.$30o();switch(_1){case"to24HourTime":case"toPadded24HourTime":return this.long24TimeFormat;case"toTime":case"toPaddedTime":return this.longTimeFormat;case"toShort24HourTime":case"toShortPadded24HourTime":return this.short24TimeFormat;case"toShortTime":case"toShortPaddedTime":return this.shortTimeFormat}
return""}
...
,isc.A.getCriteriaValue=function isc_TimeItem_getCriteriaValue(){if(this.$85m())return this.getElementValue();var _1=this.getValue();if(_1==null||isc.is.emptyString(_1))return null;if(!isc.isA.Date(_1))_1=isc.Time.parseInput(String(_1));return _1}
,isc.A.getCriterion=function isc_TimeItem_getCriterion(_1){var _2,_3=this.getOperator(_1,isc.isAn.Array(_5)),_4=this.getCriteriaFieldName();var _5=this.getCriteriaValue();if(_5==null||isc.is.emptyString(_5))return;if(this.$85m()){_2=this.parseValueExpressions(_5,_4,_3);if(_2!=null){if("equals"!=_2.operator){return _2}
_5=_2.value}}
...
_2={fieldName:_4,operator:_3,value:_5};return _2}
,isc.A.canEditCriterion=function isc_TimeItem_canEditCriterion(_1,_2){if(_1.fieldName!=null&&_1.fieldName==this.getCriteriaFieldName()&&isc.isA.Date(_1.value))
{return true}
return this.Super("canEditCriterion",arguments)}
,isc.A.$111i=function isc_TimeItem__formatCriterionValue(_1){return this.mapValueToDisplay(_1)}
,isc.A.mapValueToDisplay=function isc_TimeItem_mapValueToDisplay(_1){if(this.allowEmptyValue&&(_1==null||isc.isAn.emptyString(_1)))return isc.emptyString;if(!isc.isA.Date(_1)){var _2=isc.Time.parseInput(String(_1),true);if(_2!=null)_1=_2;else return _1}
var _3=isc.Time.format(_1,this.$30o());_3=this.Super("mapValueToDisplay",_3);return _3}
,isc.A.mapDisplayToValue=function isc_TimeItem_mapDisplayToValue(_1){var _2=this.Super("mapDisplayToValue",arguments);if((_2==null||isc.isAn.emptyString(_2))&&this.allowEmptyValue){_2=null}else{var _3=isc.Time.parseInput(String(_1),true);if(_3==null)return _1;_2=_3}
return _2}
...
,isc.A.setValue=function isc_TimeItem_setValue(_1){if(isc.isA.String(_1)){if(!this.$85m())_1=isc.Time.parseInput(_1)}
...
,isc.A.$20y=function isc_ComboBoxItem__clickOutside(){var _1=this.pickList;if(!_1||!_1.isVisible())return;var _2=isc.EH.lastEvent.target;if(!_1.contains(_2,true)&&(!_1.$314||!_1.$314.contains(_2,true))&&(!_1.filterEditor||_1.filterEditor.getEditForm()!=_2))
...
,isc.A.$84z=function isc_ComboBoxItem__mouseDownInPickList(){var _1=this.pickList;if(!_1||!_1.isVisible()||!_1.isDrawn())return false;var _2=isc.EH,_3=isc.EH.lastEvent;if((_3.eventType=="selectionChange"&&_1.contains(isc.EH.mouseDownTarget()))||((_1.contains(_3.target,true)||(_1.filterEditor&&_1.filterEditor.getEditForm()==_3.target))))
{return true}
return false}
...
);isc.B._maxIndex=isc.C+3;isc.A=isc.PickTreeItem.getPrototype();isc.A.canFocus=true;isc.A.shouldSaveValue=true;isc.A.buttonDefaults={height:19};isc.A.emptyMenuMessage="No items to display";isc.A.emptyDisplayValue=undefined;isc.A=isc.PickTreeItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.buttonConstructor="TreeMenuButton";isc.B.push(isc.A.init=function isc_PickTreeItem_init(){this.Super("init",arguments);if(this.optionDataSource==null&&this.dataSource==null&&this.valueTree==null){this.logWarn("This form item requires a 'valueTree'.")}}
...
return this.Super("saveValue",arguments)}
,isc.A.showValue=function isc_PickTreeItem_showValue(_1,_2){var _3=this.$21s(_2);if(_3!=null){this.canvas.setSelectedItem(_3)}else{var _4=this.optionDataSource||this.dataSource;var _5=!_4||(this.$17b(_2,true)!==null),_6=_5?_1:"";this.canvas.setTitle(_6)}}
...
_2.invalidateCache()}
,isc.A.$1054=function isc_PickTreeItem__getEmptyDisplayValue(){if(this.emptyDisplayValue!=null){return this.emptyDisplayValue}else{var _1=isc[this.buttonConstructor],_2=_1&&_1.getInstanceProperty("unselectedTitle");return _2||""}}
,isc.A.setEmptyDisplayValue=function isc_PickTreeItem_setEmptyDisplayValue(_1){this.emptyDisplayValue=_1;if(this.button!=null){this.button.unselectedTitle=this.$1054()}}
);isc.B._maxIndex=isc.C+20;isc.defineClass("IPickTreeItem","PickTreeItem");isc.A=isc.IPickTreeItem.getPrototype();isc.A.buttonConstructor="ITreeMenuButton"}
