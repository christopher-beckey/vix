...
! function(e, t) {
    ...
    var F = /\d+/g,
        M = {
            ...
            setStartDate: function(e) {
                k(e) || y(e) ? this.startDate = this.parseDate(e) : this.startDate = null, this.built && this.render()
            },
            setEndDate: function(e) {
                k(e) || y(e) ? this.endDate = this.parseDate(e) : this.endDate = null, this.built && this.render()
            },
                ...
                if (e.stopPropagation(), e.preventDefault(), !t.hasClass("disabled")) {
                    ...
                    switch (n) {
                        ...
                        case "year picked":
                            ...
                            break;
                        case "year":
                            r = parseInt(t.text(), 10), this.date = new Date(r, h, $(r, h, o)), s.hasMonth ? (this.viewDate = new Date(this.date), this.showView(f)) : (t.addClass(i.pickedClass).siblings().removeClass(i.pickedClass), this.renderYears(), this.hideView()), this.pick("year");
                            break;
                        case "month prev":
                        case "month next":
                        ...
                        case "month picked":
                            ...
                            break;
                        case "month":
                            h = D.inArray(t.text(), i.monthsShort), this.date = new Date(r, h, $(r, h, o)), s.hasDay ? (this.viewDate = new Date(r, h, $(r, h, o)), this.showView(p)) : (t.addClass(i.pickedClass).siblings().removeClass(i.pickedClass), this.renderMonths(), this.hideView()), this.pick("month");
                            break;
                        case "day prev":
                        case "day next":
                        case "day":
        ...
        Y = {
            ...
            renderYears: function() {
                ...
                for (c = -5; c <= 6; c += 1) {
                    var p = new Date(r + c, 1, 1),
                        f = !1;
                    t && (f = p.getFullYear() < t.getFullYear(), -5 === c && (d = f)), !f && i && (f = p.getFullYear() > i.getFullYear(), 6 === c && (u = f)), !f && s && (f = !1 === s.call(this.$element, p, "year"));
                    var g = r + c === o,
            ...
            renderMonths: function() {
                ...
                for (y = 0; y <= 11; y += 1) {
                    var v = new Date(h, y, 1),
                        m = !1;
                    t && (m = (f = v.getFullYear() === t.getFullYear()) && v.getMonth() < t.getMonth()), !m && i && (m = (g = v.getFullYear() === i.getFullYear()) && v.getMonth() > i.getMonth()), !m && r && (m = !1 === r.call(this.$element, v, "month"));
                    var w = h === u && y === c,
            ...
            renderDays: function() {
                ...
                for ((b = M.getDay() - parseInt(l, 10) % 7) <= 0 && (b += 7), i && (F = M.getTime() <= i.getTime()), D = k - (b - 1); D <= k; D += 1) {
                    var V = new Date($, x, D),
                        Y = !1;
                    i && (Y = V.getTime() < i.getTime()), !Y && h && (Y = !1 === h.call(e, V, "day")), C.push(this.createItem({
                        disabled: Y,
                ...
                var N = new Date(u, c, k);
                for (a && (P = N.getTime() >= a.getTime()), D = 1; D <= b; D += 1) {
                    var j = new Date(S, T, D),
                        q = S === v && T === m && D === w,
                        A = !1;
                    a && (A = j.getTime() > a.getTime()), !A && h && (A = !1 === h.call(e, j, "day")), I.push(this.createItem({
                        disabled: A,
                        picked: q,
                ...
                var O = [];
                for (D = 1; D <= k; D += 1) {
                    var W = new Date(u, c, D),
                        z = !1;
                    i && (z = W.getTime() < i.getTime()), !z && a && (z = W.getTime() > a.getTime()), !z && h && (z = !1 === h.call(e, W, "day"));
                    var J = u === v && c === m && D === w,
                        E = J ? "day picked" : "day";
                    O.push(this.createItem({
                        disabled: z,
                        picked: J,
                        highlighted: u === f && c === g && W.getDate() === y,
                        text: D,
                        view: z ? "day disabled" : E
                    }))
                }
                this.$monthPrev.toggleClass(r, F), this.$monthNext.toggleClass(r, P), this.$monthCurrent.toggleClass(r, F && P).html(t.yearFirst ? u + d + " " + o[c] : o[c] + " " + u + d), this.$days.html(C.join("") + O.join("") + I.join(""))
            }
        },
        I = function() {
            function a(e, t) {
    ...
    var S = d + "-top-left",
        T = d + "-bottom-left",
        P = [S, d + "-top-right", T, d + "-bottom-right"].join(" "),
        N = function() {
            function i(e) {
                var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {};
                ! function(e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, i), this.$element = D(e), this.element = e, this.options = D.extend({}, a, c[t.language], D.isPlainObject(t) && t), this.built = !1, this.shown = !1, this.isInput = !1, this.inline = !1, this.initialValue = "", this.initialDate = null, this.startDate = null, this.endDate = null, this.init()
            }
            return I(i, [{
                key: "init",
                value: function() {
                ...
                value: function() {
                    if (!this.inline) {
                        var e = this.$element,
                            ...
                            p = S;
                        v(c) && (c = 10), o < u && s < u + r + o ? (u -= o + c, p = T) : u += r + c, a < d + h && (d += n - h, p = p.replace("left", "right")), i.removeClass(P).addClass(p).css({
                            top: u,
                            left: d,
                ...
                value: function() {
                    var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};
                    D.extend(a, c[e.language], D.isPlainObject(e) && e)
                }
            }]), i
        }();
    if (D.extend && D.extend(N.prototype, Y, V, M), D.fn) {
        ...
        }, D.fn.datepicker.Constructor = N, D.fn.datepicker.languages = c, D.fn.datepicker.setDefaults = N.setDefaults, D.fn.datepicker.noConflict = function() {
